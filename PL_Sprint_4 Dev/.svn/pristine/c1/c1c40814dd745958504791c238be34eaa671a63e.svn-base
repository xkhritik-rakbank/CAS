...
public class PL_Documnet_Checker extends PLCommon implements FormListener
{
	...
	public void formLoaded(FormEvent pEvent)
	{
        ...
        formObject.setSheetCaption("Tab1", "Document Checker", 15);
        formObject.setCaption("Orig_validation", "Document Checker");
	}
	...
	public void formPopulated(FormEvent pEvent) 
	{
		try{
			FormReference formObject = FormContext.getCurrentInstance().getFormReference();
			formObject.setNGValue("Mandatory_Frames", NGFUserResourceMgr_PL.getGlobalVar("DC_Frame_Name"));
	...
	***********************************************************************************  */
	...
	//cmplx_OrigVal_ovdec
		...
		formObject.setLocked("Orig_validation",true);
	}
	...
	public void submitFormStarted(FormEvent arg0) throws ValidatorException {
		...
		CustomSaveForm();		//formObject.setNGValue("decision", formObject.getNGValue("cmplx_Decision_Decision"));
		try{ 
			formObject.setNGValue("decision", formObject.getNGValue("cmplx_Decision_Decision"));
			formObject.setNGValue("DC_WI_Status", "Y");
			...
			if("Refer".equalsIgnoreCase(formObject.getNGValue("cmplx_Decision_Decision"))){
				if( !"DDVT Maker".equalsIgnoreCase(formObject.getNGValue("q_MailSubject"))){
					if("Source".equalsIgnoreCase(formObject.getNGValue("q_MailSubject"))){
						formObject.setNGValue("postHoldReferWS","Original_Validation");
					}else {
			...
			PersonalLoanS.mLogger.info(formObject.getNGValue("postHoldReferWS"));
			PersonalLoanS.mLogger.info(formObject.getNGValue("IS_Stage_Reversal"));
