...
public class PL_PostDisbursal_Checker extends PLCommon implements FormListener
{
...
makeSheetsInvisible("Tab1", "8,9,16");//Changes done by shweta for jira #1768 to hide CPV tab
FormReference formObject = FormContext.getCurrentInstance().getFormReference();
formObject.setSheetCaption("Tab1", "Post Disbursal", 11 );
...
public void submitFormCompleted(FormEvent arg0) throws ValidatorException {
	...
	if(decision_str.contains(NGFUserResourceMgr_PL.getGlobalVar("PL_Submit_Desc"))){
...
if( formObject.getNGValue("cmplx_Decision_Decision").contains("Approve"))
{
	formObject.setNGValue("Disbursal","D");
}
