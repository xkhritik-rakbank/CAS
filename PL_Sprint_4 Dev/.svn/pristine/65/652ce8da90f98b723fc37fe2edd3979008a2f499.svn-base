...
public class PL_HR extends PLCommon implements FormListener
{
	...
	{
		PersonalLoanS.mLogger.info("PL_HR Initiation"+ "Inside formLoaded()" + pEvent.getSource().getName());
	...
	public void formPopulated(FormEvent pEvent) 
	{
		...
		{
			PersonalLoanS.mLogger.info("PL_HR-->"+ "Exception:"+e.getMessage());
			printException(e);
...
/*
		...
		//Below field is not present in PL form
