...
public class PL_Relationship_Manager extends PLCommon implements FormListener
{
	...
	public void formLoaded(FormEvent pEvent)
	{
		...
		makeSheetsInvisible(tabName, "5,6,7,8,9,11,12,13,14,15,16");//Changes done by shweta for jira #1768 to hide CPV tab
	}
	...
	***********************************************************************************  */
	...
	public void fragment_loaded(ComponentEvent pEvent)
	{
		...
		if ("Customer".equalsIgnoreCase(pEvent.getSource().getName())) {
		...
		else if ("ReferenceDetails".equalsIgnoreCase(pEvent.getSource().getName())) {//ReferenceDetails_Header
			LoadPickList("ReferenceDetails_ref_Relationship", "select '--Select--'as description,'' as code  union select convert(varchar, description),code from NG_MASTER_Relationship with (nolock) order by code");
			//ReferenceDetails_ref_Relationship
			...
			loadPicklist_KYC();
			formObject.setLocked("KYC_Frame7",true);  //Arun
		}
		...
		else if ("IncomingDocNew".equalsIgnoreCase(pEvent.getSource().getName()))
		{
        	...
        	fragment_ALign("Decision_Label3,cmplx_Decision_Decision#DecisionHistory_Label1,cmplx_Decision_ReferTo#DecisionHistory_Label11,DecisionHistory_DecisionReasonCode#Decision_Label4,cmplx_Decision_REMARKS#\n#DecisionHistory_Label31,cmplx_Decision_Customer_contacted#DecisionHistory_Label32,cmplx_Decision_RM_Extension#DecisionHistory_Label33,cmplx_Decision_Date_call#DecisionHistory_Label34,cmplx_Decision_Time_Call#\n#CustomerMetBy,cmplx_Decision_Customer_Met_By#\n#DecisionHistory_ADD#DecisionHistory_Modify#DecisionHistory_Delete#\n#Decision_ListView1#\n#DecisionHistory_save","DecisionHistory");//\n for new line
	...
	public void eventDispatched(ComponentEvent pEvent) throws ValidatorException
	{
		...
		case FRAGMENT_LOADED:
			fragment_loaded(pEvent);//---commented by akshay for proc 7469
