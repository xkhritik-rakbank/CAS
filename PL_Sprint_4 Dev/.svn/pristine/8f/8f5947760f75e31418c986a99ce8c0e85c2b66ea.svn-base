...
File Name                                                                     : PL_Interest_Rate_Approval.java
Author                                                                        : Disha
Date (DD/MM/YYYY)                                      						  : 
Description                                                                   : 
...
public class PL_Interest_Rate_Approval extends PLCommon implements FormListener
{
	...
	{
		mLogger.info("PL_Interest_Rate_Approval Initiation"+ "Inside formLoaded()" + pEvent.getSource().getName());
	...
	public void formPopulated(FormEvent pEvent) 
	{
		...
		{
			mLogger.info("PL_Interest_Rate_Approval-->"+ "Exception:"+e.getMessage());
			printException(e);
		}
	}
	...
	***********************************************************************************  */
	...
	//Below fields not present in pl form
	...
	public void submitFormStarted(FormEvent arg0) throws ValidatorException {
		...
		FormReference formObject = FormContext.getCurrentInstance().getFormReference();
		//below code changed by nikhil 08/12/17
		formObject.setNGValue("Interest_Rate_App_dec", formObject.getNGValue("cmplx_Decision_Decision"));
		saveIndecisionGrid();

		String query= "update NG_RLOS_DecisionValidation set Interest_Rate_App_dec = '"+formObject.getNGValue("Interest_Rate_App_dec")+"' where wi_name = '"+formObject.getWFWorkitemName()+"'";
