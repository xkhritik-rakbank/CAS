...
public class PL_CardCollection extends PLCommon implements FormListener
{
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
		...
		//Changes done for code optimization 25/07(else if removed because duplicate)
			...
			fragment_ALign("Decision_Label3,cmplx_Decision_Decision#DecisionHistory_Label1,cmplx_Decision_ReferTo#DecisionHistory_Label11,DecisionHistory_DecisionReasonCode#Decision_Label4,cmplx_Decision_REMARKS#DecisionHistory_Button4,#\n#DecisionHistory_ADD#DecisionHistory_Modify#DecisionHistory_Delete#\n#Decision_ListView1#\n#DecisionHistory_save","DecisionHistory");//\n for new line
