...
public class PL_Customer_Hold extends PLCommon implements FormListener
{
	...
	public void formLoaded(FormEvent pEvent)
	{
        ...
        makeSheetsInvisible("Tab1", "6,7,8,9,11,12,13,14,15,16");//Changes done by shweta for jira #1768 to hide CPV tab//Hide Disbursal,Compliance,FCU,CAD,OV,Dispatch,Services Rquest, System check
	}
