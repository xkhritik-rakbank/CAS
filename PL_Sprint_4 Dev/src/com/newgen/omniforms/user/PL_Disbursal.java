...
public class PL_Disbursal extends PLCommon implements FormListener
{
	...
	***********************************************************************************  */
	...
	public void submitFormStarted(FormEvent arg0) throws ValidatorException {
		...
		formObject.setNGValue("ReferTo", formObject.getNGItemText("cmplx_Decision_ReferTo", formObject.getSelectedIndex("cmplx_Decision_ReferTo")));
		...
		//added by jahnavi to avoid null value getting saved to account number , contract id and branch
		}
		catch(Exception e)
		{
