...
//cmplx_Decision_TotalOutstanding
	Logger mLogger=PersonalLoanS.mLogger;
	public void formLoaded(FormEvent pEvent) {
		PersonalLoanS.mLogger.info("PersonnalLoanS> PL_Iniation"+ "Inside PL PROCESS formLoaded()" + pEvent.getSource());
	...
	public void formPopulated(FormEvent pEvent) {
		...
		PersonalLoanS.mLogger.info("PersonnalLoanS>  PL_Iniation"+ "Inside PL PROCESS formPopulated()" + pEvent.getSource());
	...
	***********************************************************************************  */
	...
	public void initialize() {
		PersonalLoanS.mLogger.info("PersonnalLoanS>  PL_Iniation"+ "Inside PL PROCESS initialize()" );

	}


	public void saveFormCompleted(FormEvent pEvent) throws ValidatorException {
		PersonalLoanS.mLogger.info("PersonnalLoanS>  PL_Iniation"+ "Inside PL PROCESS saveFormCompleted()" + pEvent.getSource());
		CustomSaveForm();
	}


	public void saveFormStarted(FormEvent pEvent) throws ValidatorException {
		PersonalLoanS.mLogger.info("PersonnalLoanS>  PL_Iniation"+ "Inside PL PROCESS saveFormStarted()" + pEvent.getSource());
	...
	public void submitFormStarted(FormEvent pEvent) throws ValidatorException {
		PersonalLoanS.mLogger.info("PersonnalLoanS>  PL_Iniation"+ "Inside PL PROCESS submitFormStarted()" + pEvent.getSource());
		saveIndecisionGrid();
	}
