...
public class CC_Fulfillment_RM extends CC_Common implements FormListener
{
	...
	public void formLoaded(FormEvent pEvent)
	{
		...
		CreditCard.mLogger.info("CC Fullfillment"+ "Inside formLoaded()" + pEvent.getSource().getName());
	...
	{
	     try{
	    	 CreditCard.mLogger.info("CC Fullfillment"+"Inside CC_Fullfillment CC");
	    	 new CC_CommonCode().setFormHeader(pEvent);
	        }catch(Exception e)
	        {
	            CreditCard.mLogger.info("RLOS Initiation"+ "Exception:"+e.getMessage());
	        }
	...
	public void initialize() {
		CreditCard.mLogger.info("PersonnalLoanS>  CC_Fullfillment"+ "Inside PL PROCESS initialize()" );
		}

	
	public void saveFormCompleted(FormEvent pEvent) throws ValidatorException {
		CreditCard.mLogger.info("PersonnalLoanS>  CC_Fullfillment"+ "Inside PL PROCESS saveFormCompleted()" + pEvent.getSource());
	}

	
	public void saveFormStarted(FormEvent pEvent) throws ValidatorException {
		FormReference formObject = FormContext.getCurrentInstance().getFormReference();
		CreditCard.mLogger.info("PersonnalLoanS>  CC_Fullfillment"+"Inside PL PROCESS saveFormStarted()" + pEvent.getSource());
		formObject.setNGValue("get_parent_data",queryData_load);
		CreditCard.mLogger.info("PersonnalLoanS"+"Final val of queryData_load:"+ formObject.getNGValue("get_parent_data"));
	}

	
	public void submitFormCompleted(FormEvent pEvent) throws ValidatorException {
		CreditCard.mLogger.info("PersonnalLoanS>  CC_Fullfillment"+ "Inside PL PROCESS submitFormCompleted()" + pEvent.getSource());
		
	}

	
	public void submitFormStarted(FormEvent pEvent) throws ValidatorException {
		CreditCard.mLogger.info("PersonnalLoanS>  CC_Fullfillment"+ "Inside PL PROCESS submitFormStarted()" + pEvent.getSource());
		FormReference formObject = FormContext.getCurrentInstance().getFormReference();	
		...
		/*if (pEvent.getSource().getName().equalsIgnoreCase("Product")) {
			...
			//added by yash on 30/8/2017
				if (pEvent.getSource().getName().equalsIgnoreCase("NotepadDetails")) {
					 ...
					 CreditCard.mLogger.info("CCyash "+ "Activity name is:" + sActivityName);
