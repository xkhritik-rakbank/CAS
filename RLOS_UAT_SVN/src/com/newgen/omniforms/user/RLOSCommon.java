...
public class RLOSCommon extends Common implements Serializable
{
	...
	public void IslamicFieldsvisibility() {
		FormReference formObject = FormContext.getCurrentInstance().getFormReference();
		String query = "select distinct limit.Card_Product,limit.CC_Waiver,mstr.ReqProduct from ng_rlos_IGR_Eligibility_CardLimit limit with(nolock) join  ng_master_cardProduct mstr with(nnolock) on limit.Card_Product=mstr.CODE where wi_name = '"+formObject.getWFWorkitemName()+"' and Cardproductselect='true'";
