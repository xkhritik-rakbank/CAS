...
public class EventListenerHandler extends EventListenerImplementor {
    ...
    public void btnSearch_Clicked(ActionEvent ae) {
        SKLogger_CC.writeLog("RLOS","Inside method btnSearch_Clicked");
        ...
        /*if (m_objPickList.getAssociatedTxtCtrl().equalsIgnoreCase("EMploymentDetails_Button2")) {
            ...
            SKLogger_CC.writeLog("PL","##AKshay");
            for(int i=0;i<20;i++)
                SKLogger_CC.writeLog("PL","Column "+i+"is: "+ m_objPickList.getSelectedValue().get(i));
        }*/
    ...
    public void btnOk_Clicked(ActionEvent ae) throws ValidatorException {
    	try{
        PickList m_objPickList = FormContext.getCurrentInstance().getDefaultPickList();
        SKLogger_CC.writeLog("EventListenerHandler", "Val of m_objPickList.getAssociatedTxtCtrl() is:"+m_objPickList.getAssociatedTxtCtrl());
        /*if (m_objPickList.getAssociatedTxtCtrl().equalsIgnoreCase("EMploymentDetails_Button2")) {
            SKLogger_CC.writeLog("EventListenerHandler", "Inside OK button");
            try{
            	
                SKLogger_CC.writeLog("Date before Conversion:",m_objPickList.getSelectedValue().get(7));
                SimpleDateFormat sdf1=new SimpleDateFormat("dd-MMM-yy");
                SimpleDateFormat sdf2=new SimpleDateFormat("dd/MM/yyyy");
                String DateofInclusioninPLAloc_new=sdf2.format(sdf1.parse(m_objPickList.getSelectedValue().get(7)));
                SKLogger_CC.writeLog("converted date:",DateofInclusioninPLAloc_new);
                ...
                SKLogger_CC.writeLog("EventListenerHandler", "Exception occured in btnOk_Clicked: " + e.getMessage());
           }
       }*/
        ...
        if (m_objPickList.getAssociatedTxtCtrl().equalsIgnoreCase("EMploymentDetails_Button2")) {
            ...
            try{
			     ...
			     // changes done to check duplicate selection compare emp code and main emp code if/else condition added - 06-09-2017 Disha
                	 SKLogger_CC.writeLog("EventListenerHandler", "value of Emp Code" +  m_objPickList.getSelectedValue().get(1));
                	 SKLogger_CC.writeLog("EventListenerHandler", "value of main Emp Code" +  m_objPickList.getSelectedValue().get(9));
				...
				{     
					SKLogger_CC.writeLog("EventListenerHandler", "Employer code does not match main employer code");
        ...
        if (m_objPickList.getAssociatedTxtCtrl().equalsIgnoreCase("CustDetailVerification1_Button2")) {
    		...
    		SKLogger_CC.writeLog("EventListenerHandler", "Exception occured in btnOk_Clicked: " + ex.getMessage());
    	}
}  
