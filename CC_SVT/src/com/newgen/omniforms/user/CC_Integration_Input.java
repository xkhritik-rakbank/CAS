	...
	public String getcontact_details(){
		...
		try{
			if("PRIMARY".equalsIgnoreCase(App_type))
			{
				...
				Contactdetails_xml_str = Contactdetails_xml_str+"<ContactDetails><PrefModeOfContact>Email</PrefModeOfContact><EmailDet><MailIdType>WORKEML</MailIdType><EmailID>"+formObject.getNGValue("AlternateContactDetails_Email1")+"</EmailID><MailPrefFlag>Y</MailPrefFlag></EmailDet></ContactDetails>";//change by deepak Sir
            ...
            desctoFormCtrl.put("PS:Account:F171","A 10058 :Send SMS Option    ");
                    ...
                    for(Map.Entry<String, String> entry : desctoFormCtrl.entrySet()){
                        ...
                        if(entry.getKey().contains("F154")){
        					...
        					ext_xml_str += addExtensionValue(entry.getKey(),entry.getValue(),"N",extcount);
        					extcount++;
        				}
