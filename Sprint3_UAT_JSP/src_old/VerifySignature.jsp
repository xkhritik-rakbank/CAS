...
String Mandates = request.getParameter("docIndex");
...
WriteLog("ItemIndex: "+ItemIndex);
String CustSeqNo=request.getParameter("CustSeqNo");
                    ...
                    WriteLog("num lenght: "+num);
	               	if (num > 0) {
						...
						if(!"".equalsIgnoreCase(mqOutputResponse)){
							mqOutputResponse = getOutWtthMessageID(mqOutputResponse,sessionId,winame,JtsIP,JtsPort,appServerType,cabinetName);
						}
