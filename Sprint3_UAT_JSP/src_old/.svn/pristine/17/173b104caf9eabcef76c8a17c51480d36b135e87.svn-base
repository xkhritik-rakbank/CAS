        ...
        var core = {
            ...
            init: function (element) {
                ...
                core.waitToggle(element, true, function () {
                    core.render(element);
                    callBackFor_GanttChartRendered();//Sanjeev added
                });
            },
            ...
            leftPanel: function (element) {
                ...
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage && i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
                        entries.push('<div class="row name row fn-wide' + '" id="rowheader' + i + '" offset="' + i % settings.itemsPerPage * tools.getCellSize() + '">');
                        if(entry.name != '')
                        {
                            entries.push('<span onmouseover="showGanttLabel(event,\'' + entry.name + '\');" onmouseout="hideGanttLabel();" onmousemove="moveGanttLabel(event);" class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '">' + (entry.name || '') + '</span>');
                        }
                        else {
                            //entries.push('<div class="row desc row' + i + ' " id="RowdId_' + i + '" data-id="' + entry.id + '">');
                            entries.push('<span onmouseover="showGanttLabel(event,\'' + entry.desc + '\');" onmouseout="hideGanttLabel();" onmousemove="moveGanttLabel(event);" class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '">' + entry.desc + '</span>');
                        //entries.push('</div>');
                        }
                        entries.push('</div>');
                    }
            ...
            createProgressBar: function (days, cls, desc, label, dataObj) {
                ...
                var barStr = '<div class="bar"><div class="fn-label">' + label + '</div></div>';
                /*if(cls === 'gantt_Case_Red')
                {
                    barStr = '<div class="bar"><div class="fn-label"><span class="gantt_CaseSide_Red" style="float:left"></span>' + label + '<span class="gantt_CaseSide_Red"  style="float:right"></span></div></div>';
                }
                else if(cls === 'gantt_Case_Blue')
                {
                    barStr = '<div class="bar"><div class="fn-label"><span class="gantt_CaseSide_Blue" style="float:left"></span>' + label + '<span class="gantt_CaseSide_Blue"  style="float:right"></span></div></div>';
                }*/
