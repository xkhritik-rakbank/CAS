...
<%
	...
	String input1 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("result"), 100000, true) );
	...
	try {
		...
		if(request.getParameter("CardNumber")!=null){
			input10 = ""+Integer.parseInt(request.getParameter("CardNumber"));
...
<%!
	...
	public static String commonParseProduct_collection(String parseXml,String tagName,String wi_name,String returnType,String sTableName,String wrapperIP,String wrapperPort,String sessionId,String cabinetName,String appServerType, String subTagName,String prod,String subprod, String cifId,String subtag_single,String cust_type)
	{
		...
		*/		  
					...
					//PCASP-2833 
					String isDirect = (parseXml.contains("<IsDirect>")) ? parseXml.substring(parseXml.indexOf("<IsDirect>")+"</IsDirect>".length()-1,parseXml.indexOf("</IsDirect>")):"N";
					 columnName = valueArr[0]+",Wi_Name,Request_Type,CifId,CreditGrade,isDirect";
						  columnValues = valueArr[1]+",'"+wi_name+"','"+returnType+"','"+cifId+"','"+CreditGrade+"','"+isDirect+"'";
						  sWhere="Wi_Name='"+wi_name+"' AND AcctId = '"+entry.getKey()+"'";
