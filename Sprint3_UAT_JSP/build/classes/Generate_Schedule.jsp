...
String sSessionId = wDSession.getM_objUserInfo().getM_strSessionId();
	...
	String funding_status = ESAPI.encoder().encodeForSQL(new OracleCodec(), input15);
	...
	String Emi_val = ESAPI.encoder().encodeForSQL(new OracleCodec(), input14);
	...
	String schemecode = ESAPI.encoder().encodeForSQL(new OracleCodec(), input16);
...
<script src="${pageContext.request.contextPath}/custom/js/custom.js"></script>
 <script>
		...
		var funding_status = ($ESAPI.encoder().decodeForHTML(funding_status_encode));
		...
		var schemecode=($ESAPI.encoder().decodeForHTML(schemecode_encode));
		//svt points end
