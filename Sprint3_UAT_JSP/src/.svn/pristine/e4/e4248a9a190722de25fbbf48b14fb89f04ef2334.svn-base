...
function saveDate() {
		...
		for(var row_arr_count= 1;row_arr_count<=totalrowid;row_arr_count++){
				...
				var params="table="+stable+"&columnsNames="+data_save_var_db_name+"&columnsValues="+value+"&swhere="+swhere+"&WD_UID="+WD_UID;
...
function fetchGridData()
{
	...
	var wparams="";
	//svt points start
	params="wi_name="+winame+"&WD_UID="+WD_UID;
	...
	if(cifId==null){
		cifId = window.parent.com.newgen.omniforms.formviewer.getNGValue('cmplx_Customer_CIFNO');
	}
	var sQry="CCCRPL";
	if('CDOB'==winame.substring(0,winame.indexOf("-"))){
		cifId='No Data';
	}
	...
	wparams="child_Wi=="+winame+"~~child_Wi=="+winame+"~~child_Wi=="+winame+"~~child_Wi=="+winame+"~~cifId=="+cifId+"~~cifId=="+cifId;
	}
	else{//RLOS
	var sQry="!CCCRPL";
	var cifId = window.parent.com.newgen.omniforms.formviewer.getNGValue('cmplx_Customer_CIFNO');
	...
	wparams="Wi_Name=="+winame+"~~Wi_Name=="+winame+"~~Wi_Name=="+winame+"~~CifId=="+cifId+"~~CifId=="+cifId;
	}
	...
	//alert("0:"+col_id_arr[0]+","+"1:"+col_id_arr[1]+","+"2:"+col_id_arr[2]+","+"3:"+col_id_arr[3]+","+"4:"+col_id_arr[4]+","+"5:"+col_id_arr[5]+","+"6:"+col_id_arr[6]+","+"length:"+col_id_arr.length);
		...
		for(var i=0;i<row_arr.length-1;i++){
			...
			if(col_id_arr[1]=="text"){
				...
				if(col_id_arr[3] == "Takeover_Indicator"){
					if(value=='true'){
						...
						table_row = table_row +"<td>"+"<input id = '"+col_id_arr[3]+"_"+row_num+"' type = '"+ col_id_arr[1] +"' name = '"+col_id_arr[3]+"_"+row_num+"' "+col_id_arr[5]+" onclick='enableTakeoverAmount(this.id);' >"+"</td>";
					}
				}
			//below code added by akshay on 3/12/17 for auto checking editable checkboxes
					...
					table_row = table_row +"<td>"+"<input id = '"+col_id_arr[3]+"_"+row_num+"' type = '"+ col_id_arr[1] +"' name = '"+col_id_arr[3]+"_"+row_num+"' "+col_id_arr[4]+" "+col_id_arr[5]+"  onclick='Re_trigger_dectech(this.id);'>"+"</td>";
				}
			}
