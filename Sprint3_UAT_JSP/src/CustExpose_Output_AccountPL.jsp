...
<%
	...
	String accNo = ESAPI.encoder().encodeForSQL(new OracleCodec(), input3!=null?input3:"");
	...
	String input5 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("row_count"), 1000, true) );
	String row_count = ESAPI.encoder().encodeForSQL(new OracleCodec(), input5!=null?input5:"");
