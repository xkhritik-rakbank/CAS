...
function saveDate() {
		...
		for(var i=1;i<=row_id_arr.length;i++){
			...
			if(document.getElementById(curr_flag).value =='N'){
				...
				else if((document.getElementById(combined_limit_flag).value == '0')&&(document.getElementById(final_limit).value!='')){
	...
	for(var row_arr_count= 1;row_arr_count<=totalrowid;row_arr_count++){
				...
				var params="table="+stable+"&columnsNames="+InputField_id+"&columnsValues="+value+"&swhere="+swhere+"&WD_UID="+WD_UID;
		...
		if(id.indexOf('Cardproductselect')>-1)
		{
			...
			if(!selectedRow[row]){
				...
				if(Object.keys(selectedRow).length==0){
					...
					window.parent.com.newgen.omniforms.formviewer.setNGValueCustom('CardDetails_Islamic_mandatory','N');
				}
				else{
				var mandatory_flag =false;
					...
					if(mandatory_flag){
						window.parent.com.newgen.omniforms.formviewer.setNGValueCustom('CardDetails_Islamic_mandatory','Y');
					}
					else{
					window.parent.com.newgen.omniforms.formviewer.setNGValueCustom('CardDetails_Islamic_mandatory','N');
					}
			...
			if(cc_waiver_flag){
				...
				window.parent.com.newgen.omniforms.formviewer.setEnabledCustom('cmplx_CardDetails_SuppCardReq',false);
				...
				window.parent.com.newgen.omniforms.formviewer.setEnabledCustom('cmplx_CardDetails_SuppCardReq',true);
				window.parent.com.newgen.omniforms.formviewer.setLockedCustom('CardDetails_Frame1',false);//added by akshay on 27/12/17
