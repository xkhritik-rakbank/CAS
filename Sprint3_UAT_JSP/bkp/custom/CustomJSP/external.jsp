...
<%
	...
	String input2 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", (String) request.getParameter("Wi_Name"), 1000, true) );
	String Wi_Name = ESAPI.encoder().encodeForSQL(new OracleCodec(), input2);
		
	String input3 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", (String) request.getParameter("AgreementId"), 1000, true) );
	String AgreementId = ESAPI.encoder().encodeForSQL(new OracleCodec(), input3);
			...
			params = "AgreementId=="+AgreementId+"~~Wi_Name=="+Wi_Name;	
			  ...
			  WriteLog("sQuery1 "+sQuery1);
			   WriteLog("sQuery2 "+sQuery2);
				...
				inputXML_Common=ExecuteQuery_APSelectwithparam(sQuery_Common,params,cabinetName,sessionId);
				...
				inputXML1=ExecuteQuery_APSelectwithparam(sQuery1,params,cabinetName,sessionId);
...
<fieldset>
  ...
  <table cellspacing="10" cellpadding="5">
	...
	<tr>
		...
		<td style="padding:0 15px 0 15px;"><input type="text" name="full_name" value="<%=currMaxUtil%>" disabled></td>
	...
	<tr>
		...
		<td style="padding:0 15px 0 15px;"><input type="text" name="full_name" value="<%=AECBHistMonthCnt%>" disabled></td>
