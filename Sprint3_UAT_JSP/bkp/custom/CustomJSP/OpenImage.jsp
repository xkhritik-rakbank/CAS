...
<%
	...
	String filePath =System.getProperty("user.dir")+File.separatorChar+"installedApps"+File.separatorChar+"ANT2CASAPPS01Node01Cell"+File.separatorChar+"webdesktop.ear"+File.separatorChar+"webdesktop.war"+File.separatorChar+"CustomForms"+File.separatorChar+"RLOS";
