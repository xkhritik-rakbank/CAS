...
<%
	...
	WriteLog("Inside MultipleAccNo.jsp---WI No : "+wi_name);
	...
	String sQuery = "select AcctId from ng_RLOS_CUSTEXPOSE_AcctDetails with (nolock) where child_wi ='"+wi_name+"' and Request_Type ='InternalExposure'";
			  WriteLog("sMQuery "+sQuery);
				...
				tagName = "Record";
				subTagName = "AcctId";
				acctId = commonParse(outputXML,tagName,subTagName);
				WriteLog("commonParse select acctId --> "+acctId);
				outputResponse= acctId;	
