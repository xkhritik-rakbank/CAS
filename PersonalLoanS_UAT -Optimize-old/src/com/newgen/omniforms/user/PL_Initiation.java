...
public class PL_Initiation extends PLCommon implements FormListener{
	...
	public void formLoaded(FormEvent pEvent) {
		mLogger.info("PersonnalLoanS> PL_Iniation"+ "Inside PL PROCESS formLoaded()" + pEvent.getSource());
	...
	public void formPopulated(FormEvent pEvent) {
		...
		mLogger.info("PersonnalLoanS>  PL_Iniation"+ "Inside PL PROCESS formPopulated()" + pEvent.getSource());
