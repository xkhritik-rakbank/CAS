...
public class PL_CSM extends PLCommon implements FormListener
{
	...
	{
		mLogger.info("PL CSM insidde-->Inside formLoaded()" + pEvent.getSource().getName());
	...
	public void initialize() {
		mLogger.info( "Inside PL PROCESS initialize()" );

	}


	public void saveFormCompleted(FormEvent pEvent) throws ValidatorException {
		mLogger.info( "Inside PL PROCESS saveFormCompleted()" + pEvent.getSource());
	...
	public void submitFormStarted(FormEvent pEvent) throws ValidatorException {
		mLogger.info( "Inside PL PROCESS submitFormStarted()" + pEvent.getSource());
		...
		mLogger.info("Final val of fullName:"+ fullName);
