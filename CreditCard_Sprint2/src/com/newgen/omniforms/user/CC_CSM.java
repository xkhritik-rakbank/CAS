		...
		/*if (pEvent.getSource().getName().equalsIgnoreCase("Product")) {
			...
			// ++ below code not commented at offshore - 06-10-2017
				...
				CreditCard.mLogger.info("after all setto and get top"+formObject.getNGValue("cmplx_EmploymentDetails_Designation"));
                 ...
                 formObject.setVisible("EMploymentDetails_Text19",true);
				...
				// Ref. 1003 end.
                  //++Below code added by nikhil 7/11/17 as per CC issues sheet
                    ...
                    formObject.setTop("EMploymentDetails_Text19", 297);
                    formObject.setTop("EMploymentDetails_Label44", 282);
                    formObject.setTop("cmplx_EmploymentDetails_PremPaid",297);
                    formObject.setTop("EMploymentDetails_Label46", 307);
                    formObject.setTop("cmplx_EmploymentDetails_PremType", 312);
                    formObject.setTop("EMploymentDetails_Label47", 307);
                    formObject.setTop("cmplx_EmploymentDetails_RegPayment",307);
                    formObject.setTop("EMploymentDetails_Label52", 322);
                    formObject.setTop("cmplx_EmploymentDetails_MinimumWait", 322);
                    formObject.setTop("EMploymentDetails_Label54",  322);
                    
                    formObject.setTop("cmplx_EmploymentDetails_MotorInsurance",  337);
    				...
    				formObject.setHeight("EMploymentDetails_Frame2",400);
