...
public class CC_CAD_Analyst_1 extends CC_Common implements FormListener
{
	...
	public void submitFormStarted(FormEvent arg0) throws ValidatorException 
	{
		...
		try{
			...
			if("Approve Sub to CIF".equalsIgnoreCase(formObject.getNGValue("cmplx_CustDetailVerification_Decision")) && !"C".equalsIgnoreCase("IS_Approve_Cif"))
			{
	...
	private void fragment_loaded(FormEvent pEvent,HashMap<String,String> hm,FormReference formObject)
	{
		...
		//added by yash for CC FSD
			...
			formObject.setLocked("cmplx_IncomeDetails_CompanyAcc",false);
