...
public class CDOB_CSM extends CDOB_Common implements FormListener,Serializable
{
	/**
	 * 
	 */
	    	 ...
	    	 try
				{
	    		 String Wi_Name=formObject.getWFWorkitemName();
					...
					catch(Exception ex)
					{
						//formObject.setNGValue("AECBHistMonthCnt", "0");
						formObject.setNGValue("Is_Principal_Approval", "Y");
						DigitalOnBoarding.mLogger.info("exception in calculate aecb month count"+ex.getMessage());
					}
	        }catch(Exception e)
	        {
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
		/*if (pEvent.getSource().getName().equalsIgnoreCase("Product")) {
			...
			if ("Customer".equalsIgnoreCase(pEvent.getSource().getName())) {
				DigitalOnBoarding.mLogger.info( "start of customer");
				...
				// added for point 22
					...
					DigitalOnBoarding.mLogger.info( "Exception is: "+printException(ex));
				}
				DigitalOnBoarding.mLogger.info( "end of customer");
			}	
			...
			// ++ below code not commented at offshore - 06-10-2017
				...
				DigitalOnBoarding.mLogger.info("before loadng picklist");
				  ...
				  DigitalOnBoarding.mLogger.info("after loadng picklist");
				//++ Above Code already exists for : "18-CSM-Liability addition-" Incorrect masters in type of contract field" : Reported By Shashank on Oct 05, 2017++
				  DigitalOnBoarding.mLogger.info("after liability Details of CSM456");
				...
				formObject.setEnabled("ExtLiability_Takeoverindicator", false);
				 DigitalOnBoarding.mLogger.info("after liability Details of CSM123");
				...
				DigitalOnBoarding.mLogger.info("before disableButtonsCC"+formObject.getNGValue("cmplx_EmploymentDetails_Designation"));
				disableButtonsCC("EMploymentDetails");
				DigitalOnBoarding.mLogger.info("before setALOCListed"+formObject.getNGValue("cmplx_EmploymentDetails_Designation"));
				
				setALOCListed();
				DigitalOnBoarding.mLogger.info("before loadPicklistEmployment"+formObject.getNGValue("cmplx_EmploymentDetails_Designation"));
				
				//loadPicklistEmployment();
				DigitalOnBoarding.mLogger.info("after loadPicklistEmployment"+formObject.getNGValue("cmplx_EmploymentDetails_Designation"));
				loadPicklistEmployment();
				DigitalOnBoarding.mLogger.info("after loadPicklist4"+formObject.getNGValue("cmplx_EmploymentDetails_Designation"));
				
				Fields_ApplicationType_Employment();
				DigitalOnBoarding.mLogger.info("after Fields_ApplicationType_Employment"+formObject.getNGValue("cmplx_EmploymentDetails_Designation"));
				...
				DigitalOnBoarding.mLogger.info("after all setto and get top"+formObject.getNGValue("cmplx_EmploymentDetails_Designation"));
				if("LIFSUR".equalsIgnoreCase(formObject.getNGValue("cmplx_EmploymentDetails_targetSegCode")))
				{//EMploymentDetails_Label41
					DigitalOnBoarding.mLogger.info("@sagarika emp");
               ...
               //  formObject.setVisible("cmplx_EmploymentDetails_MinimumWait", true);
				...
				{//cmplx_EmploymentDetails_MotorInsurance
					DigitalOnBoarding.mLogger.info("@sagarika motsur");
              ...
              //    formObject.setEnabled("cmplx_EmploymentDetails_MotorInsurance",true);
				...
				// Ref. 1003 end. EMploymentDetails_Frame2 cmplx_EmploymentDetails_InsuranceValue
                  //++Below code added by nikhil 7/11/17 as per CC issues sheet
                    DigitalOnBoarding.mLogger.info("ssss-emp");
                 ...
                 //   formObject.setTop("EMploymentDetails_Label54",  327);
                  ...
                  //cmplx_EmploymentDetails_IndusSeg
    				...
    				DigitalOnBoarding.mLogger.info("end of fetchfrag of employment"+formObject.getNGValue("cmplx_EmploymentDetails_Designation"));
			...
			//changes by saurabh for DROP-4
				...
				*/
				...
				if("Yes".equalsIgnoreCase(formObject.getNGValue("cmplx_CardDetails_Supplementary_Card"))){
					DigitalOnBoarding.mLogger.info("Is Supp req is yes: ");
					...
					if(formObject.getWFActivityName().equalsIgnoreCase("DDVT_Checker") || formObject.getWFActivityName().equalsIgnoreCase("Disbursal")){
						DigitalOnBoarding.mLogger.info("activity is checker: ");
			...
			{
				DigitalOnBoarding.mLogger.info( "Activity name is:" + formObject.getNGValue("cmplx_CC_Loan_DDSMode"));
				...
				if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_F").equalsIgnoreCase(formObject.getNGValue("cmplx_CC_Loan_ModeOfSI"))){
					formObject.setLocked("cmplx_CC_Loan_FlatAMount",false);
					formObject.setLocked("cmplx_CC_Loan_SI_Percentage",true);

				}
				else if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_P").equalsIgnoreCase(formObject.getNGValue("cmplx_CC_Loan_ModeOfSI"))){
