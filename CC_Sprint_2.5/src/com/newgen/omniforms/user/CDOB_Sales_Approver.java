...
Module                                                            : Sales Approver

File Name                                                         : CC_Sales_Approver
...
public class CDOB_Sales_Approver extends CDOB_Common implements FormListener
{
	/**
	 * 
	 */
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
		...
		//added by yash on 30/8/2017
			...
			//formObject.setLocked("NotepadDetails_Frame1",true);
			  ...
			  //for decision fragment made changes 8th dec 2017s
