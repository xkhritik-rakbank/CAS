...
import com.newgen.omniforms.user.CDOB_Common;
import com.newgen.omniforms.user.DigitalOnBoarding;
import com.newgen.omniforms.user.NGFUserResourceMgr_DigitalOnBoarding;
 ...
 * @author mohit.sharma
 */
public class EventListenerHandler_CDOB extends EventListenerImplementor {

    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public EventListenerHandler_CDOB(String picklistid) {
        super(picklistid);
    }

    public EventListenerHandler_CDOB(String picklistid, EVENT compId) {
    ...
    public void btnSearch_Clicked(ActionEvent ae) {
        DigitalOnBoarding.mLogger.info("Inside method btnSearch_Clicked");
        ...
        DigitalOnBoarding.mLogger.info("@nikhil"+m_objPickList.getAssociatedTxtCtrl());
        ...
        else  if ("CompanyDetails_Aloc_search".equalsIgnoreCase(m_objPickList.getAssociatedTxtCtrl()))
        {
            ...
            for(int i=0;i<20;i++)
                DigitalOnBoarding.mLogger.info("Column "+i+"is: "+ m_objPickList.getSelectedValue().get(i));
        }
        	...
        	DigitalOnBoarding.mLogger.info("Inside method Button_State inside state"+m_objPickList.getAssociatedTxtCtrl());
            filter_value = m_objPickList.getSearchFilterValue();
            m_objPickList.setBatchRequired(true);
            m_objPickList.setBatchSize(25);        
            ...
            List<List<String>> result=formObject.getNGDataFromDataCache(query);
            DigitalOnBoarding.mLogger.info("Inside method btnSearch_Clicked"+query);
            m_objPickList.populateData(result);
        ...
        {	DigitalOnBoarding.mLogger.info("Inside method Button_City inside state"+m_objPickList.getAssociatedTxtCtrl());
           filter_value = m_objPickList.getSearchFilterValue();
           m_objPickList.setBatchRequired(true);
           m_objPickList.setBatchSize(25);        
        ...
        {	DigitalOnBoarding.mLogger.info("Inside method Designation_button1 inside state"+m_objPickList.getAssociatedTxtCtrl());
           filter_value = m_objPickList.getSearchFilterValue();
           m_objPickList.setBatchRequired(true);
           m_objPickList.setBatchSize(25);        
           ...
           DigitalOnBoarding.mLogger.info("sagarika vishnoi");   
           List<List<String>> result=formObject.getNGDataFromDataCache(query);
           DigitalOnBoarding.mLogger.info("Inside method btnSearch_Clicked"+query);
           m_objPickList.populateData(result);
        ...
        {	DigitalOnBoarding.mLogger.info("Inside method Designation_button2 inside state"+m_objPickList.getAssociatedTxtCtrl());
           filter_value = m_objPickList.getSearchFilterValue();
           m_objPickList.setBatchRequired(true);
           m_objPickList.setBatchSize(25);        
           String query="select description,code from NG_MASTER_Designation with (nolock)  where isActive='Y' and code like'%"  + filter_value + "%' or Description Like'%" + filter_value + "%'";
           DigitalOnBoarding.mLogger.info("sagarika vishnoi d2");   
           List<List<String>> result=formObject.getNGDataFromDataCache(query);
           DigitalOnBoarding.mLogger.info("Inside method btnSearch_Clicked"+query);
           m_objPickList.populateData(result);
       ...
       //Designation_button
        ...
        m_objPickList.populateData(result);
            ...
            DigitalOnBoarding.mLogger.info("Inside method Card Dispatch inside state"+m_objPickList.getAssociatedTxtCtrl());
            filter_value = m_objPickList.getSearchFilterValue();
            m_objPickList.setBatchRequired(true);
            m_objPickList.setBatchSize(25);
            //query changed by nikhil for PCSP-635
			...
			DigitalOnBoarding.mLogger.info("PL"+"##AKshay: "+Cntrl_name+" aman: "+filter_value);
			
			m_objPickList.setBatchRequired(true);
			m_objPickList.setBatchSize(25);
			String val=NGFUserResourceMgr_DigitalOnBoarding.getMasterManagerSecond(Cntrl_name);
			DigitalOnBoarding.mLogger.info("PL"+"##AKshay: "+Cntrl_name+" aman: "+val);
			String[] value= val.split(":");
			String sColumnName=value[1];
			String[] sCol=sColumnName.split(",");
			DigitalOnBoarding.mLogger.info("PL"+"##AKshay: "+filter_value);
			...
			DigitalOnBoarding.mLogger.info("PL"+"##AKshay"+query);
			List<List<String>> result=formObject.getNGDataFromDataCache(query);
			DigitalOnBoarding.mLogger.info("Inside method btnSearch_Clicked"+query);
			m_objPickList.populateData(result);
		}
    ...
    public void btnOk_Clicked(ActionEvent ae) throws ValidatorException {
       ...
       Common_Utils common=new Common_Utils(DigitalOnBoarding.mLogger);
		FormReference formObject = FormContext.getCurrentInstance().getFormReference();
       DigitalOnBoarding.mLogger.info( "Val of m_objPickList.getAssociatedTxtCtrl() is:"+m_objPickList.getAssociatedTxtCtrl());
       if ("EMploymentDetails_Button2".equalsIgnoreCase(m_objPickList.getAssociatedTxtCtrl())) {
        if( m_objPickList.getSelectedValue().get(1).equalsIgnoreCase( m_objPickList.getSelectedValue().get(23)))
		{
			...
			DigitalOnBoarding.mLogger.info( "before Micro");
	       ...
	       // OFUtility.updateState("cmplx_EmploymentDetails_Indus_Micro", "value", m_objPickList.getSelectedValue().get(13) , "setNGValue");
            ...
            DigitalOnBoarding.mLogger.info("before setting value in indus micro: "+formObject.getNGValue("cmplx_EmploymentDetails_Indus_Macro"));
            ...
            DigitalOnBoarding.mLogger.info("after setting value in indus micro"+formObject.getNGValue("cmplx_EmploymentDetails_Indus_Micro"));
			}
			DigitalOnBoarding.mLogger.info( "After micro code");
       ...
       if("CompanyDetails_Aloc_search".equalsIgnoreCase(m_objPickList.getAssociatedTxtCtrl()))
       {
        ...
        if ("CustDetailVerification1_Button2".equalsIgnoreCase(m_objPickList.getAssociatedTxtCtrl())) {
            DigitalOnBoarding.mLogger.info( "Inside OK button");
            
                DigitalOnBoarding.mLogger.info(m_objPickList.getSelectedValue().get(7));
                List<String> mylist = new ArrayList<String>();
                mylist.add("cmplx_CustDetailverification1_EmiratesId");
          
       }
        else if ("Button_State".equalsIgnoreCase(m_objPickList.getAssociatedTxtCtrl())||"AddressDetails_state".equalsIgnoreCase(m_objPickList.getAssociatedTxtCtrl())) {
        	DigitalOnBoarding.mLogger.info("Inside Button_State catch: ");
        	DigitalOnBoarding.mLogger.info("Inside Button_State catch: "+m_objPickList.getSelectedValue().get(1));
        	...
        	DigitalOnBoarding.mLogger.info("Inside Button_City catch: "+m_objPickList.getSelectedValue().get(1));
        	...
        	DigitalOnBoarding.mLogger.info("Inside Designation_button1 catch: "+m_objPickList.getSelectedValue().get(1));
        	
        	OFUtility.updateState("cmplx_cust_ver_sp2_desig_remarks", "value", m_objPickList.getSelectedValue().get(1) , "setNGValue"); 
        	new CDOB_Common().Update_Office_Address();
        	...
        	DigitalOnBoarding.mLogger.info("Inside Designation_button2 catch: "+m_objPickList.getSelectedValue().get(1));
        	...
        	DigitalOnBoarding.mLogger.info("sagarika emp:"+m_objPickList.getSelectedValue().get(1));
    		...
    		if(framestate2 == 0){
    			...
    			DigitalOnBoarding.mLogger.info("fetched employment details sagarika 1");
    			OFUtility.updateState("cmplx_EmploymentDetails_Designation", "value", m_objPickList.getSelectedValue().get(0) , "setNGValue");
    		}
    		else {//end of fetchfrag of employment09
            	OFUtility.updateState("cmplx_EmploymentDetails_Designation", "value", m_objPickList.getSelectedValue().get(0) , "setNGValue"); 

    			DigitalOnBoarding.mLogger.info("fetched employment details sagarika");
    			//below code added by nikhil for PCSP-22
    			
    			
    		}
        	DigitalOnBoarding.mLogger.info("sagarika emp value change:"+formObject.getNGValue("cmplx_EmploymentDetails_Designation"));
        	new CDOB_Common().Update_Office_Address();
        }
      ...
      //--above code added by nikhil for PCAS-1212 CR
    		...
    		DigitalOnBoarding.mLogger.info( "Exception occured in btnOk_Clicked: " + ex.getMessage());
    ...
    public void btnPrev_Clicked(ActionEvent ae) {
        DigitalOnBoarding.mLogger.info("###########" + ae.getComponent().getClientId());
    }
}
