...
public class CDOB_FPU extends CDOB_Common implements FormListener
{
	/**
	 * 
	 */
	...
	public void formLoaded(FormEvent pEvent)
	{
		...
		makeSheetsInvisible("Tab1", "6,8,12,13,14,15,16,17");//pcaf-392
	...
	public void formPopulated(FormEvent pEvent) 
	{
		...
		try{
			DigitalOnBoarding.mLogger.info("Inside CC_FCU CC");
			...
			{*/
				formObject.setNGValue("Mandatory_Frames", NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("FCU_SAL_Frame_Name"));
			//}
		...
		/*if (pEvent.getSource().getName().equalsIgnoreCase("Product")) {
			...
			//added by yash on 30/8/2017
			    ...
			    formObject.setVisible("NotepadDetails_Frame3",true);
                 ...
                 formObject.setVisible("cmplx_DEC_AlocType", false);
                 formObject.setVisible("DecisionHistory_Label20", false);
