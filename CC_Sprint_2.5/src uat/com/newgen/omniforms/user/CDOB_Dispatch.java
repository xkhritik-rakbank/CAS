...
public class CDOB_Dispatch extends CDOB_Common implements FormListener
{
	/**
	 * 
	 */
	...
	{
	     try{
	    	 DigitalOnBoarding.mLogger.info("Inside CC Dispatch CC");
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
		/*if (pEvent.getSource().getName().equalsIgnoreCase("Product")) {
			...
			//	formObject.setLocked("EMploymentDetails_Frame1",true);
				...
				DigitalOnBoarding.mLogger.info("Inside alternate contact details fragment (Dispatch) :"+formObject.getNGValue("Card_Dispatch_Option"));
