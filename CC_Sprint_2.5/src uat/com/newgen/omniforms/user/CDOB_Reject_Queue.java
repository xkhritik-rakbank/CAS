...
public class CDOB_Reject_Queue extends CDOB_Common implements FormListener
{
	/**
	 * 
	 */
	...
	CDOB_Integration_Input Intgration_input = new CDOB_Integration_Input();
	CDOB_Integration_Output Intgration_Output = new CDOB_Integration_Output();
	...
	{
		try{
			DigitalOnBoarding.mLogger.info( "Inside Reject CC");
	...
	public void saveFormCompleted(FormEvent pEvent) throws ValidatorException {
		DigitalOnBoarding.mLogger.info( "Inside CC PROCESS saveFormCompleted()" + pEvent.getSource());
