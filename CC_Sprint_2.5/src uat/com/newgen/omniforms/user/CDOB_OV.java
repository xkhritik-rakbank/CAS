...
public class CDOB_OV extends CDOB_Common implements FormListener
{
	/**
	 * 
	 */
...
cmplx_DEC_VerificationRequired
	...
	public void formLoaded(FormEvent pEvent)
	{
		...
		makeSheetsInvisible("Tab1", "1,6,8,9,11,12,13,14,15,16,17");//pcaf-392
	//	makeSheetsInvisible("Tab1", "7,8,9,12,13,14,15,16,17");-cc
		DigitalOnBoarding.mLogger.info( "Inside formLoaded() of CC_OV");
	}
	...
	public void formPopulated(FormEvent pEvent) 
	{
		...
		try{
			DigitalOnBoarding.mLogger.info("Inside CC_OV CC");
			FormReference formObject = FormContext.getCurrentInstance().getFormReference();
			//formObject.setNGValue("Mandatory_Frames", NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("OV_Frame_Name"));as asked by Rachit:sagarika
			new CDOB_CommonCode().setFormHeader(pEvent);
			//Done By aman for Sprint2
			if (formObject.getNGValue("RefFrmOV").equals("Y") ){
	...
	public void saveFormStarted(FormEvent pEvent) throws ValidatorException {
		...
		if("Approve".equalsIgnoreCase(formObject.getNGValue("cmplx_DEC_Decision"))){
			DigitalOnBoarding.mLogger.info( "Inside Approve SFS OV WI: "+formObject.getWFWorkitemName());
			DigitalOnBoarding.mLogger.info( "Value of ORIGINAL_VALIDATION is : "+formObject.getNGValue("ORIGINAL_VALIDATION"));
	...
	public void submitFormStarted(FormEvent pEvent) throws ValidatorException {
		...
		DigitalOnBoarding.mLogger.info( "Inside PL OV_dec submitFormStarted()" +formObject.getNGValue("OV_dec"));
			 
		DigitalOnBoarding.mLogger.info( "Inside SFS OV WI: "+formObject.getNGValue("cmplx_DEC_Decision"));
		...
		if("Approve".equalsIgnoreCase(formObject.getNGValue("cmplx_DEC_Decision"))){
			...
			DigitalOnBoarding.mLogger.info( "Inside Reject SFS OV WI: "+formObject.getWFWorkitemName());
		...
		DigitalOnBoarding.mLogger.info( "Value of ORIGINAL_VALIDATION is : "+formObject.getNGValue("ORIGINAL_VALIDATION"));
			...
			DigitalOnBoarding.mLogger.info( "Inside Exception submitFormstarted");
		}
		finally{
			//app OV validation for document section
			//OriginalDocs(); sagarika for digitalonboarding as asked by rachit
			saveIndecisionGrid();
			LoadReferGrid();
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
			if ("Customer".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				formObject.setLocked("cmplx_Customer_IdIssueDate", false);//added by saurabh1
				formObject.setLocked("cmplx_Customer_EmirateIDExpiry", false);//added by saurabh1
				...
				formObject.setVisible("OriginalValidation_Customer_Update",true);//added by saurabh1
				formObject.setLocked("OriginalValidation_Customer_Update",false);//added by saurabh1
...
//			formObject.setLocked("CompanyDetails_Frame2", true);
		...
		//added by yash on 24/8/2017
			...
			//commented by nikhil for wrong value set
			...
			//ormObject.setNGValue("NotepadDetails_user",formObject.getNGValue("cmplx_Customer_FirstNAme") +" "+ formObject.getNGValue("cmplx_Customer_MiddleNAme") +" "+ formObject.getNGValue("cmplx_Customer_LastNAme"));
		...
		/*	formObject.setVisible("DecisionHistory_CheckBox1",false);
			...
			//12th sept
			  ...
			  formObject.setHeight("DecisionHistory_Frame1", formObject.getTop("DecisionHistory_save")+ formObject.getHeight("DecisionHistory_save")+20);
				...
				if(!formObject.isVisible("OriginalValidation_Frame1")){
