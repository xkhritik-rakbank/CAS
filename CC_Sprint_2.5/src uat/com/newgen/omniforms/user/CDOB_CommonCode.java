...
public class CDOB_CommonCode extends CDOB_Common {
	...
	public void FrameExpandEvent(ComponentEvent pEvent){
		...
		try{
			...
			DigitalOnBoarding.mLogger.info("Inside CC_CommonCode-->FrameExpandEvent()");
			...
			if ("EmploymentDetails".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				DigitalOnBoarding.mLogger.info("This is on click of employment details ");
			...
			if ("Internal_External_Liability".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				DigitalOnBoarding.mLogger.info("fetch_Liability_frag : Activity Name::"+formObject.getWFActivityName()+" WI No. ::"+formObject.getWFWorkitemName());
				setScoreRange();
				formObject.setLocked("cmplx_Liability_New_DBR",true);
				formObject.setLocked("cmplx_Liability_New_TAI",true);
				formObject.setLocked("cmplx_Liability_New_DBRNet",true);
				...
				if("Salaried".equalsIgnoreCase(empType) || "Salaried Pensioner".equalsIgnoreCase(empType)|| "Pensioner".equalsIgnoreCase(empType)){
					...
					DigitalOnBoarding.mLogger.info("framestate for Employment is: "+framestate2);
					if(framestate2 == 0){
						DigitalOnBoarding.mLogger.info("EmploymentDetails");
					}
					else {
						loadEmployment();
						DigitalOnBoarding.mLogger.info("fetched cacacacaca employment details");
					}
					DigitalOnBoarding.mLogger.info( "Inside Self Employed case for liabilities");
				...
				//Deepak 09102017- JIRA 2864 to load company details in case of Self Employed while loading employment details
					...
					formObject.setVisible("cmplx_Liability_New_CACBankName", true);
					formObject.setVisible("Liability_New_Label12", true);
					DigitalOnBoarding.mLogger.info("framestate for Company is: "+framestate2);
					if(framestate2 == 0){
						DigitalOnBoarding.mLogger.info("EmploymentDetails");
					}
					else {
					...
					DigitalOnBoarding.mLogger.info( "Inside Salaried case for liabilities");
				...
				if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_CSM").equalsIgnoreCase(activity)){
			...
			if ("Alt_Contact_container".equalsIgnoreCase(pEvent.getSource().getName())) 
			{
				...
				DigitalOnBoarding.mLogger.info("before invisibility");
				if("DDVT_maker".equalsIgnoreCase(activityName))
				{
				...
				DigitalOnBoarding.mLogger.info("after invisibility");
				try{
					...
					DigitalOnBoarding.mLogger.info("Exception in setting Estatement flag as default yes:"+printException(ex));	
				}
			...
			if("Loan_Disbursal".equalsIgnoreCase(pEvent.getSource().getName())){
				...
				DigitalOnBoarding.mLogger.info("after loan disbursal fragment");
			}
			...
			if ("DecisionHistory".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				expandDecision();
				DigitalOnBoarding.mLogger.info("After Expand decision");
				formObject.fetchFragment("DecisionHistory", "DecisionHistory", "q_DecisionHistory");
				loadInDecGrid();
				DigitalOnBoarding.mLogger.info("After Load in DEc frid");
				loadPicklist3();
				DigitalOnBoarding.mLogger.info("After Loadpicklist3");
				formObject.setLocked("cmplx_DEC_ReferTo", true);
				DigitalOnBoarding.mLogger.info("Before IF");
				/*if("CAD_Analyst1".equalsIgnoreCase(formObject.getWFActivityName())){
					formObject.fetchFragment("DecisionHistory", "DecisionHistory", "q_DecisionHistory");xs
				}*/
				load_Customer_Details_Verification(formObject);
				if("CPV_Analyst".equalsIgnoreCase(formObject.getWFActivityName()))
				{
				 formObject.setNGValue("cmplx_DEC_SetReminder","");
				}
				...
				DigitalOnBoarding.mLogger.info("Done");
				try
				{
					throw new ValidatorException(new CustomExceptionHandler("Error Message", "Text1","EventType", hm));
				}
			...
			if ("Frame4".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				DigitalOnBoarding.mLogger.info("IncomingDocuments");
				...
				if("Salaried".equalsIgnoreCase(formObject.getNGValue("EmploymentType"))){
					...
					if(framestate_CompDetails == 0){
						DigitalOnBoarding.mLogger.info("CompDetails already fetched");
					}
					else {
						formObject.fetchFragment("CompDetails", "CompanyDetails", "q_CompanyDetails");
						DigitalOnBoarding.mLogger.info("fetched CompDetails details");
					}
				}
				formObject.fetchFragment("Frame4","IncomingDocNew","q_incomingDocNew");
				DigitalOnBoarding.mLogger.info("fetchIncomingDocRepeater");
				...
				DigitalOnBoarding.mLogger.info("formObject.fetchFragment1");
				try{
			...
			if ("Card_Details".equalsIgnoreCase(pEvent.getSource().getName())) {
				//formObject.fetchFragment(arg0, arg1, arg2)
				DigitalOnBoarding.mLogger.info("Fetch fragment called test Sajan");
				...
				if(!"CSM".equalsIgnoreCase(activityName))
				{
					...
					if("".equalsIgnoreCase(formObject.getNGValue("cmplx_CardDetails_Statement_cycle"))){
						if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_Salaried").equalsIgnoreCase(formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0,6))){
			...
			/*	DigitalOnBoarding.mLogger.info("This is expanding finacle core test 111");
				
				formObject.setNGFrameState("Finacle_Core", 1);*/
				/*formObject.getHeight("Finacle_Core");
				formObject.getTop("Finacle_Core");*/
			...
			if ("MOL".equalsIgnoreCase(pEvent.getSource().getName())) {
				/*hm.put("MOL","Clicked");
				popupFlag="N";*/
				DigitalOnBoarding.mLogger.info("This is MOL expanding test 111");
			...
			if ("Salary_Enquiry".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				DigitalOnBoarding.mLogger.info( "Data to be added in account Grid account query: "+query);
				List<List<String>> list_acc=formObject.getNGDataFromDataCache(query);
				for(List<String> mylist : list_acc)
				{
					DigitalOnBoarding.mLogger.info( "Data to be added in account Grid account Grid: "+mylist.toString());
			...
			if ("Smart_Check1".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				if("FPU".equalsIgnoreCase(activityName)||"CAD_Analyst1".equalsIgnoreCase(activityName)||"CAD_Analyst2".equalsIgnoreCase(activityName)||"CPV_Analyst".equalsIgnoreCase(activityName)||"CPV".equalsIgnoreCase(activityName))
				{
					
				}
				else
				{
					formObject.setLocked("SmartCheck1_Frame1",true);//@sagarika
				}
			...
			if ("Office_Mob_Verification".equalsIgnoreCase(pEvent.getSource().getName())) {
				hm.put("Office_Mob_Verification","Clicked");
				 DigitalOnBoarding.mLogger.info( "INside Office verificatioj of Frame Expand");
...
//DecisionHistory_ReferTo
			...
			if ("Smart_Check".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				popupFlag="N";*/
				DigitalOnBoarding.mLogger.info("Inside Smartr check Fetch");
				hm.put("Smart_Check","Clicked");
				formObject.fetchFragment("Smart_Check", "SmartCheck", "q_SmartCheck");
				DigitalOnBoarding.mLogger.info("After Smart check Fetch");
				try
				{
					throw new ValidatorException(new CustomExceptionHandler("Error Message", "Text1","EventType", hm));
				}
			...
			if ("Compliance".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				DigitalOnBoarding.mLogger.info("after value of n Compliance_row");
			...
			if ("CC_Creation".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				loadPicklist3();
				formObject.setLocked("cmplx_DEC_ReferTo", true);
				DigitalOnBoarding.mLogger.info("After Loadpicklist3 new deepak");
				...
				if(emptype.equalsIgnoreCase("Self Employed")){
					...
					DigitalOnBoarding.mLogger.info("framestate for Employment is: "+frameStateComp);
					if(frameStateComp == 0){
						DigitalOnBoarding.mLogger.info("Companydetails");
					}
					else {
						fetch_Company_frag(formObject);
						DigitalOnBoarding.mLogger.info("fetched Companydetails details");
					}
				}
				//formObject.fetchFragment("Part_Match", "PartMatch", "q_PartMatch");
				//expandFinacleCRMCustInfo();
			...
			if ("Customer_Details_Verification1".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				DigitalOnBoarding.mLogger.info("Inside Fetch Customer_Details_Verification1 sagarika");
				...
				DigitalOnBoarding.mLogger.info("auto ssss");
				if("FPU".equalsIgnoreCase(activityName))
				{
					formObject.setLocked("Customer_Details_Verification1",false);//sagarika
				}
				else
				{
			...
			if ("Employment_Verification".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				DigitalOnBoarding.mLogger.info( "Inside add button: Employment_Verification loadpicklist");
				...
				if("FPU".equalsIgnoreCase(activityName))//sagarika
				{
					formObject.setLocked("Employment_Verification",false);
				}
				else
				{
			...
			if ("Exceptional_Case_Alert".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				//Added by Sajan to fetch Customer detail frag PCASF-469
				formObject.fetchFragment("Customer_Details_Verification1", "cust_ver_sp2", "q_custVeri");
				autopopulateValuesCustomerDetailVerification(formObject);
				//formObject.setLocked("Cust_ver_sp2_Frame1",true);
				int framestate4=formObject.getNGFrameState("Customer_Details_Verification1");
				String fvi="";
				if(framestate4 !=0){
					formObject.fetchFragment("Customer_Details_Verification1", "CustDetailVerification1", "q_CustDetailVeriFCU");
				...
				int framestate_new=formObject.getNGFrameState("Employment_Verification");
				//String fvi="";
				if(framestate4 !=0){
					formObject.fetchFragment("Employment_Verification", "EmploymentVerification_s2", "q_empVer_sp");
					//fvi=formObject.getNGValue("cmplx_CustDetailverification1_Filed_Visit_value");
					formObject.setNGFrameState("Employment_Verification", 1);
				...
				if("FPU".equalsIgnoreCase(activityName))//sagarika
				{
					...
					formObject.setLocked("Cust_ver_sp2_Frame1",false);
					formObject.setLocked("EmploymentVerification_s2_Frame1",false);
				}
				else
				{
				...
				try
				{
					...
					DigitalOnBoarding.mLogger.info("objOutput_Liab args are: "+objInput_Liab.get(0));
					...
					DigitalOnBoarding.mLogger.info("output from proc ng_rlos_ExceptionFragmentAutomationProc :"+(String)objOutput_Liab.get(0));
				...
				{
					DigitalOnBoarding.mLogger.info("Error in ng_rlos_ExceptionFragmentAutomationProc :: "+Ex.getMessage());
				}
	...
	Author                              : Sajan            
	Description                         : load Customer fragment      
...
//				/formObject.setLocked("cmplx_Customer_CardNotAvailable", true);
			...
			//}
				DigitalOnBoarding.mLogger.info("Test logs Sajan ");	
		}
		catch(Exception e){
			DigitalOnBoarding.mLogger.info("RLOS CommonCOde CustomerFragment_Load() Exception occured: "+printException(e));
		}
	}
	...
	public void autopopulateValuesFCU(FormReference formObject) {
		...
		DigitalOnBoarding.mLogger.info("fcu @ emirate"+emirate);
		try
		{
		...
		{
			emirate="";
			DigitalOnBoarding.mLogger.info("inside fcu catch");
		}
...
Description                         : auto populate Vlaues Buss Verification       
	...
	{
		DigitalOnBoarding.mLogger.info( "Inside value in customer detail verification");
		...
		DigitalOnBoarding.mLogger.info( "all frames sss");
		if("Y".equalsIgnoreCase(formObject.getNGValue("cmplx_IncomeDetails_SalaryXferToBank")))
		{
			DigitalOnBoarding.mLogger.info( "Inside value in customer detail verification salary");
		...
		DigitalOnBoarding.mLogger.info("value of emp status");
		DigitalOnBoarding.mLogger.info("it is"+emp);
		...
		//formObject.setNGValue("Cust_ver_sp2_Text13","aa");
		DigitalOnBoarding.mLogger.info( "text3 values"+formObject.getNGValue("Cust_ver_sp2_Text13"));
		formObject.setLocked("Cust_ver_sp2_Text13", true);
		formObject.setEnabled("Cust_ver_sp2_Text13", false);
		formObject.setEnabled("Cust_ver_sp2_Text14", false);
		formObject.setEnabled("Cust_ver_sp2_Text15", false);
		formObject.setEnabled("Cust_ver_sp2_Text16", false);
		formObject.setEnabled("Cust_ver_sp2_Text18", false);
		formObject.setEnabled("Cust_ver_sp2_Text20", false);
		formObject.setEnabled("Cust_ver_sp2_Text6", false);
		formObject.setEnabled("Cust_ver_sp2_Text20", false);
		formObject.setEnabled("Cust_ver_sp2_Text8", false);
		//Cust_ver_sp2_Text6 Cust_ver_sp2_Text8 Cust_ver_sp2_Text10 Cust_ver_sp2_Text9
		DigitalOnBoarding.mLogger.info( "all values");
	}//cmplx_cust_ver_sp2_emp_status__remarks
	public void autopopulateValuesBusinessVerification(FormReference formObject) {
		DigitalOnBoarding.mLogger.info( "Inside add button: business verification2 b$ function of autopopulateValuesBusinessVerification");
		...
		try
		{
			...
			formObject.setLocked("cmplx_BussVerification1_ContactTelephone", true);*/
			//--above code added by  nikhil 12/10/17 as per CC FSD 2.2
			DigitalOnBoarding.mLogger.info( "company framestate:"+formObject.getNGFrameState("CompDetails")+ "value :"+formObject.getNGValue("cmplx_CompanyDetails_cmplx_CompanyGrid",0,4));
			DigitalOnBoarding.mLogger.info( "auth sign framestate:"+formObject.getNGFrameState("Auth_Sign_Details")+ "value :"+formObject.getNGValue("cmplx_AuthSignDetails_cmplx_GR_AuthorizedSignDetails",0,1));
			DigitalOnBoarding.mLogger.info( "alconct framestate:"+formObject.getNGFrameState("Alt_Contact_container")+ "value :"+formObject.getNGValue("AlternateContactDetails_OfficeNo"));

			DigitalOnBoarding.mLogger.info( "Inside add button: business verification2 after function of autopopulateValuesBusinessVerification");
			DigitalOnBoarding.mLogger.info( "Inside add button: business verification2 b$ function of autopopulateValuesBusinessVerification");
		}
		catch(Exception ex)
		{
	...
	public void autopopulateValuesEmployeesVeri(FormReference formObject,String fvi){
		...
		formObject.setEnabled("EmploymentVerification_s2_Text29",false);
		...
		DigitalOnBoarding.mLogger.info("value of emp status"+formObject.getNGValue("cmplx_EmploymentDetails_EmpStatus"));
		...
		formObject.setEnabled("EmploymentVerification_s2_Text7",false);
		...
		formObject.setEnabled("EmploymentVerification_s2_Text1", false);
	...
	public void setValuesFCU(FormReference formObject,String...values) {
		...
		for(String str : values){
			if(checkValue(str)){
				...
				DigitalOnBoarding.mLogger.info(controls[i]+"::"+ str);
	...
	public void setFormHeader(FormEvent pEvent){
		...
		try{
			...
			formObject.setTop("World_Check", formObject.getTop("MOL")+formObject.getHeight("MOL_Header")+50);
			formObject.setTop("Reject_Enquiry", formObject.getTop("World_Check")+formObject.getHeight("World_Check_Header")+50);
			//added by saurabh1 for pcasf-67 end
			DigitalOnBoarding.mLogger.info( "Inside formPopulated()" + pEvent.getSource());
			formObject.fetchFragment("CustomerDetails", "Customer", "q_Customer");
			formObject.setNGFrameState("CustomerDetails",0);
			...
			//String query="(select top 1 case when CASE_STATUS='Confirmed Fraud' then 'Negative case' else CASE_STATUS end as CASE_STATUS from NG_EFMS_RESPONSE where APPLICATION_NUMBER='"+App_No+"' order by  CASE_STATUS desc) as EFMS_CASE_STATUS)";
		
			String nationality = formObject.getNGValue("cmplx_Customer_Nationality");
			DigitalOnBoarding.mLogger.info( "Nationality is$$$$: "+nationality);
			...
			//String EFMS_status = "".equalsIgnoreCase(formObject.getNGValue("EFMS_AlertStatusFlag"))?formObject.getNGValue("EFMS_IS_Alerted"):formObject.getNGValue("EFMS_AlertStatusFlag");
			//String EFMS_status="";
			//String query_efms ="select CASE_STATUS from (select top 1 case when CASE_STATUS='Confirmed Fraud' then 'Negative case' else CASE_STATUS end as CASE_STATUS from NG_EFMS_RESPONSE where APPLICATION_NUMBER like '%1628%' order by  CASE_STATUS desc) as EFMS_CASE_STATUS";
			...
			//	formObject.setNGValue("EFMS_Status", result.get(0).get(0));
			//	DigitalOnBoarding.mLogger.info("efmssagarika"+formObject.getNGValue("EFMS_status"));
		    //}
			
			//if("confirmed fraud".equalsIgnoreCase(EFMS_status))
			//{
			//	DigitalOnBoarding.mLogger.info("efms"+result.get(0).get(0));
			//	EFMS_status="Negative Case";
		//	}
			//formObject.setNGValue("EFMS_Status", EFMS_status);
			setEfms();
		//	DigitalOnBoarding.mLogger.info("efms_ sagarika::value null"+formObject.getNGValue("EFMS_Status"));
		//	DigitalOnBoarding.mLogger.info("efms_ sagarika::value"+EFMS_status);
			//formObject.setNGValue("EFMS_Status", EFMS_status);//sagarika
			//formObject.setNGValue("IntroDateLabel",formObject.getNGValue("CreatedDate"));//Tarang to be removed on friday(1/19/2018)
			formObject.setNGValue("IntroDateLabel",formObject.getNGValue("Created_Date"));//sagarika 
			DigitalOnBoarding.mLogger.info("@CPV_ sagarika::"+formObject.getNGValue("CPV_DECISION"));
			
			DigitalOnBoarding.mLogger.info("CPV :: @sag "+formObject.getNGValue("CPV_DECISION"));
			//formObject.setNGValue("isCPVDone","No");
			if("Y".equalsIgnoreCase(formObject.getNGValue("cpv")))
			{
				DigitalOnBoarding.mLogger.info("cpvsss@sag"+formObject.getNGValue("cpv"));
				formObject.setNGValue("isCPVDone","Yes"); 
				DigitalOnBoarding.mLogger.info("cpvsss@sagarika"+formObject.getNGValue("isCPVDone"));
			}
			else{
			...
			formObject.setNGValue("Introduction_Date",formObject.getNGValue("Created_Date"));
			...
			formObject.setNGValue("Label_introdate",dateFormat.format(date));
			...
			//added CAD1_Hold  by saurabh1 for pcasf-463
			List<String> activity_openFragmentsonLoad = Arrays.asList("CAD1_Hold","Hold_CPV","HR","Interest_Rate_Approval","Manager","Original_Validation","Post_Disbursal","Rejected_Application"
					...
					,"Compliance","CPV_Analyst","CPV","CSM_Review","RM_Review",NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_CSM"),"DDVT_Checker","Disbursal","FPU","Fulfillment_RM","CAD_Analyst1","Cad_Analyst2","DDVT_Maker","Archival","CustomerHold");//Changed by aman for PCSP-477
			...
			DigitalOnBoarding.mLogger.info( "Just before calling company details function");
			...
			if(!(activityName.contains("CAD") || activityName.contains("Cad") || "Disbursal".equalsIgnoreCase(activityName))){
				DigitalOnBoarding.mLogger.info( "Just before calling checkSecNatapp function");
			...
			if("Smart_CPV".equalsIgnoreCase(activityName))
			{
				...
				DigitalOnBoarding.mLogger.info( "Inside SMart_CPV Set header ");
			}
	...
	public void openFragmentsonLoad(FormReference formObject , String activityName){
		try{
			...
			DigitalOnBoarding.mLogger.info( "sQuerysQuerysQuerysQuerysQuerysQuerysQuerysQuery:"+sQuery+   "    OutputXMLOutputXMLOutputXML"+OutputXML);
			...
			DigitalOnBoarding.mLogger.info( "Exception:"+ex.getMessage());
		}
	}
	/*          Function Header:
	...
	public void disablePartnerDetails(FormReference formObject){
		...
		DigitalOnBoarding.mLogger.info("authgridrowcount"+authgridRowCount);
		if(authgridRowCount >0){
			...
			for(int i=0;i<authgridRowCount;i++){
				...
				DigitalOnBoarding.mLogger.info("soleEmployee"+soleEmployee);
				if("Yes".equalsIgnoreCase(soleEmployee)){
					DigitalOnBoarding.mLogger.info("soleEmployee is Yes!!!!!");
					flag = true;
				}
			}
			if(flag){
	...
	public void checkComanyDetailsTabVisibility(FormReference formObject){
		...
		//formObject.setNGFrameState("ProductContainer", 0);
		String empType=formObject.getNGValue("cmplx_Product_cmplx_ProductGrid", 0, 6);
		DigitalOnBoarding.mLogger.info(empType );
		...
		if(empType.contains("Salaried")||"Pensioner".equalsIgnoreCase(empType)){
			DigitalOnBoarding.mLogger.info(empType.contains("Salaried")+"");
			...
			DigitalOnBoarding.mLogger.info(empType.contains("Self Employed")+"");
	...
	public void mouse_clicked(FormEvent pEvent) 
	{
		...
		CDOB_Integration_Output valSet=new CDOB_Integration_Output();
		...
		try{
			...
			if("DecisionHistory_ADD".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				DigitalOnBoarding.mLogger.info( "Inside ReferGrid");
				try{
					if("DDVT_Maker".equalsIgnoreCase(formObject.getWFActivityName())){
						ddvtmaker_submitapp();
					}
					DigitalOnBoarding.mLogger.info("CC_CommonCode"+ "Inside AddInReferGrid: "); 
					//	FormReference formObject = FormContext.getCurrentInstance().getFormReference();
					...
					DigitalOnBoarding.mLogger.info("CC_Common"+ "DecisionReasonCode: "+DecisionCode);
					...
					DigitalOnBoarding.mLogger.info("PL_CommonCode"+"ReferList is:"+DecisionCodelist.toString());
					//}
					DigitalOnBoarding.mLogger.info("PL out of refer function"); 
					...
					if(("Cad_Analyst2".equalsIgnoreCase(formObject.getWFActivityName())||"DDVT_Checker".equalsIgnoreCase(formObject.getWFActivityName())) && "Refer".equalsIgnoreCase(decision)){
						...
						String query = "update NG_DOB_EXTTABLE set ReferTo = '"+ReferTo+"' where CC_Wi_Name = '"+formObject.getWFWorkitemName()+"'";
						DigitalOnBoarding.mLogger.info("Deepak Query to update ReferTo at Cad 2: "+query);
						formObject.saveDataIntoDataSource(query);
					}
					if("CSM_Review".equalsIgnoreCase(formObject.getWFActivityName())){
						String query = "update NG_DOB_EXTTABLE set IS_SALES_HEAD_DEC = (select top 1 IS_SALES_HEAD_DEC from NG_RLOS_DecisionValidation with(nolock) where wi_name = '"+formObject.getWFWorkitemName()+"') where CC_Wi_Name ='"+formObject.getWFWorkitemName()+"'";
						DigitalOnBoarding.mLogger.info("Deepak Query to update IS_SALES_HEAD_DEC at CSM_Review: "+query);
						formObject.saveDataIntoDataSource(query);
						if("Submit".equalsIgnoreCase(decision)){
							...
							DigitalOnBoarding.mLogger.info("Deepak Query to update IS_SALES_HEAD_DEC at CSM_Review: "+query_2);
						}
					}
					...
					DigitalOnBoarding.mLogger.info("PL_Common ReferList Exception is:");
					printException(ex);
				}


				DigitalOnBoarding.mLogger.info( "Out of ReferGrid");
			}//ReqProd
			...
			{
				DigitalOnBoarding.mLogger.info( "check");
			...
			//below code by saurabh for new Incoming Doc.
				...
				DigitalOnBoarding.mLogger.info("rlos modify btn inc doc");
				DigitalOnBoarding.mLogger.info("formObject.isLocked(\"IncomingDocNew_DocType\")"+formObject.isLocked("IncomingDocNew_DocType"));
				DigitalOnBoarding.mLogger.info("formObject.isLocked(\"IncomingDocNew_DocName\")"+formObject.isLocked("IncomingDocNew_DocName"));
				if(formObject.isLocked("IncomingDocNew_DocType")) {
					DigitalOnBoarding.mLogger.info("document type is locked");
					formObject.setLocked("IncomingDocNew_DocType", false);
				}
				if(formObject.isLocked("IncomingDocNew_DocName")) {
					DigitalOnBoarding.mLogger.info("document name is locked");
			...
			{
				DigitalOnBoarding.mLogger.info( "Inside Modify DecisionGrid");
				formObject.ExecuteExternalCommand("NGDeleteRow", "DecisionHistory_Decision_ListView1");
				try{
					if("DDVT_Maker".equalsIgnoreCase(formObject.getWFActivityName())){
						ddvtmaker_submitapp();
					}
					DigitalOnBoarding.mLogger.info("PL_CommonCode"+ "Inside AddInDecisionGrid: "); 
					//String currDate=new SimpleDateFormat("MM/dd/yyyy HH:mm").format(Calendar.getInstance().getTime());
					String decision=formObject.getNGValue("cmplx_DEC_Decision");
					String ReferTo=formObject.getNGValue("DecisionHistory_ReferTo");
					String currDate=common.Convert_dateFormat("", "","dd/MM/yyyy HH:mm");
					...
					String subS = s.substring(startPosition, endPosition-4);
					//if("Refer".equalsIgnoreCase(decision) || "Reject".equalsIgnoreCase(decision)){
					DigitalOnBoarding.mLogger.info("CC refer function"); 
					List<String> DecisionCodelist=new ArrayList<String>();
					...
					//	DecisionCodelist.add(formObject.getWFWorkitemName());
					formObject.addItemFromList("DecisionHistory_Decision_ListView1",DecisionCodelist);
					DigitalOnBoarding.mLogger.info("CC_CommonCode"+"ReferList is:"+DecisionCodelist.toString());
					//}
					DigitalOnBoarding.mLogger.info("CC out of refer function"); 
					...
					if("Cad_Analyst2".equalsIgnoreCase(formObject.getWFActivityName())||"DDVT_Checker".equalsIgnoreCase(formObject.getWFActivityName())){
						...
						if("Refer".equalsIgnoreCase(decision)){
							query = "update NG_DOB_EXTTABLE set ReferTo = '"+ReferTo+"' where CC_Wi_Name = '"+formObject.getWFWorkitemName()+"'";
						}
						else{
							query = "update NG_DOB_EXTTABLE set ReferTo = '' where CC_Wi_Name = '"+formObject.getWFWorkitemName()+"'";
						}
				...
				DigitalOnBoarding.mLogger.info( "Out of modify function");
			}
			...
			//added by akshay on 6/7/18 for drop 5 point
				...
				if(formObject.getNGValue("cmplx_Customer_NTB").equals("false")){
					...
					objOutput.add("Text");
					DigitalOnBoarding.mLogger.info("Before executing procedure ng_RLOS_CheckWriteOff");
					objOutput= formObject.getDataFromStoredProcedure("ng_RLOS_CheckWriteOff", objInput,objOutput);
					DigitalOnBoarding.mLogger.info("Before executing procedure ng_RLOS_CheckWriteOff::"+(String)objOutput.get(0));
				}
				DigitalOnBoarding.mLogger.info("Before data insert in CRN grid");
				int gridRowCount = formObject.getLVWRowCount("cmplx_CardDetails_cmplx_CardCRNDetails");
				DigitalOnBoarding.mLogger.info("CRN grid row count" + gridRowCount);
				if(gridRowCount==0){
					loadDataInCRNGrid();
					DigitalOnBoarding.mLogger.info("after data insert in CRN grid");
					alert_msg="CRN generated";
				...
				DigitalOnBoarding.mLogger.info("Value of ReqProd is:"+ReqProd);
			...
			//ended by akshay
				...
				DigitalOnBoarding.mLogger.info( "Inside add button: "+formObject.getNGValue("Address_wi_name"));
				...
				DigitalOnBoarding.mLogger.info(formObject.getNGValue("CC_Loan_wi_name"));
				formObject.ExecuteExternalCommand("NGAddRow", "cmplx_CC_Loan_cmplx_btc");//cmplx_CC_Loan_cmplx_btc
				DigitalOnBoarding.mLogger.info( "Inside add button33: add of btc details");
				...
				DigitalOnBoarding.mLogger.info( "Inside add button33: modify of btc details");
				...
				DigitalOnBoarding.mLogger.info( "Inside add button33: delete of btc details");
			}
				...
				DigitalOnBoarding.mLogger.info( "Inside add button33: add of SmartCheck_Add details");
			}
			...
			//	formObject.setEnabled("SmartCheck_Add",true);
				...
				DigitalOnBoarding.mLogger.info( "Inside add button33: modify of SmartCheck_Modify details");
			}
				...
				DigitalOnBoarding.mLogger.info( "Inside add button33: delete of SmartCheck_Delete details");
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL058");
				throw new ValidatorException(new FacesMessage(alert_msg));
			}

			else if ("FinacleCRMCustInfo_Add".equalsIgnoreCase(pEvent.getSource().getName())){
				if(Check_ECRNGenOnChange()){
					alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL116");
					throw new ValidatorException(new FacesMessage(alert_msg));
				}
				formObject.setNGValue("FinacleCRMCustInfo_WINAME",formObject.getWFWorkitemName());
				DigitalOnBoarding.mLogger.info(formObject.getNGValue("FinacleCRMCustInfo_WINAME"));
				...
				DigitalOnBoarding.mLogger.info( "Inside add button33: add of FinacleCRMCustInfo details");
				...
				DigitalOnBoarding.mLogger.info( "Inside add button3 FinacleCRMCustInfo_Text1: " + formObject.getNGValue("FinacleCRMCustInfo_Text1"));
				DigitalOnBoarding.mLogger.info( "Inside add button3 cmplx_Customer_NTB: " + formObject.getNGValue("cmplx_Customer_NTB"));
				DigitalOnBoarding.mLogger.info( "Inside add button3 FinacleCRMCustInfo_CheckBox1: " + formObject.getNGValue("FinacleCRMCustInfo_CheckBox1"));
				...
				DigitalOnBoarding.mLogger.info( "Inside modify button33: modify of FinacleCRMCustInfo details");
				...
				formObject.setNGValue("FinacleCRMCustInfo_WINAME",formObject.getWFWorkitemName());
				DigitalOnBoarding.mLogger.info(formObject.getNGValue("FinacleCRMCustInfo_WINAME"));
				DigitalOnBoarding.mLogger.info( "Inside delete button33: delete of FinacleCRMCustInfo details");
				Custom_fragmentSave("CustomerDetails");
				Custom_fragmentSave("FinacleCRMCustInfo_Frame1");//Deepak changes done for PCAS-3526
				formObject.RaiseEvent("WFSave");
			}
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL096");
				throw new ValidatorException(new FacesMessage(alert_msg));
			}
			...
			//change by saurabh on 20th Dec
				...
				if("Self Employed".equals(formObject.getNGValue("EmploymentType")) || "PA".equals(formObject.getNGValue("Subproduct_productGrid"))){
					try{
						...
						DigitalOnBoarding.mLogger.info("IncomeDetails_FinacialSummarySelf button");

						objInput.add("Text:" + formObject.getWFWorkitemName());
						objOutput.add("Text");
						objOutput = formObject.getDataFromStoredProcedure("getFinancialSummaryData", objInput, objOutput);
						DigitalOnBoarding.mLogger.info("getFinancialSummaryData Output: "+objOutput.toString());
						...
						if(!"".equals(data)){
							...
							if(data_array[0]!=null && !"".equals(data_array[0])){
				...
				if(result2!=null && result.get(0).get(0)!=null && result.size()>0)  //if(result!=null && result.size()>0)
				{
					...
					formObject.setNGValue("cmplx_IncomeDetails_AvgCredTurnover", String.format("%.2f", value2));
						...
						if(formObject.isVisible("FinacleCore_Frame1")){
							DigitalOnBoarding.mLogger.info( "FinacleCore_Frame1 is visible");
						...
						DigitalOnBoarding.mLogger.info( "Exception in setting finan summ data: "+printException(ex));
					}
				}
				...
				else
				{
					try
					{
						...
						DigitalOnBoarding.mLogger.info( "Exception in setting finacle core: "+printException(ex));
					}
				}
			}
			...
			else if(pEvent.getSource().getName().equalsIgnoreCase("ReferHistory_Modify"))
			{
				...
				DigitalOnBoarding.mLogger.info( "EMpName$"+EmpName+"$");
				String query=null;
			...
			else if("CompanyDetails_Aloc_search".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				try{
					if(	NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_true").equalsIgnoreCase(formObject.getNGValue("cmplx_EmploymentDetails_Others"))){
				...
				{
					DigitalOnBoarding.mLogger.info( "Exception occurred in removing item from cmplx_EmploymentDetails_EmpStatusCC"+printException(e));}
			}
			...
			else if("IncomeDetails_Add".equalsIgnoreCase(pEvent.getSource().getName()))	
			{
				...
				DigitalOnBoarding.mLogger.info( "Inside add button: "+formObject.getNGValue("IncomeDetails_wi_name"));
			...
			else if("IncomeDetails_Delete".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				DigitalOnBoarding.mLogger.info( "Inside Customer_save button: ");
				//Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				Custom_fragmentSave("CustomerDetails");
				...
				alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL084");

				throw new ValidatorException(new FacesMessage(alert_msg));

			}
			
			//Added by Sajan to save MOL fragment
			else if("MOL1_Button1".equalsIgnoreCase(pEvent.getSource().getName())){
				DigitalOnBoarding.mLogger.info("This is MOL fragment save test 111");
				Custom_fragmentSave("MOL1");
				formObject.RaiseEvent("WFSave");//added by saurabh1 for pcasf-459
				alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL078");
			...
			//added By Tarang ended on 08/03/2018
				...
				//Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				DigitalOnBoarding.mLogger.info("inside IncomeDetails_Salaried_Save");
				Custom_fragmentSave("IncomeDetails");
				alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL039");
				throw new ValidatorException(new FacesMessage(alert_msg));
			}
				...
				alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL008");
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL061");
			...
			//added by yash on 21/8/2017
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL059");
				loadDataInCRNGrid();
				throw new ValidatorException(new FacesMessage(alert_msg));
			}
			else if("SupplementCardDetails_Add".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				DigitalOnBoarding.mLogger.info("Selected Card Prod id: "+formObject.getNGSelectedItemText("SupplementCardDetails_CardProduct"));
			...
			else if("SupplementCardDetails_Delete".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL060");
		...
		if("ExtLiability_Button4".equalsIgnoreCase(pEvent.getSource().getName()))
		{
			...
			CreditCard.mLogger.info( "Inside add button: "+formObject.getNGValue("partner_winame"));
				...
				DigitalOnBoarding.mLogger.info( "Inside add button: "+formObject.getNGValue("PartnerDetails_partner_winame"));
			...
			else  if("AuthorisedSignDetails_add".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				DigitalOnBoarding.mLogger.info( "Inside add button: "+formObject.getNGValue("AuthorisedSign_wiName"));
			...
			//added by Akshay on 7/9/2017 for Fetch Company Details call on CAD
				...
				DigitalOnBoarding.mLogger.info("CompanyDetails_Button3");
				...
				DigitalOnBoarding.mLogger.info(BusinessIncDate);

				if("0000".equalsIgnoreCase(ReturnCode) || "000".equalsIgnoreCase(ReturnCode) ){
					formObject.setNGValue("Is_Customer_Details","Y");

					DigitalOnBoarding.mLogger.info("value of company Details corporation"+formObject.getNGValue("Is_Customer_Details"));
					...
					DigitalOnBoarding.mLogger.info("corporation cif");
					DigitalOnBoarding.mLogger.info(formObject.getNGValue("Is_Customer_Details"));
				}
				else{
					DigitalOnBoarding.mLogger.info("Customer Details Corporation CIF is not generated");
					formObject.setNGValue("Is_Customer_Details","N");
				}
				DigitalOnBoarding.mLogger.info(formObject.getNGValue("Is_Customer_Details"));
			}
			
			//Added by Sajan to create CIF on CA1
			else if("DecisionHistory_Button4".equalsIgnoreCase(pEvent.getSource().getName())){
				if("".equals(formObject.getNGValue("cmplx_Customer_CIFNo")) || formObject.getNGValue("cmplx_Customer_CIFNo")==null){
					outputResponse=genX.GenerateXML("NEW_CUSTOMER_REQ", "SAL");
					DigitalOnBoarding.mLogger.info("Output XML for CreateCIF is "+outputResponse);
					ReturnCode =  (outputResponse.contains("<ReturnCode>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
					 DigitalOnBoarding.mLogger.info(ReturnCode);
					 if("0000".equalsIgnoreCase(ReturnCode)){
						 ...
						 DigitalOnBoarding.mLogger.info("Inside if of New customer Req");
						 //formObject.setNGValue("cmplx_Customer_CIFNo",CIf_value);
						 //formObject.RaiseEvent("WFSave");
						 DigitalOnBoarding.mLogger.info(ReturnCode);
	
						 DigitalOnBoarding.mLogger.info(formObject.getNGValue("Is_Account_Create"));
						 DigitalOnBoarding.mLogger.info(formObject.getNGValue("EligibilityStatus"));
						 DigitalOnBoarding.mLogger.info(formObject.getNGValue("EligibilityStatusCode"));
						 DigitalOnBoarding.mLogger.info(formObject.getNGValue("EligibilityStatusDesc"));
						 alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL011");
					 }
					 else{
						 DigitalOnBoarding.mLogger.info("Inside else of New Customer Req");
						 alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL010");
					 }
				}
				...
				//String cif_verf_status=getCIFStatus("verification",pass,cifId);
				String cif_verf_status=getCIFStatus("verification",pass,cifId);
				if ((!"".equals(formObject.getNGValue("cmplx_Customer_CIFNo")))&&("".equalsIgnoreCase(cif_verf_status)||"N".equalsIgnoreCase(cif_verf_status))){
					...
					if("0000".equalsIgnoreCase(ReturnCode)|| "MSGEXC50107".equalsIgnoreCase(ReturnCode)){
						 formObject.setNGValue("cmplx_DEC_MultipleApplicantsGrid",0, 5,"Y");
						cif_verf_status="Y";
						alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL019");
					}
					else{
						formObject.setNGValue("cmplx_DEC_MultipleApplicantsGrid",0, 5,"N");
			...
			//change by saurabh on 6th Dec
				...
				DigitalOnBoarding.mLogger.info(ReturnDesc);
				if("0000".equalsIgnoreCase(ReturnCode) || "000".equalsIgnoreCase(ReturnCode)){
					formObject.setNGValue("Is_Customer_Details","Y");
					DigitalOnBoarding.mLogger.info("value of Authorised_CIF"+formObject.getNGValue("Is_Customer_Details"));
					valSet.valueSetCustomer(outputResponse,"Signatory_CIF");    
					DigitalOnBoarding.mLogger.info("Authorised_CIF is generated");
					DigitalOnBoarding.mLogger.info(formObject.getNGValue("Is_Customer_Details"));
					//Comman method written to convert date.
				...
				try{
					...
					DigitalOnBoarding.mLogger.info("Customer Details is not generated");
					formObject.setNGValue("Is_Customer_Details","N");
				}
				DigitalOnBoarding.mLogger.info(formObject.getNGValue("Is_Customer_Details"));
			}
			...
			{		
				...
				DigitalOnBoarding.mLogger.info("cmplx_FinacleCore_avg_credit_3month++"+formObject.getNGValue("cmplx_FinacleCore_avg_credit_3month"));
				DigitalOnBoarding.mLogger.info("cmplx_FinacleCore_avg_credit_6month"+formObject.getNGValue("cmplx_FinacleCore_avg_credit_6month"));
				...
				if ("Salaried".equalsIgnoreCase(Emp_type)||"Salaried Pensioner".equalsIgnoreCase(Emp_type)||"Pensioner".equalsIgnoreCase(Emp_type)){
					...
					DigitalOnBoarding.mLogger.info("CompanyDetails_Frame1CompanyDetails_Frame1CompanyDetails_Frame1 already fetched."+formObject.isVisible("CompanyDetails_Frame1"));

					if (!formObject.isVisible("CompanyDetails_Frame1")) {
						DigitalOnBoarding.mLogger.info("fetched CompanyDetails_Frame1CompanyDetails_Frame1CompanyDetails_Frame1 details");

						formObject.fetchFragment("CompDetails", "CompanyDetails", "q_CompanyDetails");
						formObject.setTop("Auth_Sign_Details", formObject.getTop("CompDetails")+formObject.getHeight("CompDetails")+25);
						formObject.fetchFragment("Auth_Sign_Details", "AuthorisedSignDetails", "q_AuthorisedSignDetails");
						formObject.setTop("Partner_Details", formObject.getTop("Auth_Sign_Details")+formObject.getHeight("Auth_Sign_Details")+25);
						DigitalOnBoarding.mLogger.info("fetched Internal_External_Liability details");
					}
				}
			...
			/*	formObject.setTop("Salary_Enquiry", formObject.getTop("World_Check")+formObject.getHeight("World_Check")+35);
				...
				DigitalOnBoarding.mLogger.info("$$After genX.GenerateXML for outputResponse : "+outputResponse);
				...
				try{
					...
					DigitalOnBoarding.mLogger.info(" Exception in EMI Generation");
				}
				//EMI Calcuation logic added below 24-Sept-2017 End
				if("Error".equalsIgnoreCase(outputResponse))//PCAS-1776-sagarika 09/07/19
				{
					DigitalOnBoarding.mLogger.info("sagarika alert");

					alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL109");
					throw new ValidatorException(new FacesMessage(alert_msg));
				}
				...
				DigitalOnBoarding.mLogger.info(SystemErrorCode);
				if("".equalsIgnoreCase(SystemErrorCode)){
					new CDOB_Integration_Output().valueSetCustomer(outputResponse,"");   
					alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL021");
					...
					alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL012");
					throw new ValidatorException(new FacesMessage(alert_msg));
				}
			...
			//++ Below Code added By Yash on Oct 9, 2017  to fix : "to save liability" : Reported By Shashank on Oct 09, 2017++
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL034");
				formObject.RaiseEvent("WFSave");
			...
			//++ Above Code added By Yash on Oct 9, 2017  to fix : "to save liability" : Reported By Shashank on Oct 09, 2017++
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL025");
			...
			//++ Above Code added By Yash on Oct 10, 2017  to fix : 10-"There should be only 1 save button below Partner details fragment.Similar to how it is at initiation" : Reported By Shashank on Oct 09, 2017++
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL024");
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL043");
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL001");
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL009");
				...
				try{
					...
					alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL007");
					DigitalOnBoarding.mLogger.info("Inside CardDetails_Save button click!!!"+alert_msg);
				}
				catch(Exception e){
					DigitalOnBoarding.mLogger.info("Inside CardDetails_Save button click!!!"+"Exception occurred!!"+printException(e));
				}
				throw new ValidatorException(new FacesMessage(alert_msg));
				...
				DigitalOnBoarding.mLogger.info( "Inside add button: "+formObject.getNGValue("FATCA_Wi_Name"));
				...
				DigitalOnBoarding.mLogger.info("FATCA_Button3");
			...
			//Added By Prabhakar Drop-4 point-3
				...
				try{
					...
					DigitalOnBoarding.mLogger.info( "Inside Fatca Modify>>>FATCA_selectedreasonhidden: "+formObject.getNGValue("FATCA_selectedreasonhidden"));
					...
					formObject.setNGValue("FATCA_selectedreasonhidden", "");
					DigitalOnBoarding.mLogger.info( "Inside add FATCA_Modify: modify of FATCA details");
				}catch(Exception e){
					DigitalOnBoarding.mLogger.info("Exception in FATCA modify: "+printException(e));	
				}
			}
			//Added By Prabhakar Drop-4 point-3
				...
				formObject.clear("FATCA_SelectedReason");
				LoadPickList("FATCA_ListedReason", "Select description,code from ng_master_fatcaReasons with(nolock)");
				DigitalOnBoarding.mLogger.info( "Inside FATCA_Delete: delete of FATCA details");
				formObject.setNGValue("FATCA_selectedreasonhidden", "");
			}
			...
			else if("cmplx_FATCA_cmplx_GR_FatcaDetails".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				try{
					...
					DigitalOnBoarding.mLogger.info("Inside FatcaGrid Click");
					DigitalOnBoarding.mLogger.info("Index is "+formObject.getSelectedIndex("cmplx_FATCA_cmplx_GR_FatcaDetails"));
					String hiddenText="";
					if(formObject.getSelectedIndex("cmplx_FATCA_cmplx_GR_FatcaDetails")>-1){
						...
						DigitalOnBoarding.mLogger.info("HiddenField is: "+hiddenText);
						...
						if(hiddenText!=null && !"".equalsIgnoreCase(hiddenText) && !"NA".equals(hiddenText)){
							...
							if(formObject.getItemCount("FATCA_SelectedReason")==0)
							{
								...
								for (String string : listedReasonList)
								{
									...
									DigitalOnBoarding.mLogger.info("FATCA_SelectedReason"+selectedReasonList);
									formObject.addComboItem("FATCA_SelectedReason",getKeyByValue(ReasonMap, string), string);

								}
								for (String string : selectedReasonList)
								{
									DigitalOnBoarding.mLogger.info("FATCA_ListedReason"+selectedReasonList);
						...
						DigitalOnBoarding.mLogger.info("Inside de-select FATCA row");
						int itemCount = formObject.getItemCount("FATCA_SelectedReason");
						DigitalOnBoarding.mLogger.info("itemCount: "+itemCount);
						for(int i=0;i<itemCount;i++){
							try {
								formObject.removeItem("FATCA_SelectedReason", (itemCount-1)-i);
							} catch (Exception e) {
								// TODO Auto-generated catch block
								DigitalOnBoarding.mLogger.info("Exception in removing row from listbox: "+printException(e));
							}
						}
					}
					DigitalOnBoarding.mLogger.info("HIDDEN VALUE IS"+hiddenText);
				}catch(Exception e){
					DigitalOnBoarding.mLogger.info("Exception in FATCA grid click: "+printException(e));	
				}
			}

			else if("FATCA_Save".equalsIgnoreCase(pEvent.getSource().getName())){
				DigitalOnBoarding.mLogger.info("inside Fatca Save button");
				//Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				Custom_fragmentSave("FATCA");
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL036");
			...
			else if("KYC_Add".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				DigitalOnBoarding.mLogger.info( "Inside KYC add button: "+formObject.getNGValue("kyc_Wi_Name"));
			...
			else if("KYC_Modify".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				formObject.setNGValue("KYC_CustomerType", "--Select--");
				DigitalOnBoarding.mLogger.info("Inside KYC Modify Button"+formObject.getNGValue("kyc_Wi_Name"));
			}
			//Added by Prabhakar drop-4 point-3
			...
			//Modified by Prabhakar drop-4 point-3
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL041");
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL045");
		...
		if("NotepadDetails_save".equalsIgnoreCase(pEvent.getSource().getName())){
			...
			throw new ValidatorException(new FacesMessage(alert_msg));
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL053");
			...
			//added by yash on 8/8/2017
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL056");
				throw new ValidatorException(new FacesMessage(alert_msg));
			}
			else if("FinacleCRMCustInfo_Button1".equalsIgnoreCase(pEvent.getSource().getName())){
				//Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				Custom_fragmentSave("FinacleCRMCustInfo_Frame1");
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL037");
				throw new ValidatorException(new FacesMessage(alert_msg));
			}
			else if("RejectEnq_Save".equalsIgnoreCase(pEvent.getSource().getName())){
				//Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				Custom_fragmentSave("RejectEnq_Frame1");
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL054");
				throw new ValidatorException(new FacesMessage(alert_msg));
			}
			else if("ExternalBlackList_Save".equalsIgnoreCase(pEvent.getSource().getName())){
				//Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				Custom_fragmentSave("ExternalBlackList_Frame1");
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL035");
				throw new ValidatorException(new FacesMessage(alert_msg));
			}
			...
			//added by yash on 21/8/2017
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL044");
				throw new ValidatorException(new FacesMessage(alert_msg));
			}
				...
				//Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				Custom_fragmentSave("DecisionHistory");
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL022");
				throw new ValidatorException(new FacesMessage(alert_msg));
			}
			...
			else if("CompanyDetails_Add".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				DigitalOnBoarding.mLogger.info( "Inside add button: "+formObject.getNGValue("company_winame"));
			...
			else  if("CompanyDetails_Modify".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				//++Below code added by  nikhil 10/10/17
				DigitalOnBoarding.mLogger.info( "Inside NotepadDetails_Add button: "+formObject.getNGValue("formObject.getWFWorkitemName()"));
			...
			// added by abhishek as per CC FSD
				...
				Notepad_grid();
				DigitalOnBoarding.mLogger.info("After Notepad Grid click function");
			} 
			else if("FinacleCore_Button4".equalsIgnoreCase(pEvent.getSource().getName())){
				DigitalOnBoarding.mLogger.info( "Inside Customer_finacle_add button: ");
			...
			// added for calculation on turnover grid fragment
				...
				DigitalOnBoarding.mLogger.info("turnover grid rowcount is::"+n);
				if(n>0){
					calculateTrnovrGrid();
				}else{
			...
			// added by  abhishek to modify the avg nbc repeater data 
				...
				DigitalOnBoarding.mLogger.info("inside the FinacleCore_Button9 rowcount is::"+RowNumber);
				for(int i=0;i<RowNumber.length;i++){
					DigitalOnBoarding.mLogger.info("inside the grid rowcount is::"+i);
					if (ConsiderForObligation.equalsIgnoreCase("true")){
						DigitalOnBoarding.mLogger.info("inside the grid rowcount if::"+i);
						formObject.setNGValue("cmplx_FinacleCore_credturn_grid",Integer.parseInt(RowNumber[i]),4,"true");
					}
					else{
						DigitalOnBoarding.mLogger.info("inside the grid rowcount else::"+ConsiderForObligation);
			...
			else if("Customer_Reference_Add".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				DigitalOnBoarding.mLogger.info( "Inside add button: "+formObject.getNGValue("reference_wi_name"));
			...
			else if("Customer_Reference_delete".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				DigitalOnBoarding.mLogger.info( "Inside add button: "+formObject.getNGValue("Grid_wi_name"));
				...
				DigitalOnBoarding.mLogger.info( "Inside add button:value of emp "+formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0,6));
				if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_Salaried").equalsIgnoreCase(formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0,6))){
					formObject.setSheetVisible("Tab1", 1, false);
				}
				//09/08/2017 to make company details invisible 
				...
				DigitalOnBoarding.mLogger.info("Inside modify of CC Modify");
				String cardprodval = formObject.getNGSelectedItemText("CardProd"); //Arun (12/11/17) CardProd
				formObject.setNGValue("CardLabel",Selected_card());
				DigitalOnBoarding.mLogger.info("Product_type: "+ formObject.getNGValue("Product_type"));
				DigitalOnBoarding.mLogger.info("ReqProd: "+ formObject.getNGValue("ReqProd"));
				DigitalOnBoarding.mLogger.info("AppType: "+ formObject.getNGValue("AppType"));
				DigitalOnBoarding.mLogger.info("EmpType: "+ formObject.getNGValue("EmpType"));
				...
				if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_Salaried").equalsIgnoreCase(formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0,6))){
					formObject.setSheetVisible("Tab1", 1, false);
					DigitalOnBoarding.mLogger.info( "Inside add button:value of emp inside if of modify");
				}
				else{
					formObject.setSheetVisible("Tab1", 1, true);
					DigitalOnBoarding.mLogger.info( "Inside add button:value of emp inside else of modify");
				}
				//09/08/2017 to make company details invisible 
			}
			...
			populatePickListWindow(query,"EMploymentDetails_Button2", "Employer Name,Employer Code,INCLUDED IN PL ALOC,INCLUDED IN CC ALOC,INDUSTRY SECTOR,INDUSTRY MACRO,INDUSTRY MICRO,CONSTITUTION,NAME OF FREEZONE AUTHORITY,MAIN EMPLOYER CODE", true, 20);			     
				...
				if (formObject.getNGValue("cmplx_EmploymentDetails_targetSegCode").equalsIgnoreCase("CAC")){
					...
					List<List<String>> result = formObject.getDataFromDataSource(query);
					if(result!=null && !result.isEmpty())  //if(result!=null && result.size()>0)
					{DigitalOnBoarding.mLogger.info("document name is locked"+result.get(0).get(0));

					if (result.get(0).get(0).equalsIgnoreCase("0")){
						DigitalOnBoarding.mLogger.info("Inside 0 name is locked");

						alert_msg="Please select CAC Indicator from manual Liability or External Liability";
					}

					else{
						DigitalOnBoarding.mLogger.info("Inside else name is locked");
				...
				//Below code is addde by Sajan for PCASF-522
				if("CAD_Analyst1".equalsIgnoreCase(strActivityName)){
					try{
						
						List<List<String>> CPVMismatchCheck=null;
						String Wi_Name=formObject.getWFWorkitemName();
						//String AlertMsg="";
						String final_query = "select isnull(is_CPV_Done,''),isnull(CPV_DECISION,''),'','','' from NG_DOB_EXTTABLE with (nolock) where CC_Wi_Name='"+Wi_Name+"' union all select isnull(emp.DesigStatus,''),isnull(emp.ConfirmedInJob,''),isnull(inc.grossSal,''),ISNULL(inc.Accomodation,''),isnull(emp.DOJ,'')  from ng_RLOS_EmpDetails emp with (nolock) join ng_RLOS_IncomeDetails inc with (nolock) on emp.wi_name=inc.wi_name where emp.wi_name ='"+Wi_Name+"' union all SELECT (case when Desig_upd is null or Desig_upd ='--Select--' or Desig_upd = '' then (select code from NG_MASTER_Designation with (nolock) where Description=Desig_val) else (select code from NG_MASTER_Designation with (nolock) where Description=Desig_upd) end ),(case when confirmedinJob_upd is null or confirmedinJob_upd ='--Select--' then confirmedinJob_val else confirmedinJob_upd end),(case when fixedsalupd is null or fixedsalupd ='--Select--' then fixedsal_val else fixedsalupd end),(case when AccomProvided_upd is null or AccomProvided_upd ='NA' or AccomProvided_upd ='--Select--' then AccomProvided_val else AccomProvided_upd end),(case when doj_upd is null then doj_val else doj_upd end) from NG_RLOS_OffVerification with (nolock) where wi_name='"+Wi_Name+"'";
						DigitalOnBoarding.mLogger.info("Inside CPV Mismatch final_query : "+ final_query);
						CPVMismatchCheck=formObject.getDataFromDataSource(final_query);
						if("Y".equalsIgnoreCase(CPVMismatchCheck.get(0).get(0))){
								if(!(CPVMismatchCheck.get(2).get(0)).equalsIgnoreCase(CPVMismatchCheck.get(1).get(0)))
								{
									alert_msg=alert_msg+" - Please check if CPV details match and If CPV is required";
								}
								else if(!(CPVMismatchCheck.get(2).get(1)).equalsIgnoreCase(CPVMismatchCheck.get(1).get(1))){
									alert_msg=alert_msg+" - Please check if CPV details match and If CPV is required";
								}
								else if(!(CPVMismatchCheck.get(2).get(4)).equalsIgnoreCase(CPVMismatchCheck.get(1).get(4))){
									alert_msg=alert_msg+" - Please check if CPV details match and If CPV is required";
								}
						}
						...
						DigitalOnBoarding.mLogger.error("Exception occured in Save employment details ");
					}
				...
				DigitalOnBoarding.mLogger.info(formObject.getSelectedSheet(pEvent.getSource().getName())+"");
		...
		else if("AuthorisedSignDetails_delete".equalsIgnoreCase(pEvent.getSource().getName()))
		{
			...
			else if("Reference_Details_Reference_Add".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				DigitalOnBoarding.mLogger.info( "Inside add button: "+formObject.getNGValue("Reference_Details_reference_wi_name"));
			...
			else if("Reference_Details_Reference_delete".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				DigitalOnBoarding.mLogger.info("list"+list);
			}
		...
		else if("FinacleCore_Button6".equalsIgnoreCase(pEvent.getSource().getName()))
		{
			...
			{
				DigitalOnBoarding.mLogger.info("Inside Add button WorldCheck1_Button1 "+"");
			...
			{
				DigitalOnBoarding.mLogger.info("Inside modify button WorldCheck1_Button2 core"+"");
			...
			{
				DigitalOnBoarding.mLogger.info("Inside delete button WorldCheck1_Button3 core"+"");
			...
			formObject.saveFragment("Finacle_Core");
				...
				//Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				Custom_fragmentSave("PartnerDetails");
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL046");
		...
		if("NotepadDetails_Delete".equalsIgnoreCase(pEvent.getSource().getName())){
			...
			//added by nikhil for PCSP-589
				...
				DigitalOnBoarding.mLogger.info(" inside tele calling frame in hold_CPV"+""+ sdf.format(cal.getTime()) );
				...
				if(rowCount==0)
				{DigitalOnBoarding.mLogger.info("inside load notepad sagarika");
				formObject.setNGValue("NotepadDetails_Sno",1);//sagarika for PCAS-2642
				DigitalOnBoarding.mLogger.info("ss"+formObject.getNGValue("NotepadDetails_Sno"));
				}
				else
				{
					DigitalOnBoarding.mLogger.info("inside load notepad sagarikaw");
			...
			{
				if(	NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_false").equalsIgnoreCase(formObject.getNGValue("cmplx_Customer_CIFID_Available"))){
					outputResponse =genX.GenerateXML("CUSTOMER_ELIGIBILITY","Primary_CIF");
					DigitalOnBoarding.mLogger.info("RLOS value of ReturnDesc"+"Customer Eligibility");
					ReturnCode =  (outputResponse.contains("<ReturnCode>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
					DigitalOnBoarding.mLogger.info("RLOS value of ReturnCode"+ReturnCode);
					if("0000".equalsIgnoreCase(ReturnCode)){
						valSet.valueSetCustomer(outputResponse,"");    
						...
						if("true".equalsIgnoreCase(NTB_flag)){
							DigitalOnBoarding.mLogger.info( "inside Customer Eligibility to through Exception to Exit:");
							alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL013");
						}
						else{
							...
							if("Y".equalsIgnoreCase(Staff_cif)){
								alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL074");
							}
							else{
								outputResponse = genX.GenerateXML("CUSTOMER_DETAILS","Primary_CIF");
								DigitalOnBoarding.mLogger.info("RLOS value of ReturnCode"+"Inside Customer");
								if("0000".equalsIgnoreCase(ReturnCode)){
									formObject.setNGValue("Is_Customer_Details","Y");
									DigitalOnBoarding.mLogger.info("RLOS value of Is_Customer_Details"+formObject.getNGValue("Is_Customer_Details"));
									...
									try{
										...
										if(str_dob!=null&&!str_dob.equalsIgnoreCase("")){
											String n_str_dob=sdf2.format(sdf1.parse(str_dob));
											DigitalOnBoarding.mLogger.info("converting date entered"+n_str_dob+"asd");
											formObject.setNGValue("cmplx_Customer_DOb",n_str_dob,false);
										}
									}
									catch(Exception e){
										DigitalOnBoarding.mLogger.info("Exception Occur while converting date"+e+"");
									}     
								}
								else{
									alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL028");
									DigitalOnBoarding.mLogger.info("PL DDVT Maker value of ReturnCode"+"Error in Customer Eligibility: "+ ReturnCode);
								}
								formObject.RaiseEvent("WFSave");
							}
						...
						DigitalOnBoarding.mLogger.info("PL DDVT Maker value of ReturnCode"+"Error in Customer Eligibility: "+ ReturnCode);
						alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL027");
					}
				}
				else{
...
hm.clear();
					...
					if(!"".equalsIgnoreCase(formObject.getNGValue("cmplx_Customer_CIFNo")) && !" ".equalsIgnoreCase(formObject.getNGValue("cmplx_Customer_CIFNo"))){
						...
						if("0000".equalsIgnoreCase(ReturnCode)){
							...
							if("Y".equalsIgnoreCase(Staff_cif)){
								...
								valSet.valueSetCustomer(outputResponse,"Primary_CIF");
								formObject.setNGValue("cmplx_Customer_DOb",formatDateFromOnetoAnother(formObject.getNGValue("cmplx_Customer_DOb"),"yyyy-mm-dd","dd/mm/yyyy"),false);
								alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL095");
								/*	try{
						String str_dob=formObject.getNGValue("cmplx_Customer_DOb");
						SimpleDateFormat sdf1=new SimpleDateFormat("yyyy-mm-dd");
						SimpleDateFormat sdf2=new SimpleDateFormat("dd/mm/yyyy");
				...
				outputResponse = new CDOB_Integration_Input().GenerateXML("CUSTOMER_DETAILS","CIF_LOCK");
				ReturnCode = outputResponse.contains("<ReturnCode>") ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
				DigitalOnBoarding.mLogger.info("Inside cif lock--->return code is "+ReturnCode);
				if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_integrationsuccess").equalsIgnoreCase(ReturnCode))
				{
					DigitalOnBoarding.mLogger.info("Locked sucessfully!!!");
					...
					alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL082");
					formObject.RaiseEvent("WFSave");
				}
				else{
					alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL012");
				...
				outputResponse = new CDOB_Integration_Input().GenerateXML("CUSTOMER_DETAILS","CIF_UNLOCK");
				ReturnCode =  outputResponse.contains("<ReturnCode>")? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";

				if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_integrationsuccess").equalsIgnoreCase(ReturnCode))
				{
					formObject.setNGValue("Is_CustLock_Disbursal","N");
					DigitalOnBoarding.mLogger.info("UnLocked sucessfully!!");
					formObject.setNGValue("cmplx_DEC_MultipleApplicantsGrid", formObject.getSelectedIndex("cmplx_DEC_MultipleApplicantsGrid"),6,"N");
					alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL083");
					formObject.RaiseEvent("WFSave");
				}
				else{
					alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL012");
			 ...
			 //FIRCO-start
				else if ("Worldcheck".equalsIgnoreCase(pEvent.getSource().getName()) || "WorldCheck_fetch".equalsIgnoreCase(pEvent.getSource().getName())){
					String popupFlag="Y";
					...
					DigitalOnBoarding.mLogger.info("NEW Shweta @@@@-" +outputResponseFIRCO);
					//outputResponseFIRCO="";
					...
					DigitalOnBoarding.mLogger.info("RLOS value of ReturnCode"+ReturnCodeFIRCO);
					...
					DigitalOnBoarding.mLogger.info("RLOS value of ReturnDesc"+ReturnDescFIRCO);
					if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_Firco").equalsIgnoreCase(ReturnCodeFIRCO) || "FFF002".equalsIgnoreCase(ReturnCodeFIRCO))
					{
						...
						DigitalOnBoarding.mLogger.info("RLOS value of ContractID"+SystemID);					
						...
						if (StatusBehavior.equalsIgnoreCase("4")  || StatusBehavior.equalsIgnoreCase("0")){					
							...
							formObject.setNGValue("Firco_Update","Progress");
						} else {
							NewgenStatus="Done";
						}
						...
						String query1="INSERT INTO NG_RLOS_FIRCO_Online_Response (workitem_no,Firco_ID,Request_datatime,Workstep_name,Newgen_status,StatusBehavior,StatusName,AlertDetails,Updated_Datetime) "
								+ "VALUES('"+ formObject.getWFWorkitemName()+"','"+SystemID+"','"+requestDate+"','"+formObject.getWFActivityName()+"','"+NewgenStatus+"','"+StatusBehavior+"','"+StatusName+"','"+AlertDetails+"','"+UpdatedDateAndTime+"')";
						formObject.saveDataIntoDataSource(query1);
						DigitalOnBoarding.mLogger.info("RLOS value of query1 "+query1);	
						
						String removeOldRecord="delete from ng_rlos_FIRCO with (nolock) where Workitem_no='"+ formObject.getWFWorkitemName()+"'";
						formObject.saveDataIntoDataSource(removeOldRecord);
						DigitalOnBoarding.mLogger.info("RLOS value of deleteQuery "+removeOldRecord);		
						String query="INSERT INTO NG_RLOS_FIRCO (Process_name,Workitem_no,Firco_ID,Request_datatime,Workstep_name,Newgen_status,StatusBehavior,StatusName,AlertDetails,Updated_Datetime) "
								+ "VALUES('"+formObject.getWFProcessName()+"','"+ formObject.getWFWorkitemName()+"','"+SystemID+"','"+requestDate+"','"+formObject.getWFActivityName()+"','"+NewgenStatus+"','"+StatusBehavior+"','"+StatusName+"','"+AlertDetails+"','"+UpdatedDateAndTime+"')";
						DigitalOnBoarding.mLogger.info("RLOS value of InsertQuery "+query);	
						formObject.saveDataIntoDataSource(query);
						...
						if(StatusBehavior.equalsIgnoreCase("2")){
							alert_msg= NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL117");
							formObject.setNGValue("IS_WORLD_CHECK","Y");
						}
						else {
						alert_msg= NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL118");
//
					...
					alert_msg= NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL119");					
					}
			...
			// FIRCO-end
				...
				DigitalOnBoarding.mLogger.info("CC_DDVT_MAker "+ "EID value for Entity Details for Supplementary Cards: "+EmiratesID);
				...
				if( EmiratesID!=null && !"".equalsIgnoreCase(EmiratesID)){
					...
					ReturnCode =  (outputResponse.contains("<ReturnCode>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
					DigitalOnBoarding.mLogger.info("CC_DDVT_MAker value of ReturnCode for Supplementary Cards: "+ReturnCode);
					if("0000".equalsIgnoreCase(ReturnCode)){
					...
					DigitalOnBoarding.mLogger.info("CC_DDVT_MAker value of Primary Cif"+primaryCif);
				}
				if(!isEntityDetailsSuccess || (primaryCif==null || "".equalsIgnoreCase(primaryCif))){
					...
					DigitalOnBoarding.mLogger.info("outputResponse after Supplement CUSTOMER_ELIGIBILITY:  "+outputResponse);
					ReturnCode =  (outputResponse.contains("<ReturnCode>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
					DigitalOnBoarding.mLogger.info("CC_DDVT_MAker value of ReturnCode for Supplementary Cards: "+ReturnCode);
					if("0000".equalsIgnoreCase(ReturnCode) )
					{
			...
			else if("Customer_Button1".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				if("0000".equalsIgnoreCase(ReturnCode)){
					...
					DigitalOnBoarding.mLogger.info("PL value of BlacklistFlag_Part"+"Customer is BlacklistedFlag"+BlacklistFlag);
					...
					DigitalOnBoarding.mLogger.info("PL value of BlacklistFlag_Part"+"Customer is DuplicationFlag"+DuplicationFlag);
					...
					DigitalOnBoarding.mLogger.info("PL value of BlacklistFlag_Part"+"Customer is NegatedFlag"+NegatedFlag);
					formObject.setNGValue("Is_Customer_Eligibility","Y");
					formObject.RaiseEvent("WFSave");
					DigitalOnBoarding.mLogger.info("RLOS value of ReturnDesc Is_Customer_Eligibility"+formObject.getNGValue("Is_Customer_Eligibility"));
					...
					if("true".equalsIgnoreCase(NTB_flag)){
						...
						alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL014");
					}
				...
				DigitalOnBoarding.mLogger.info("RLOS value of Customer Details"+formObject.getNGValue("Is_Customer_Eligibility"));
				DigitalOnBoarding.mLogger.info("RLOS value of BlacklistFlag"+formObject.getNGValue("BlacklistFlag"));
				DigitalOnBoarding.mLogger.info("RLOS value of DuplicationFlag"+formObject.getNGValue("DuplicationFlag"));
				DigitalOnBoarding.mLogger.info("RLOS value of IsAcctCustFlag"+formObject.getNGValue("IsAcctCustFlag"));
				formObject.RaiseEvent("WFSave");
				throw new ValidatorException(new FacesMessage(alert_msg));
				//}
			}
				...
				//genX.GenerateXML();
				DigitalOnBoarding.mLogger.info("PL PartMatch_Search"+ "Inside PartMatch_Search button: ");
				...
				DigitalOnBoarding.mLogger.info("OPart match OUTPUT::::"+outputResponse);
				ReturnCode =  (outputResponse.contains("<ReturnCode>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
				DigitalOnBoarding.mLogger.info("PL value of ReturnCode"+ReturnCode);
				ReturnDesc =  (outputResponse.contains("<ReturnDesc>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnDesc>")+"</ReturnDesc>".length()-1,outputResponse.indexOf("</ReturnDesc>")):"";	
				DigitalOnBoarding.mLogger.info("PL value of ReturnDesc"+ReturnDesc);
				if("0000".equalsIgnoreCase(ReturnCode) || "000".equalsIgnoreCase(ReturnCode) ){
					//valueSetCustomer(outputResponse);	
					...
					DigitalOnBoarding.mLogger.info("PL value of Part Match Request"+"inside if of partmatch");
					alert_msg= NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL064");
				}
				else{
					formObject.setNGValue("Is_PartMatchSearch","N");
					formObject.setLocked("PartMatch_Blacklist", false);
					DigitalOnBoarding.mLogger.info("PL value of Part Match Request"+"inside else of partmatch");
					alert_msg= NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL031");
				}
				formObject.RaiseEvent("WFSave");
				DigitalOnBoarding.mLogger.info("PL value of Part Match Request"+formObject.getNGValue("Is_PartMatchSearch"));
				if((	NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_Y").equalsIgnoreCase(formObject.getNGValue("Is_PartMatchSearch"))))
				{ 
					DigitalOnBoarding.mLogger.info("RLOS value of Is_CUSTOMER_UPDATE_REQ"+"inside if condition of disabling the button");
				}
				else{
				...
				if(supplementry_to_PrimaryCheck()){
					alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL115");
					throw new ValidatorException(new FacesMessage(alert_msg));
				}
				try{
					outputResponse =genX.GenerateXML("CUSTOMER_DETAILS","PartMatch_CIF");//changed by akshay for proc 7395 on 1/4/18
					DigitalOnBoarding.mLogger.info("CC value of ReturnDesc"+"Customer Details part Match");
					ReturnCode =  (outputResponse.contains("<ReturnCode>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
					DigitalOnBoarding.mLogger.info("CC value of ReturnCode part Match"+ReturnCode);
					if("0000".equalsIgnoreCase(ReturnCode)){

						String Staff_cif = CDOB_Common.getTagValue(outputResponse, "IsStaff");  
						if("Y".equalsIgnoreCase(Staff_cif)){
							DigitalOnBoarding.mLogger.info("Staff CIF is Y");
							alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL074");
							DigitalOnBoarding.mLogger.info("alert msg---"+alert_msg);
							...
							DigitalOnBoarding.mLogger.info("CC value of ReturnCode part Match"+ReturnCode);
							DigitalOnBoarding.mLogger.info("Value of NegativeListFlag: "+NegativeListFlag+" BlacklistFlag_code:Blacklist Reason: "+BlacklistFlag_reason+": "+BlacklistFlag_code);

							if("Y".equalsIgnoreCase(BlacklistFlag_Part))
							{
								DigitalOnBoarding.mLogger.info("CC value of BlacklistFlag_Part"+"Customer is Blacklisted");    
							}
							else{
								BlacklistFlag_Part="N";
								DigitalOnBoarding.mLogger.info("CC value of BlacklistFlag_Part"+"Customer is not Blacklisted");    
							}
							//added by Akshay
							if("Y".equalsIgnoreCase(NegativeListFlag))
							{
								DigitalOnBoarding.mLogger.info("CC value of NegativeListFlag"+"Customer is Negative");
								//Deepak Changes done for Negative flag and code & reason code. - PCAS-1985 - 07/07/2019
								...
								NegativeListFlag="N";
								DigitalOnBoarding.mLogger.info("CC value of BlacklistFlag_Part"+"Customer is not Negative");    
							}//ended By Akshay
						}

						DigitalOnBoarding.mLogger.info("CC value of BlacklistFlag_Part flag"+BlacklistFlag_Part+"");   
						...
						DigitalOnBoarding.mLogger.info("CC value of BlacklistFlag_Part flag inside try"+BlacklistFlag_Part+"");    
						...
						DigitalOnBoarding.mLogger.info("CC DDVT Maker"+ "list_custinfo list values"+list_custinfo);
					...
					DigitalOnBoarding.mLogger.info("PL DDVT Maker"+ "Inside Validator exception Catch---->STAFF CIF case!!"+alert_msg);
					throw new ValidatorException(new FacesMessage(alert_msg));
				}
				catch(Exception e){
					DigitalOnBoarding.mLogger.info("PL DDVT Maker"+ "Exception while setting data in grid:"+e.getMessage());
					alert_msg= NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL032");
					throw new ValidatorException(new FacesMessage(alert_msg));
				}
			...
			CreditCard.mLogger.info(formObject.getNGValue("Is_Customer_Details"));
				...
				DigitalOnBoarding.mLogger.info(ReturnCode);
				ReturnDesc =  (outputResponse.contains("<ReturnDesc>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnDesc>")+"</ReturnDesc>".length()-1,outputResponse.indexOf("</ReturnDesc>")):"";    
				DigitalOnBoarding.mLogger.info("CC value of ReturnDesc"+ReturnDesc);
				if("0000".equalsIgnoreCase(ReturnCode) || "000".equalsIgnoreCase(ReturnCode)){
					formObject.setNGValue("Is_Customer_Details","Y");
					DigitalOnBoarding.mLogger.info("CC value of EID_Genuine"+"value of Authorised_CIF"+formObject.getNGValue("Is_Customer_Details"));
					valSet.valueSetCustomer(outputResponse,"Authorised_CIF");    
					DigitalOnBoarding.mLogger.info("CC value of Customer Details"+"Authorised_CIF is generated");
					DigitalOnBoarding.mLogger.info("CC value of Customer Details"+formObject.getNGValue("Is_Customer_Details"));
				}
				else{
					DigitalOnBoarding.mLogger.info("Customer Details"+"Customer Details is not generated");
					formObject.setNGValue("Is_Customer_Details","N");
				}
				DigitalOnBoarding.mLogger.info("CC value of Authorised_CIF"+formObject.getNGValue("Is_Customer_Details"));
			}
			 ...
			 */
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL090");
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL075");
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL076");
				...
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL077");
				...
				//Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				Custom_fragmentSave("Part_Match");
				alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL097");
			...
			//changes done in below for blacklist changes
				...
				try
				{
					DigitalOnBoarding.mLogger.info("PL value of ReturnDesc"+"Blacklist Details part Match1111");
					...
					DigitalOnBoarding.mLogger.info("PL value of ReturnDesc"+"Blacklist Details part Match1111 after initializing strings");
					outputResponse =genX.GenerateXML("BLACKLIST_DETAILS","");
					DigitalOnBoarding.mLogger.info("PL value of ReturnDesc"+"Blacklist Details part Match");
					ReturnCode =  (outputResponse.contains("<ReturnCode>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
					DigitalOnBoarding.mLogger.info("PL value of ReturnCode part Match"+ReturnCode);
					ReturnDesc =  (outputResponse.contains("<ReturnDesc>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnDesc>")+"</ReturnDesc>".length()-1,outputResponse.indexOf("</ReturnDesc>")):"";    
					DigitalOnBoarding.mLogger.info("PL value of ReturnDesc part Match"+ReturnDesc);

					if("0000".equalsIgnoreCase(ReturnCode) ){
						//alert_msg = "BlackList Check Successfully: " ;
						formObject.setNGValue("Is_Customer_Eligibility_Part","Y");   
						DigitalOnBoarding.mLogger.info("PL value of BlacklistFlag_Part Customer is Blacklisted StatusType"+formObject.getNGValue("Is_Customer_Eligibility_Part"));
						...
						DigitalOnBoarding.mLogger.info("PL value of BlacklistFlag_Part"+"Customer is Blacklisted StatusType"+StatusType);
						...
						DigitalOnBoarding.mLogger.info(outputResponse);
						...
						for (int temp1 = 0; temp1 < nListMain.getLength(); temp1++) {
							...
							for (int temp = 0; temp < StatusInfoList.getLength(); temp++) {
								...
								if (nNode.getNodeType() == Node.ELEMENT_NODE) {
									...
									DigitalOnBoarding.mLogger.info("StatusType: "+StatusType);
									...
									if(StatusDetailsList.getLength()==0){
										...
										DigitalOnBoarding.mLogger.info("final list:: "+ BlacklistGrid.toString());
									}
									else{
										for (int listcount=0;listcount<StatusDetailsList.getLength();listcount++){
											...
											if("Black List".equalsIgnoreCase(StatusType)){
												...
												DigitalOnBoarding.mLogger.info("PL value of BlacklistFlag_Part Customer is Blacklisted StatusCode"+BlacklistCode);
											...
											DigitalOnBoarding.mLogger.info("PL value of CustomerStatus"+"Customer is Blacklisted StatusType"+CustomerStatus);
											//below code added by nikhil 12/12/17
											List<String> BlacklistGrid = new ArrayList<String>(); 
											BlacklistGrid.add(CifID);
											BlacklistGrid.add(CustomerStatus); 
											...
											formObject.addItemFromList("cmplx_PartMatch_Blacklist_Grid",BlacklistGrid);
											DigitalOnBoarding.mLogger.info("final list: "+listcount+" : "+ BlacklistGrid.toString());
										}
									}
				...
				{
					DigitalOnBoarding.logException(ex);
					//below code added by nikhil 12/12/17
					alert_msg = "BlackList Check failed Please contact administrator";
				}
				throw new ValidatorException(new FacesMessage(alert_msg));
			...
			// added by  abhishek to modify the avg nbc repeater data 
				...
				boolean flag = false;
				DigitalOnBoarding.mLogger.info("@nikhil Inside Acc Modify");
				...
				DigitalOnBoarding.mLogger.info("@nikhil Inside Acc Modify::"+repObj1.getRepeaterRowCount());
				...
				DigitalOnBoarding.mLogger.info("@nikhil Inside FLag"+flag);
				if(flag==true){
					DigitalOnBoarding.mLogger.info("@nikhil FLag is true");
			...
			// added by  abhishek to modify the turnover repeater data 
				...
				if(formObject.getSelectedIndex("cmplx_FinacleCore_credturn_grid")>-1){
					...
					//int x = 0;
					DigitalOnBoarding.mLogger.info("turnover grid after select query for turnover row count value is::"+n);
					int deleteCount = 0;
					for(int i=0;i<n;i++){
						String accNoinGrid = formObject.getNGValue("cmplx_FinacleCore_credturn_grid",(i-deleteCount),0);
						DigitalOnBoarding.mLogger.info("accNoinGrid is:"+accNoinGrid);
			...
			{
				DigitalOnBoarding.mLogger.info("CC val cmplx_DEC_VerificationRequired "+ "Value of cmplx_DEC_VerificationRequired is:"+formObject.getNGValue("cmplx_DEC_VerificationRequired"));
			...
			//}
				...
				DigitalOnBoarding.mLogger.info( "Inside add button: add of card details");
...
//								{
									gridECRN=formObject.getNGValue("cmplx_CardDetails_cmplx_CardCRNDetails",0,1); //Removed loop : && changed i to 0 since the loop was executing only once in any case.
									DigitalOnBoarding.mLogger.info(0+" Row ECRN is "+gridECRN);
									//formObject.getNGValueAt(arg0, arg1)
									if(gridECRN!=null && !gridECRN.equalsIgnoreCase(""))
										DigitalOnBoarding.mLogger.info("ECRN is already Present "+gridECRN);
//									break;
//								}
							}
							objInput.add("Text:" + formObject.getWFWorkitemName());
							...
							if(objOutput.isEmpty()){
								alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL093");
								...
								if(ECRNandCRN.contains("Error")){
									...
									if(ECRNandCRN.indexOf(":")>-1 && ECRNandCRN.split(":").length>0){
										...
										alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL094");
									}
								}
								else{
									...
									DigitalOnBoarding.mLogger.info("ECRN IS: " + ((String)objOutput.get(0)).substring(0, 9) + " CRN Is: " + ((String)objOutput.get(0)).substring(10));
									String CardProduct=formObject.getNGValue("CardDetails_CardProduct");
									String KRN=formObject.getNGValue("CardDetails_KRN");
									DigitalOnBoarding.mLogger.info("CardProduct is: "+CardProduct+" And KRN is: "+KRN);
									DigitalOnBoarding.mLogger.info("KRN IS"+String.valueOf(KRN));
									alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL094");
								}
							}
						}
				...
				/*if(CardProduct.toLowerCase().contains("kalyan") && "".equalsIgnoreCase(KRN))
          {
			...
			else if ("CardDetails_Button5".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				List<String> objInput = new ArrayList();
				List<Object> objOutput = new ArrayList();
				DigitalOnBoarding.mLogger.info("Generate KCRN Button");
				objInput.add("Text:" + formObject.getWFWorkitemName());
				objInput.add("Text:" + formObject.getNGValue("CardDetails_ECRN"));
				objOutput.add("Text");
				DigitalOnBoarding.mLogger.info("objInput args are: " + formObject.getWFWorkitemName()+" "+formObject.getNGValue("CardDetails_CRN"));
				...
				DigitalOnBoarding.mLogger.info("KRN IS: " + ((String)objOutput.get(0)));
			}
		...
		//Above code added by Prabhakar for CRN 
			 */		else if ("CardDetails_add".equalsIgnoreCase(pEvent.getSource().getName())){
				 formObject.setNGValue("CardDetailsGR_WiName",formObject.getWFWorkitemName());
				 DigitalOnBoarding.mLogger.info(formObject.getNGValue("CardDetailsGR_WiName"));
				 formObject.ExecuteExternalCommand("NGAddRow", "cmplx_CardDetails_cmplx_CardCRNDetails");
				 DigitalOnBoarding.mLogger.info("after adding in the grid");
				 ...
				 DigitalOnBoarding.mLogger.info( "Inside add button22: modify of card details");
				 ...
				 if("DDVT_Maker".equals(formObject.getWFActivityName()) && formObject.getLVWRowCount("cmplx_CardDetails_cmplx_CardCRNDetails")>0){
					 ...
					 if("".equalsIgnoreCase(formObject.getNGValue("ECRN"))){
						 ...
						 DigitalOnBoarding.mLogger.info("NewCif: "+ newCif);
						 DigitalOnBoarding.mLogger.info("old CIF: "+ formObject.getNGValue("cmplx_Customer_CIFNo"));
						 DigitalOnBoarding.mLogger.info("NTB flag: "+ formObject.getNGValue("cmplx_Customer_NTB"));
						 if((!formObject.getNGValue("cmplx_Customer_CIFNo").equalsIgnoreCase(newCif)) && (!"".equalsIgnoreCase(newCif) && "false".equalsIgnoreCase(formObject.getNGValue("cmplx_Customer_NTB"))) ){
							 DigitalOnBoarding.mLogger.info("Inside CIF update condition: "+ newCif);
				 ...
				 DigitalOnBoarding.mLogger.info( "Inside add button33: delete of card details");
				 //Deepak 25March2018 Changes done to save CRN Grid data. at CRN/ECRN generation 
				 //Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				 Custom_fragmentSave("Card_Details");
			...
			// added by abhishek on 17 august 2017//change by prabhakar drop-4 point-3
				 ...
				 DigitalOnBoarding.mLogger.info( "Inside FATCA_Button1 text is "+text);
				 ...
				 String hiddenText=formObject.getNGValue("FATCA_selectedreasonhidden");
				 DigitalOnBoarding.mLogger.info("hiddenText is: "+hiddenText);
				 Map<String,String> ReasonMap =getFatcaReasons();
				 ...
				 formObject.setNGValue("FATCA_selectedreasonhidden", hiddenText);
				 DigitalOnBoarding.mLogger.info( "Inside FATCA_Button1 hidden text is after Concat: "+hiddenText);
			...
			//Modified by prabhakar drop-4point-3
				 ...
				 try {
					 DigitalOnBoarding.mLogger.info( "Inside FATCA_Button2 ");
					 Map<String,String> ReasonMap =getFatcaReasons();
					 String hiddenText=formObject.getNGValue("FATCA_selectedreasonhidden");
					 DigitalOnBoarding.mLogger.info( "Inside FATCA_Button1 hidden text is "+hiddenText);
					 ...
					 DigitalOnBoarding.mLogger.info( "hiddenText.indexOf(hiddenTextRemove)+hiddenTextRemove.length(), hiddenText.length() "+hiddenText.indexOf(hiddenTextRemove)+hiddenTextRemove.length()+","+hiddenText.length());
					 ...
					 formObject.setNGValue("FATCA_selectedreasonhidden", hiddenText);
					 DigitalOnBoarding.mLogger.info( "Inside FATCA_Button1 hidden text is after deletion: "+hiddenText);
			 ...
			 */
				 ...
				 DigitalOnBoarding.mLogger.info( "Inside add button: "+formObject.getNGValue("OECD_winame"));
				 ...
				 DigitalOnBoarding.mLogger.info("Tinno"+Tinno);
				 DigitalOnBoarding.mLogger.info("Tinno_reason"+Tinno_reason);
				 ...
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL079");
			 ...
			 else if("DecisionHistory_Button2".equalsIgnoreCase(pEvent.getSource().getName()))
			 {
				 try{
					 ...
					 DigitalOnBoarding.mLogger.info( "inside create Account/Customer NTB value: "+NTB_flag );
					 ...
					 if(MultipleAppGridSelectedRow("MultipleApp_AppCIF").equalsIgnoreCase("")){
						 ...
						 String Emp_type = NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_SAL");
						 ...
						 DigitalOnBoarding.mLogger.info("value of applicant type is: "+MultipleAppGridSelectedRow("MultipleApp_AppType"));
						 if("Primary".equalsIgnoreCase(MultipleAppGridSelectedRow("MultipleApp_AppType"))){
							 DigitalOnBoarding.mLogger.info("inside primary applicant type is: ");
							 ...
							 DigitalOnBoarding.mLogger.info("inside supplement applicant type is: ");
							 outputResponse = genX.GenerateXML("NEW_CUSTOMER_REQ","SUPPLEMENT_CIF");
							 ReturnCode =  outputResponse.contains("<ReturnCode>") ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
							 if("0000".equalsIgnoreCase(ReturnCode))
							 {
								 DigitalOnBoarding.mLogger.info("CC DDVT Checker"+ "Supplement CIf created  sucessfully!!!");
								 alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL011");
						 ...
						 DigitalOnBoarding.mLogger.info("inside else condition for creating cif");
					 }
					 ...
					 DigitalOnBoarding.mLogger.info("Inside DecisionHistory_Button2:"+"exception occurred!!!"+printException(e));
		...
		else if("CC_Creation_Card_Services".equalsIgnoreCase(pEvent.getSource().getName()))
		{
			 ...
			 */
				 ...
				 DigitalOnBoarding.mLogger.info("inside transer to CAPS");
				 ...
				 {
					 DigitalOnBoarding.mLogger.info("inside supplement condition");
					 outputResponse = genX.GenerateXML("CARD_NOTIFICATION","SUPPLEMENT");
				 }
				 else{
					 DigitalOnBoarding.mLogger.info("inside primary condition");
				 ...
				 DigitalOnBoarding.mLogger.info(ReturnDesc);
				 if("0000".equalsIgnoreCase(ReturnCode) || "000".equalsIgnoreCase(ReturnCode)){
					 DigitalOnBoarding.mLogger.info("value of Customer_Details inside lock code");
					 formObject.setNGValue("Is_CardNotifiaction","Y");
					 ...
					 DigitalOnBoarding.mLogger.info(""+formObject.getNGValue("Is_CardNotifiaction"));
					 //Tarang 24 Dec, New method added to handle invalid session in fragment save event.
					 ...
					 try{
						 ...
						 DigitalOnBoarding.mLogger.info("Exception occured while eror code desc from DB table: "+e.getMessage());
					 }
			...
			// ended by yash
				 ...
				 DigitalOnBoarding.mLogger.info("RLOS value of ReturnCode"+"inside button click");
				 DigitalOnBoarding.mLogger.info(""+"Card Creation Call triggered");
				 ...
				 DigitalOnBoarding.mLogger.info("islamic_complete query: "+islamic_complete);
				 ...
				 DigitalOnBoarding.mLogger.info("RLOS value of ReturnCode"+ReturnCode);
				 if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_integrationsuccess").equalsIgnoreCase(ReturnCode)){
					 DigitalOnBoarding.mLogger.info("PLCommoncode card creation successfull");
				 ...
				 formObject.RaiseEvent("WFSave");
				 DigitalOnBoarding.mLogger.info("inside button click");
				 String Product_Name;
			...
			Product_Name=formObject.getNGValue("cmplx_CCCreation_pdt");
				 ...
				 DigitalOnBoarding.mLogger.info(""+Product_Name);
				 if("Limit Change Request".equalsIgnoreCase(Product_Name)){
					 outputResponse = genX.GenerateXML("CARD_SERVICES_REQUEST","Limit Change Request");
					 ReturnCode =  (outputResponse.contains("<ReturnCode>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
					 DigitalOnBoarding.mLogger.info(ReturnCode);
					 ...
					 if("0000".equalsIgnoreCase(ReturnCode) || "000".equalsIgnoreCase(ReturnCode) ){
						 DigitalOnBoarding.mLogger.info("value of Customer_Details inside inquiry code");
						 formObject.setNGValue("Is_CardServices","Y");
						 DigitalOnBoarding.mLogger.info(""+formObject.getNGValue("Is_CardServices"));
						 DigitalOnBoarding.mLogger.info("CARD SERVICES RUNNING Limit Change Request");
						 alert_msg=Product_Name+NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL086");
					...
					if("0000".equalsIgnoreCase(ReturnCode) || "000".equalsIgnoreCase(ReturnCode)){
						...
						alert_msg=Product_Name+NGFUserResourceMgr_CreditCard.getAlert("VAL089");
						 ...
						 alert_msg=Product_Name+NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL087");
					 }
				 }
				 ...
				 if("Financial Services Request".equalsIgnoreCase(Product_Name)){
					 ...
					 if("0000".equalsIgnoreCase(ReturnCode) || "000".equalsIgnoreCase(ReturnCode)){
						 ...
						 formObject.setNGValue("Is_CardServices","Y"); 
						 DigitalOnBoarding.mLogger.info(""+formObject.getNGValue("Is_CardServices"));
						 DigitalOnBoarding.mLogger.info("CARD SERVICES RUNNING Financial Services Request");
						 alert_msg=Product_Name+NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL086");
						 /*outputResponse = genX.GenerateXML("CARD_NOTIFICATION","");
					ReturnCode =  (outputResponse.contains("<ReturnCode>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
					CreditCard.mLogger.info(ReturnCode);
				 ...
				 if("Product Upgrade Request".equalsIgnoreCase(Product_Name)){
					 ...
					 if("0000".equalsIgnoreCase(ReturnCode) || "000".equalsIgnoreCase(ReturnCode) ){
						 ...
						 formObject.setNGValue("Is_CardServices","Y"); 
						 DigitalOnBoarding.mLogger.info(""+formObject.getNGValue("Is_CardServices"));
						 DigitalOnBoarding.mLogger.info("CARD SERVICES RUNNING Product Upgrade Request");
						 alert_msg=Product_Name+NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL086");
						 /*outputResponse = genX.GenerateXML("CARD_NOTIFICATION","");
					ReturnCode =  (outputResponse.contains("<ReturnCode>")) ? outputResponse.substring(outputResponse.indexOf("<ReturnCode>")+"</ReturnCode>".length()-1,outputResponse.indexOf("</ReturnCode>")):"";
					CreditCard.mLogger.info(ReturnCode);
			...
			/*	 else if("BussinessVerification1_Button1".equalsIgnoreCase(pEvent.getSource().getName()))
			 {
				 ...
				 DigitalOnBoarding.mLogger.info( "new cust Verification Details are saved"); 
				 Custom_fragmentSave("Customer_Details_Verification1");
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL105");
				 DigitalOnBoarding.mLogger.info( "s Verification Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));

			 }
			 else if ("EmploymentVerification_s2_Button1".equalsIgnoreCase(pEvent.getSource().getName())) {
				 //loadPicklist_Address();
				 DigitalOnBoarding.mLogger.info( "new Employment Verification Details are saved"); 
				 //Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				 Custom_fragmentSave("Employment_Verification");
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL026");
				 DigitalOnBoarding.mLogger.info( "new Employment Verification Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));

			 }
			 else if ("exceptionalCase_sp2_Button2".equalsIgnoreCase(pEvent.getSource().getName())) {
				 DigitalOnBoarding.mLogger.info( "new except Verification Details are saved"); 
				 Custom_fragmentSave("Exceptional_Case_Alert");
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL106");
				 DigitalOnBoarding.mLogger.info( "new except Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));
			 }//cmplx_fieldvisit_sp2_drop2
			 else if ("fieldvisit_sp2_Button1".equalsIgnoreCase(pEvent.getSource().getName())) {
				 DigitalOnBoarding.mLogger.info( "new field Verification Details are saved"); 
				 Custom_fragmentSave("Field_Visit_Initiated");
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL107");
				 DigitalOnBoarding.mLogger.info( "new fieldVerification Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));
			 }//EMploymentDetails_Label43
			 else if ("checklist_ver_sp2_Button1".equalsIgnoreCase(pEvent.getSource().getName())) {
				 DigitalOnBoarding.mLogger.info( "checkList Verification Details are saved");  //Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				 Custom_fragmentSave("CheckList");
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL108");
				 DigitalOnBoarding.mLogger.info( "checkList Verification Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));
			 }
			//below code modified by nikhil 4/12/17
			 else if("BankingCheck_save".equalsIgnoreCase(pEvent.getSource().getName())){

				 DigitalOnBoarding.mLogger.info( "Banking Check Details are saved"); 
				 //Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				 Custom_fragmentSave("Banking_Check");
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL002");
				 DigitalOnBoarding.mLogger.info( "Banking Check Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));
			 }
			...
			//Below else if button functionality changed by nikhil  5/12/17 for serach of cust detail verification
				 ...
				 DigitalOnBoarding.mLogger.info( "Inside FCU Search button ");
				 ...
				 try
				 {
					 if("Self Employed".equalsIgnoreCase(formObject.getNGValue("EmploymentType")))
					 {
						 DigitalOnBoarding.mLogger.info( "Inside FCU Search button: Self Employed ");
					 ...
					 {
						 DigitalOnBoarding.mLogger.info( "Inside FCU Search button: Salaried ");
					 ...
					 DigitalOnBoarding.mLogger.info( "query is: of cust detail search "+query);
					 List<List<String>> list=formObject.getDataFromDataSource(query);
					 DigitalOnBoarding.mLogger.info("##Arun");
				 ...
				 {
					 DigitalOnBoarding.mLogger.info(ex.getStackTrace());
				 }
			 }
				 ...
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL066");
				 DigitalOnBoarding.mLogger.info( "Customer Details Verification Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));
				 ...
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL065");
				 ...
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL067");
				 DigitalOnBoarding.mLogger.info( "Customer Details Verification Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));
				 ...
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL068");
				 DigitalOnBoarding.mLogger.info( "Customer Details Verification Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));
				 ...
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL069");
				 DigitalOnBoarding.mLogger.info( "Customer Details Verification Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));
				 ...
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL070");
				 DigitalOnBoarding.mLogger.info( "Customer Details Verification Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));
				 ...
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL071");
				 DigitalOnBoarding.mLogger.info( "Customer Details Verification Details are saved123"); 
				 formObject.RaiseEvent("WFSave");
				 throw new ValidatorException(new FacesMessage(alert_msg));
				 ...
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL072");
				 DigitalOnBoarding.mLogger.info( "Customer Details Verification Details are saved123"); 
				 throw new ValidatorException(new FacesMessage(alert_msg));
				 ...
				 DigitalOnBoarding.mLogger.info( "Enable button click::query result is::"+list );
				 for(int i =0;i<list.size();i++ ){
					/* if("Smart_CPV".equalsIgnoreCase(list.get(i).get(0))){
						 // formObject.setLocked("OfficeandMobileVerification_Frame1", true);
						 alert_msg = NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL006");
						 throw new ValidatorException(new FacesMessage(alert_msg));
					 }*/
			...
			String curr="0.06";
				 ...
				 formObject.RaiseEvent("WFSave");
				 DigitalOnBoarding.mLogger.info( "sagarika new_cpv_cad"+formObject.getNGValue("cmplx_OffVerification_cnfrminjob_val"));
				 DigitalOnBoarding.mLogger.info( "sagarika new_cpv_cad"+formObject.getNGValue("cmplx_OffVerification_cnfminjob_ver"));
				 DigitalOnBoarding.mLogger.info( "sagarika new_cpv_cad"+formObject.getNGValue("cmplx_OffVerification_cnfminjob_ver"));
				 
			

/*if("No".equals(formObject.getNGValue("cmplx_OffVerification_doj_ver")))
{
...
/*else
{
	formObject.setLocked("cmplx_OffVerification_doj_upd", true);
			...
			//-- Above code added by abhishek as per CC FSD 2.7.3
			 ...
			 {
				 DigitalOnBoarding.mLogger.info( "inside Compliance_Button2 click before call::");
				 formObject.ExecuteExternalCommand("NGModifyRow", "cmplx_Compliance_cmplx_gr_compliance");
				 DigitalOnBoarding.mLogger.info( "inside Compliance_Button2 click after  call::");
			 }
			 else if("Compliance_Save".equalsIgnoreCase(pEvent.getSource().getName())){
				 //Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				 Custom_fragmentSave("Compliance");
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL099");//compliance details details savedd
				 throw new ValidatorException(new FacesMessage(alert_msg));
				 ...
				 DigitalOnBoarding.mLogger.info( "currDate::"+currDate);
			...
			// added by abhishek as per CC FSD 
				 ...
				 DigitalOnBoarding.mLogger.info( "inside contact established click::");
				 DateFormat dateFormat = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
				 Date date = new Date();
				 String currDate = dateFormat.format(date);
				 DigitalOnBoarding.mLogger.info( "currDate::"+currDate);
			...
			// changed by saurabh on 8th Feb
			 ...
			 }//added by saurabh1 start for OV
			 else  if("OriginalValidation_Customer_Update".equalsIgnoreCase(pEvent.getSource().getName()) ){

				 DigitalOnBoarding.mLogger.info("inside OriginalValidation_Customer_Update" );
				 expandDecision();
				 formObject.fetchFragment("DecisionHistory", "DecisionHistory", "q_DecisionHistory");
				 loadInDecGrid();
				 openDemographicTabs();
				 ...
				 formObject.setTop("ProductContainer",1350);
				 formObject.fetchFragment("Internal_External_Liability", "Liability_New", "q_Liabilities");
				 formObject.setLocked("cmplx_Liability_New_DBR",true);
				 formObject.setLocked("cmplx_Liability_New_TAI",true);
				 formObject.setLocked("cmplx_Liability_New_DBRNet",true);
			...
			//++ below code added by abhishek on 04/01/2018 for EFMS refresh functionality
				 ...
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL080");//Incoming Document details savedd
				 throw new ValidatorException(new FacesMessage(alert_msg));
			 }
			 else if("ELigibiltyAndProductInfo_Refresh".equalsIgnoreCase(pEvent.getSource().getName()))
			 {
				 DigitalOnBoarding.mLogger.info("Inside refresh button code::");
				 ...
				 try{
					 ...
					 DigitalOnBoarding.mLogger.info("EFMS list 2::"+list_alertstatus);
					 alertstatus = list_alertstatus.get(0).get(0)+" || "+list_alertstatus.get(1).get(0);
				 }
				 catch(Exception e){
					 DigitalOnBoarding.mLogger.info("Exception occured while geting alertstatus"+e.getMessage());
				 ...
				 if(!list.isEmpty()){
					 ...
					 DigitalOnBoarding.mLogger.info("EFMS Alertflag::"+Alertflag);
			...
			CreditCard.mLogger.info("inside mouse clicked for refr casde :::"+refer);
			 ...
			 else if("OriginalValidation_Save".equalsIgnoreCase(pEvent.getSource().getName()))
			 {
				 //Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				 Custom_fragmentSave("Original_validation");
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL081");//Incoming Document details savedd
				 throw new ValidatorException(new FacesMessage(alert_msg));
			 }
			 else if("ReferHistory_save".equalsIgnoreCase(pEvent.getSource().getName())){
				 DigitalOnBoarding.mLogger.info("Inside refer hostory save event.. ");
				 //Tarang 24 Dec, New method added to handle invalid session in fragment save event.
				 Custom_fragmentSave("ReferHistory");
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL091");//Incoming Document details savedd
				 throw new ValidatorException(new FacesMessage(alert_msg));
			 }
				 ...
				 DigitalOnBoarding.mLogger.info( "deignation_7");
			...
			/*	 else if ("Designation_button7".equalsIgnoreCase(pEvent.getSource().getName())){
			 ...
			 else if("CardCollection_Button4".equalsIgnoreCase(pEvent.getSource().getName()))
			 {
				 ...
				 alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL098");//Incoming Document details savedd
				 throw new ValidatorException(new FacesMessage(alert_msg));
			 }
			...
			//Deepak Changes done for PCAS-3431
			 ...
			 formObject.setEnabled("FinacleCore_DDSClearing", true);
			 formObject.setEnabled("FinacleCore_ReturnDate", true);
					 ...
					 DigitalOnBoarding.mLogger.info("Exception occured in ::"+e.getMessage());
					 throw new ValidatorException(new FacesMessage(alert_msg));
				 }
			 }
	//added by saurabh1
			private String VaildateSkyward(String buttonId) {
				...
				if("0000".equalsIgnoreCase(ReturnCode))
				{
					...
					formObject.setNGValue("AlternateContactDetails_SkywardNumber", MembershipNumber);
	...
	Description                         : value changed event       
			...
			public void value_changed(FormEvent pEvent)
			{
				...
				//Smart
					...
					if("cmplx_fieldvisit_sp2_drop2".equalsIgnoreCase(pEvent.getSource().getName()))
					{
						try{
							...
							{
								DigitalOnBoarding.mLogger.info("inhouse");
							...
							{
								DigitalOnBoarding.mLogger.info("Agency");
				...
				//	DigitalOnBoarding.mLogger.info(" @sagarika "+(pEvent.getSource().getName()));
					if("cmplx_OffVerification_colleaguenoverified".equalsIgnoreCase(pEvent.getSource().getName()) || "cmplx_OffVerification_hrdemailverified".equalsIgnoreCase(pEvent.getSource().getName())){
						try{
							DigitalOnBoarding.mLogger.info(" @sagarika verify");
							...
							{
								DigitalOnBoarding.mLogger.info(" @sagarika cmplx");
								formObject.setLocked("cmplx_OffVerification_fxdsal_ver",false);
								formObject.setEnabled("cmplx_OffVerification_accpvded_ver",true);
								formObject.setEnabled("cmplx_OffVerification_desig_ver",true);
								formObject.setEnabled("cmplx_OffVerification_doj_ver",true);
							...
							{DigitalOnBoarding.mLogger.info(" @sagarika notverify");
							formObject.setLocked("cmplx_OffVerification_fxdsal_ver",true);
							...
							DigitalOnBoarding.mLogger.info(" Exception in EMI Generation"+e.getMessage());
						}
					}
						...
						try{
							...
							if(formObject.getNGValue("cmplx_DEC_Decision").equalsIgnoreCase("REFER"))
							{
								...
								LoadPickList("DecisionHistory_ReferTo", "select referTo from ng_MASTER_Decision with (nolock) where ProcessName='DigitalOnBoarding' and workstepName='"+Workstep+"' and decision='"+formObject.getNGValue("cmplx_DEC_Decision")+"'");
								formObject.setLocked("DecisionHistory_dec_reason_code", false);
								...
								//LoadPickList("DecisionHistory_dec_reason_code", "select description,code from ng_MASTER_DecisionReason with (nolock) where workstep='"+Workstep+"' and decision='"+formObject.getNGValue("cmplx_DEC_Decision")+"' order by code");
									LoadPickList1("DecisionHistory_dec_reason_code", "select description from ng_MASTER_DecisionReason with (nolock) where workstep='"+Workstep+"' and decision='"+formObject.getNGValue("cmplx_DEC_Decision")+"' order by code");//added by saurabh1 for pcasf-504
								}


							}
							else if ("FPU".equalsIgnoreCase(formObject.getWFActivityName())){
								//cmplx_EmploymentDetails_IndusSeg
								DigitalOnBoarding.mLogger.info("Inside change event of Decision ss");
								formObject.setNGValue("cmplx_DEC_FeedbackStatus","");
								String decision=formObject.getNGValue("cmplx_DEC_Decision");
								DigitalOnBoarding.mLogger.info("decision string"+decision);
								DigitalOnBoarding.mLogger.info("formvalue"+formObject.getNGValue("cmplx_DEC_Decision"));
								DigitalOnBoarding.mLogger.info("inside feedback status");
								if("Positive".equalsIgnoreCase(decision)){
									DigitalOnBoarding.mLogger.info("inside positive decision");
									formObject.setNGValue("cmplx_DEC_FeedbackStatus","Positive");
								}
								else if("Negative".equalsIgnoreCase(decision))
								{
									DigitalOnBoarding.mLogger.info("inside negative decision");
							...
							{
								DigitalOnBoarding.mLogger.info("Inside REJECT or PENDING decision");
							...
							else if(formObject.getNGValue("cmplx_DEC_Decision").equalsIgnoreCase("Submit") && "DDVT_maker".equalsIgnoreCase(formObject.getWFActivityName()))
							{
								...
								DigitalOnBoarding.mLogger.info("Inside else of decision");
							...
							DigitalOnBoarding.mLogger.info("End of change event of Decision");
						}
						catch(Exception e){
							DigitalOnBoarding.mLogger.info(" Exception in EMI Generation"+e.getMessage());
						}
				...
				if(formObject.getNGValue("cmplx_DEC_Decision").equalsIgnoreCase("REFER"))
				{
					...
					formObject.setLocked("DecisionHistory_ReferTo", false);//DecisionHistory_ReferTo
					LoadPickList("x", "select referTo from ng_MASTER_Decision with (nolock) where ProcessName='CreditCard' and workstepName='"+Workstep+"' and decision='"+formObject.getNGValue("cmplx_DEC_Decision")+"'");
					formObject.setLocked("DecisionHistory_dec_reason_code", false);
					LoadPickList("DecisionHistory_dec_reason_code", "select description,code from (SELECT '--Select--' as description,'' as code union select description,code from ng_MASTER_DecisionReason with (nolock) where workstep='"+Workstep+"' and decision='"+formObject.getNGValue("cmplx_DEC_Decision")+"') as new  order by  case when code='' then code else description end");
				...
				formObject.setNGValue("DecisionHistory_save", true);
					...
					// Code added to Load targetSegmentCode on basis of code
						...
						DigitalOnBoarding.mLogger.info("RLOS val change "+ "Value of dob is:"+formObject.getNGValue("ApplicationCategory"));
						...
						DigitalOnBoarding.mLogger.info("RLOS val change "+ "Value of subproduct is:"+formObject.getNGValue("subproduct"));
					...
					// Code added to Load targetSegmentCode on basis of code
						...
						DigitalOnBoarding.mLogger.info("RLOS val change "+ "Value of subproduct is:"+formObject.getNGValue("subproduct"));
						if(appCategory!=null &&  "BAU".equalsIgnoreCase(appCategory)){
							LoadPickList("cmplx_EmploymentDetails_targetSegCode", "select '--Select--' as description,'' as code union select description,code from NG_MASTER_TargetSegmentCode with (nolock) where isActive='Y' and BAU='Y' and (product = 'CC' or product='B') order by code");
						}
						else if(appCategory!=null &&  "S".equalsIgnoreCase(appCategory)){
						...
						DigitalOnBoarding.mLogger.info("CC val change "+ "Value of ReqProd is:"+ReqProd);
						loadPicklistProduct(ReqProd);
					}

					else if ("subProd".equalsIgnoreCase(pEvent.getSource().getName())){
						DigitalOnBoarding.mLogger.info("CC val change "+ "Value of SubProd is:"+formObject.getNGValue("subProd"));
						//formObject.clear("AppType");
						if(	NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_BusinessTitaniumCard").equalsIgnoreCase(formObject.getNGValue("subProd"))){
							LoadPickList("AppType", "select '--Select--' union select convert(varchar, description) from ng_master_ApplicationType with (nolock) where subProdFlag='"+NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_BTC")+"'");
							formObject.setNGValue("EmpType","Self Employed");
						}	
						else if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_InstantMoney").equalsIgnoreCase(formObject.getNGValue("subProd"))){
							LoadPickList("AppType", "select '--Select--' union select convert(varchar, description) from ng_master_ApplicationType  with (nolock) where subProdFlag='"+NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_IM")+"'");
							formObject.setNGValue("EmpType","Salaried");
						}

						else if(	NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_LimitIncrease").equalsIgnoreCase(formObject.getNGValue("subProd")))
							LoadPickList("AppType", "select '--Select--' union select convert(varchar, description) from ng_master_ApplicationType with (nolock) where subProdFlag='"+NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_LI")+"'");

						else if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_SalariedCreditCard").equalsIgnoreCase(formObject.getNGValue("subProd")))
							LoadPickList("AppType", "select '--Select--' union select convert(varchar, description) from ng_master_ApplicationType with (nolock) where subProdFlag='"+NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_SAL")+"'");

						else if(NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_SelfEmployedCreditCard").equalsIgnoreCase(formObject.getNGValue("subProd")))
							LoadPickList("AppType", "select '--Select--' union select convert(varchar, description) from ng_master_ApplicationType with (nolock) where subProdFlag='"+NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_SE")+"'");

						else if(	NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_ExpatPersonalLoans").equalsIgnoreCase(formObject.getNGValue("subProd")))
							LoadPickList("AppType", "select '--Select--' union select convert(varchar, description) from ng_master_ApplicationType with (nolock) where subProdFlag='"+NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_EXP")+"'");

						else if(	NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_NationalPersonal").equalsIgnoreCase(formObject.getNGValue("subProd")))
							LoadPickList("AppType", "select '--Select--' union select convert(varchar, description) from ng_master_ApplicationType with (nolock) where subProdFlag='"+NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_NAT")+"'");

						else if(	NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_Pre-Approved").equalsIgnoreCase(formObject.getNGValue("subProd")))
							LoadPickList("AppType", "select '--Select--' union select convert(varchar, description) from ng_master_ApplicationType with (nolock) where subProdFlag='"+NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_PA")+"'");

						else if(	NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_ProductUpgrade").equalsIgnoreCase(formObject.getNGValue("subProd")))
							LoadPickList("AppType", "select '--Select--' union select convert(varchar, description) from ng_master_ApplicationType with (nolock) where subProdFlag='"+NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_PU")+"'");
			...
			if("Islamic".equalsIgnoreCase(ProdType))
				LoadPickList("CardProd", "select '--Select--' union select convert(varchar,description) from ng_MASTER_CardProduct with (nolock) where code like '%AMAL%' ORDER BY description");
						...
						DigitalOnBoarding.mLogger.info("RLOS val change "+ "Value of cmplx_WorldCheck_WorldCheck_Grid_dob is:"+formObject.getNGValue("cmplx_WorldCheck_WorldCheck_Grid_dob"));
					...
					// Changes done by aman for PCSP-67
						...
						DigitalOnBoarding.mLogger.info("RLOS val change Value of dob is:"+sQuery);

						List<List<String>> recordList = formObject.getNGDataFromDataCache(sQuery);
						DigitalOnBoarding.mLogger.info("RLOS val change Vasdfsdflue of dob is:"+recordList.get(0).get(0));
						if(recordList.get(0).get(0)!= null && recordList.get(0)!=null && !"".equalsIgnoreCase(recordList.get(0).get(0)) && recordList!=null)
						{
							formObject.setNGValue("Contract_App_Type",recordList.get(0).get(0));
						}
					...
					// Changes done by aman for PCSP-67
						...
						DigitalOnBoarding.mLogger.info( "$Indus Macro$:" +formObject.getNGValue("cmplx_EmploymentVerification_FiledVisitedInitiated_value"));
					...
					//beow code by saurabh for new incoming doc.
						...
						if("Personal Loan".equalsIgnoreCase(requested_product)){
							...
							if("CAC".equalsIgnoreCase(targetsegCode)){
								...
								query="SELECT docname FROM ng_rlos_DocTable with (nolock) WHERE DocType = '"+docType+"' and (ProductName = '"+requested_product+"'  or ProductName='All') and ActivityName='"+activity+"' and (SubProductName = '"+requested_subproduct+"'  or SubProductName='All') and Active = 'Y' and (Designation='CAC' or Designation='All') ";
							}
								...
								query="SELECT docname FROM ng_rlos_DocTable with (nolock) WHERE DocType = '"+docType+"' and (ProductName = '"+requested_product+"'  or ProductName='All') and ActivityName='"+activity+"' and (SubProductName = '"+requested_subproduct+"'  or SubProductName='All') and Active = 'Y' and (Designation='DOC' or Designation='All') ";
							}
								...
								query="SELECT docname FROM ng_rlos_DocTable with (nolock) WHERE DocType = '"+docType+"' and (ProductName = '"+requested_product+"'  or ProductName='All') and ActivityName='"+activity+"' and (SubProductName = '"+requested_subproduct+"'  or SubProductName='All') and Active = 'Y' and (Designation='EMPID' or Designation='All') ";
							}
								...
								query="SELECT docname FROM ng_rlos_DocTable with (nolock) WHERE DocType = '"+docType+"' and (ProductName = '"+requested_product+"'  or ProductName='All') and ActivityName='"+activity+"' and (SubProductName = '"+requested_subproduct+"'  or SubProductName='All') and Active = 'Y' and (Designation='NEP' or Designation='All') ";
							}
							else if("VIS".equalsIgnoreCase(targetsegCode)){
								query="SELECT docname FROM ng_rlos_DocTable with (nolock) WHERE DocType = '"+docType+"' and (ProductName = '"+requested_product+"'  or ProductName='All') and ActivityName='"+activity+"' and (SubProductName = '"+requested_subproduct+"'  or SubProductName='All') and Active = 'Y' and (Designation='VC' or Designation='All') ";
							}
							else{

								query="SELECT docname FROM ng_rlos_DocTable with (nolock) WHERE DocType = '"+docType+"' and (ProductName = '"+requested_product+"'  or ProductName='All') and ActivityName='"+activity+"' and (SubProductName = '"+requested_subproduct+"'  or SubProductName='All') and Active = 'Y' and (Designation='"+targetsegCode+"' or Designation='"+empTypeDoc+"' or Designation='All') and ProcessName='DigitalOnBoarding' ";
							}
		...
		//code added for LOB
			...
			common.getAge(formObject.getNGValue("cmplx_EmploymentDetails_DOJ"),"cmplx_EmploymentDetails_LOS");
					...
					/*else if ("cmplx_EmploymentDetails_EmpIndusSector".equalsIgnoreCase(pEvent.getSource().getName()) && "true".equals(formObject.getNGValue("cmplx_EmploymentDetails_Others"))){
						...
						DigitalOnBoarding.mLogger.info( "$Indus Sector$:" +formObject.getNGValue("cmplx_EmploymentDetails_EmpIndusSector"));
					...
					/*else if ("cmplx_EmploymentDetails_Indus_Macro".equalsIgnoreCase(pEvent.getSource().getName()) && "true".equals(formObject.getNGValue("cmplx_EmploymentDetails_Others"))){
						DigitalOnBoarding.mLogger.info( "$Indus Macro$:" +formObject.getNGValue("cmplx_EmploymentDetails_Indus_Macro"));
					...
					//added by yashfor CC FSD
						...
						DigitalOnBoarding.mLogger.info(sQuery);
						List<List<String>> recordList = formObject.getNGDataFromDataCache(sQuery);
						...
						{ DigitalOnBoarding.mLogger.info(recordList.get(0).get(0));
						formObject.setNGValue("NotepadDetails_notecode",recordList.get(0).get(0));
						DigitalOnBoarding.mLogger.info(recordList.get(0).get(1));
			...
			if(recordList!=null && recordList.get(0)!=null && recordList.get(0).get(0)!= null && !"".equalsIgnoreCase(recordList.get(0).get(0)) )
			{
				...
				formObject.setNGValue("NotepadDetails_workstep",recordList.get(0).get(1),false);
						...
						if(totalCredit>deduction){
							...
							alert_msg=NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL023");
							throw new ValidatorException(new FacesMessage(alert_msg));
						}
					} 
			...
			CreditCard.mLogger.info(" ");
					...
					else if ("AppType".equalsIgnoreCase(pEvent.getSource().getName()))
					{
						...
						DigitalOnBoarding.mLogger.info( "Value of SubProd is:"+formObject.getNGValue("SubProd"));
						DigitalOnBoarding.mLogger.info( "Value of AppType is:"+formObject.getNGValue("AppType"));
						DigitalOnBoarding.mLogger.info( "Value of AppType is:"+formObject.getNGValue("Product_type"));


						if (("Conventional".equalsIgnoreCase(TypeofProduct))&& NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_EXP").equalsIgnoreCase(subprod)&&("TKOE".equalsIgnoreCase(apptype))){


							DigitalOnBoarding.mLogger.info( "1Value of AppType is:"+formObject.getNGValue("AppType"));
						...
						if (("Conventional".equalsIgnoreCase(TypeofProduct))&& NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_EXP").equalsIgnoreCase(subprod)&&("NEWE".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "2Value of AppType is:"+formObject.getNGValue("AppType"));
						...
						if (("Conventional".equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_EXP").equalsIgnoreCase(subprod))&&("TOPE".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "3Value of AppType is:"+formObject.getNGValue("AppType"));
						...
						if (("Conventional".equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_EXP").equalsIgnoreCase(subprod))&&("RESCE".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "4Value of AppType is:"+formObject.getNGValue("AppType"));
							formObject.clear("Scheme");
							formObject.setNGValue("Scheme","--Select--");
						...
						if (("Conventional".equalsIgnoreCase(TypeofProduct)&& NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_NAT").equalsIgnoreCase(subprod))&&("TOPN".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "5Value of AppType is:"+formObject.getNGValue("AppType"));
							formObject.clear("Scheme");
							formObject.setNGValue("Scheme","--Select--");
						...
						if (("Conventional".equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_NAT").equalsIgnoreCase(subprod))&&("TKON".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "6Value of AppType is:"+formObject.getNGValue("AppType"));
							formObject.clear("Scheme");
							formObject.setNGValue("Scheme","--Select--");
						...
						if (("Conventional".equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_NAT").equalsIgnoreCase(subprod))&&("NEWN".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "7Value of AppType is:"+formObject.getNGValue("AppType"));
							formObject.clear("Scheme");
							formObject.setNGValue("Scheme","--Select--");
						...
						if (("Conventional".equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_NAT").equalsIgnoreCase(subprod))&&("RESCN".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "8Value of AppType is:"+formObject.getNGValue("AppType"));
							formObject.clear("Scheme");
							formObject.setNGValue("Scheme","--Select--");
						...
						if (("Islamic".equalsIgnoreCase(TypeofProduct))&& NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_EXP").equalsIgnoreCase(subprod)&&("TKOE".equalsIgnoreCase(apptype))){
						...
						if (("Islamic".equalsIgnoreCase(TypeofProduct))&& NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_EXP").equalsIgnoreCase(subprod)&&("NEWE".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "2Value of AppType is:"+formObject.getNGValue("AppType"));
							formObject.clear("Scheme");
							formObject.setNGValue("Scheme","--Select--");
						...
						if (("Islamic".equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_EXP").equalsIgnoreCase(subprod))&&("TOPE".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "3Value of AppType is:"+formObject.getNGValue("AppType"));
						...
						if (("Islamic".equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_EXP").equalsIgnoreCase(subprod))&&("RESCE".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "4Value of AppType is:"+formObject.getNGValue("AppType"));
						...
						if (("Islamic".equalsIgnoreCase(TypeofProduct)&& NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_NAT").equalsIgnoreCase(subprod))&&("TOPN".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "5Value of AppType is:"+formObject.getNGValue("AppType"));
							formObject.clear("Scheme");
							formObject.setNGValue("Scheme","--Select--");
						...
						if (("Islamic".equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_NAT").equalsIgnoreCase(subprod))&&("TKON".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "6Value of AppType is:"+formObject.getNGValue("AppType"));
							formObject.clear("Scheme");
							formObject.setNGValue("Scheme","--Select--");
						...
						if (("Islamic".equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_NAT").equalsIgnoreCase(subprod))&&("NEWN".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "7Value of AppType is:"+formObject.getNGValue("AppType"));
							formObject.clear("Scheme");
							formObject.setNGValue("Scheme","--Select--");
						...
						if (("Islamic".equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_NAT").equalsIgnoreCase(subprod))&&("RESCN".equalsIgnoreCase(apptype))){
							DigitalOnBoarding.mLogger.info( "8Value of AppType is:"+formObject.getNGValue("AppType"));
							formObject.clear("Scheme");
							formObject.setNGValue("Scheme","--Select--");
					...
					else if ("cmplx_DEC_SubFeedbackStatus".equalsIgnoreCase(pEvent.getSource().getName()) && "FPU".equalsIgnoreCase(formObject.getWFActivityName())){

						DigitalOnBoarding.mLogger.info("inside feedback cmplx_DEC_FeedbackStatus");
						...
						//LoadpicklistFCU();
						DigitalOnBoarding.mLogger.info("inside feedback status after loadpicklist");

					}//cmplx_DEC_SubFeedbackStatus
					else if ("cmplx_DEC_FeedbackStatus".equalsIgnoreCase(pEvent.getSource().getName()) && "FPU".equalsIgnoreCase(formObject.getWFActivityName())){
						...
						{
							DigitalOnBoarding.mLogger.info("not a P/N decision");
							LoadpicklistFCU();
						}
					...
					{
						DigitalOnBoarding.mLogger.info("inside mouse clicked for refr casde :::");
						//String refer=formObject.getNGValue("DecisionHistory_ReferTo");
						String referTo = formObject.getNGValue("DecisionHistory_ReferTo");
						DigitalOnBoarding.mLogger.info("inside mouse clicked for refr casde :::"+referTo);
						formObject.clear("DecisionHistory_dec_reason_code"); 
					...
					//	LoadPickList("DecisionHistory_dec_reason_code", "select description,code from ng_MASTER_DecisionReason with (nolock) where workstep='"+Workstep+"' and decision='"+formObject.getNGValue("cmplx_DEC_Decision")+"' and ReferTo='"+referTo+"' and (ProcessName='CreditCard' or  ProcessName='ALL') order by code");
						LoadPickList1("DecisionHistory_dec_reason_code", "select description from ng_MASTER_DecisionReason with (nolock) where workstep='"+Workstep+"' and decision='"+formObject.getNGValue("cmplx_DEC_Decision")+"' and ReferTo='"+referTo+"' and (ProcessName='CreditCard' or  ProcessName='ALL') order by code");//added by saurabh1 for pcasf-504

						formObject.setNGValue("q_MailSubject", referTo);
						if("CPV".equalsIgnoreCase(formObject.getWFActivityName()) || "Smart_CPV".equalsIgnoreCase(formObject.getWFActivityName()) || "CPV_Analyst".equalsIgnoreCase(formObject.getWFActivityName()))
						{
						if("Customer_Hold".equalsIgnoreCase(referTo))
						{
							String rem=formObject.getNGValue("cmplx_OffVerification_hremail")+ " to be amended";
							formObject.setNGValue("cmplx_DEC_Remarks",rem);
							DigitalOnBoarding.mLogger.info("Customer_Hold SSSSS");
						}
						}
					...
					else if("cmplx_CardDetails_SelfSupp_required".equalsIgnoreCase(pEvent.getSource().getName()))
					{
						...
						if(Avl_Cards==null || Avl_Cards.size()==0)
						{
							...
							{	
								...
								throw new ValidatorException(new FacesMessage(NGFUserResourceMgr_DigitalOnBoarding.getAlert("VAL113")));
							}
						}
						if(!"Yes".equalsIgnoreCase(formObject.getNGValue("cmplx_CardDetails_SelfSupp_required")))
						{
					...
					DigitalOnBoarding.mLogger.info("Exception occured in Change event"+e.getMessage());
					throw new ValidatorException(new FacesMessage(alert_msg));
				}
			}
		...
		Description                         : To avoid overlapping on frame collapse     
			...
			{
				//FormReference formObject=FormContext.getCurrentInstance().getFormReference();
				DigitalOnBoarding.mLogger.info("Inside Frame Collapsed");
				if("Address_Details_container".equals(pEvent.getSource().getName()))
				{
					DigitalOnBoarding.mLogger.info("Inside if condition Frame Collapsed");
	...
	Description                         : fetch notepad details      
			...
			public void ddvtmaker_submitapp(){
				FormReference formObject = FormContext.getCurrentInstance().getFormReference();
				DigitalOnBoarding.mLogger.info("ddvtmaker_submitapp method start:: Winame: "+ formObject.getWFWorkitemName()+" user name: "+ formObject.getUserName());
				try{
					String CRN=formObject.getNGValue("cmplx_CardDetails_cmplx_CardCRNDetails",0, 2);
					for(int i=1;i<formObject.getLVWRowCount("cmplx_CardDetails_cmplx_CardCRNDetails");i++)
					{
					...
					DigitalOnBoarding.mLogger.info("CRN: "+formObject.getNGValue("CRN")+" ECRN: "+formObject.getNGValue("ECRN") + " Final_Limit: "+formObject.getNGValue("Final_Limit")+" email_id: "+formObject.getNGValue("email_id"));
				}
				catch(Exception e){
					DigitalOnBoarding.mLogger.info("Exception occured in ddvtmaker_submitapp to set ext table data: "+e.getMessage());
				}
				...
				try{
					...
					DigitalOnBoarding.mLogger.info("Exception occured in ddvtmaker_submitapp to set decision+fragment data save table data: "+e.getMessage());
				}
				formObject.RaiseEvent("WFSave");
				CustomSaveForm();
				DigitalOnBoarding.mLogger.info("ddvtmaker_submitapp method end:: Winame: "+ formObject.getWFWorkitemName()+" user name: "+ formObject.getUserName());
			}
			...
			{
				FormReference formObject = FormContext.getCurrentInstance().getFormReference();
				DigitalOnBoarding.mLogger.info("Inside LockFragmentsOnLoad()");
				if ("Customer".equalsIgnoreCase(pEvent.getSource().getName())) {
					...
					//loadPicklistEmployment(); ExtLiability_Frame4
					...
					String Activityname=formObject.getWFActivityName();
					DigitalOnBoarding.mLogger.info( "Exception:inside dsa review"+Activityname);
					...
					if(Activityname.equalsIgnoreCase("DSA_CSO_Review")){
						...
						if(	NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_PersonalLoan").equalsIgnoreCase(formObject.getNGValue("PrimaryProduct"))){
						...
						else if(	NGFUserResourceMgr_DigitalOnBoarding.getGlobalVar("CC_CreditCard").equalsIgnoreCase(formObject.getNGValue("PrimaryProduct"))){
			...
			formObject.setLocked("Compliance_Frame1",true);
				...
				if ("DecisionHistory".equalsIgnoreCase(pEvent.getSource().getName())) {
					...
					if(Activityname.equalsIgnoreCase("DSA_CSO_Review")){
						DigitalOnBoarding.mLogger.info( "inside dsa review");
			...
			public String setReferto(){
				...
				try{
					...
					DigitalOnBoarding.mLogger.info( "Exception occured in setReferto: "+e.getMessage());
				}
				return ReferTo;
			}
