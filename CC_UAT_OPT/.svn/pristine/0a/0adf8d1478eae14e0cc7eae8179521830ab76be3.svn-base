		...
		/*if (pEvent.getSource().getName().equalsIgnoreCase("Product")) {
			...
			// ++ below code not commented at offshore - 06-10-2017
				...
				//++ Below Code already exists for : "16-CSM-Liability Details-" Only aggregate exposure fiel shoul be visible in the bottom section in Liability details" : Reported By Shashank on Oct 05, 2017++
				  ...
				  formObject.setVisible("ExtLiability_AECBReport",true);
			...
			//added by yash on 22/8/2017
				...
				//12th sept
				 ...
				 //12th sept
				//++below code commented by nikhil 9/11/17 to fix "To fix actioned user name which is auto-populating"
				...
				//Ref. 1001.
				//--above code commented by nikhil 9/11/17 to fix "To fix actioned user name which is auto-populating"
			}
			//ended by yash
...
//changed by akshay on 6/12/17 for decision alignment
                ...
                //Changes DOne by aman for the field alignment
             /*   formObject.setTop("DecisionHistory_Decision_Label4", 60);
                formObject.setLeft("DecisionHistory_Decision_Label4", 550);
                formObject.setTop("cmplx_DEC_Remarks", 80);
               ...
               /* formObject.setVisible("DecisionHistory_Label8",false);
				...
				formObject.setVisible("DecisionHistory_Decision_Label4",false);  //Commented by Aman because the same is of no use
				formObject.setVisible("cmplx_DEC_Remarks",false);
                 ...
                 formObject.setVisible("DecisionHistory_Label7",false);
 				//changes done by akshay on 4/12/17 to align fields
 		 	...
 		 	formObject.setLocked("DecisionHistory_ReferTo",true);
				...
				formObject.setEnabled("cmplx_DEC_VerificationRequired", false);
 		 		//12th sept
 		 		/*formObject.setTop("DecisionHistory_Decision_Label3",20);//dec
				formObject.setTop("cmplx_DEC_Decision",36);//dec field
				disableButtonsCC("DecisionHistory");
				formObject.setTop("DecisionHistory_Decision_ListView1",100);
				//--Above code added by nikhil 7/11/17 as per CC issues sheet
				//Below code added by aman for positioning of decision fragment
				formObject.setVisible("DecisionHistory_Label26", true);
				formObject.setLeft("DecisionHistory_Decision_Label4", 1000);
				formObject.setLeft("cmplx_DEC_Remarks", 1000);
				formObject.setTop("DecisionHistory_Decision_Label4", 20);
				formObject.setTop("cmplx_DEC_Remarks", 36);
				formObject.setTop("DecisionHistory_dec_reason_code",36);//rsn code
				formObject.setTop("DecisionHistory_Label11",20);//rsn code label
				formObject.setLeft("DecisionHistory_Label11", 672);
				formObject.setLeft("DecisionHistory_dec_reason_code", 672);
				formObject.setLeft("DecisionHistory_Label26", 300);
				formObject.setLeft("DecisionHistory_ReferTo", 300);
				formObject.setTop("DecisionHistory_Label26", 20);
				formObject.setTop("DecisionHistory_ReferTo", 36);
