...
public class CC_FCU extends CC_Common implements FormListener
{
	...
	public void formPopulated(FormEvent pEvent) 
	{
		...
		try{
			...
			CreditCard.mLogger.info("Inside CC_FCU CC sagarika emp"+ formObject.getNGValue("EmploymentType"));
			CreditCard.mLogger.info("Inside CC_FCU CC sagarika R"+ formobject1.getConfigElement("Mode"));
			
			CreditCard.mLogger.info("Inside CC_FCU CC sagarika"+ formObject.getNGValue("Mandatory_Frames"));
			...
			if(!"R".equalsIgnoreCase(formobject1.getConfigElement("Mode"))) 
			{
				...
				CreditCard.mLogger.info("Inside CC_FCU CC"+ formObject.getNGValue("Mandatory_Frames"));
			}
