	...
	public void mouse_clicked(FormEvent pEvent) 
	{
		...
		try{
			...
			//Added by shivang
				...
				if( !("Salaried".equalsIgnoreCase(Emp_Type) ||  "SEC".equals(Sub_Prod) || "BPA".equals(Sub_Prod) || "true".equalsIgnoreCase(formObject.getNGValue("cmplx_Customer_VIPFlag")) ||
										("PA".equalsIgnoreCase(Sub_Prod) && ("RFL".equals(App_type) || "RFLP".equals(App_type) || "MOR".equals(App_type))) ||
										("BTC".equalsIgnoreCase(Sub_Prod) && "SMES".equals(App_type)) || ("SE".equalsIgnoreCase(Sub_Prod) && "S".equalsIgnoreCase(appCatg)) ) || ("PA".equalsIgnoreCase(Sub_Prod) && "Salaried".equalsIgnoreCase(Emp_Type) && !"MOR".equalsIgnoreCase(Emp_Type)))
				{
					formObject.setNGValue("Data_refresh_trigger", "Y");
					formObject.setEnabled("FinacleCore_Data_Refresh", true);
					formObject.setNGFocus("Finacle_Core");
...
public void set_enabled_customer(FormEvent pEvent){
...
public void  LimitIncreaseFields_Income1(FormEvent pEvent)
{
	FormReference formObject = FormContext.getCurrentInstance().getFormReference();
	int n = formObject.getLVWRowCount("cmplx_Product_cmplx_ProductGrid");
	if(n>0){
		for(int i=0;i<n;i++){ 
			if(formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",i,2).equalsIgnoreCase("Limit Increase")){
				formObject.setEnabled("cmplx_IncomeDetails_MonthlyRent",false); 
				formObject.setEnabled("cmplx_IncomeDetails_NoOfBankStat",false); 
				break;
			}
		}
	}
