...
*/	/*          Function Header:
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
		...
		*/	loadPicklist_CompanyDet();
		...
		for(int i=0;i<formObject.getLVWRowCount("cmplx_CompanyDetails_cmplx_CompanyGrid");i++)
		{
			if(formObject.getNGValue("cmplx_CompanyDetails_cmplx_CompanyGrid",i,0).contains("CNOAL"))
			{
				...
				CreditCard.mLogger.info("cnoal test");
			}//SupplementCardDetails_FetchDetails
		}
		setComapnyCode();
		AECBHistMonthCnt();
