...
public class CC_Compliance extends CC_Common implements FormListener
{
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
		...
		CreditCard.mLogger.info( "Compliance Step Fragment loaded event frame is: " + pEvent.getSource().getName());
			if ("Customer".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				*/
				...
				formObject.setLocked("IncomingDocNew_Frame1",false);//hritik ppct17
				formObject.setEnabled("IncomingDocNew_Frame1",true);//added hritik
				formObject.setLocked("cmplx_IncomingDocNew_MandatoryDocument",true);
				formObject.setLocked("cmplx_IncomingDocNew_NonMandatoryDoc",true);
				formObject.setLocked("IncomingDocNew_mandatory",true);
				formObject.setLocked("IncomingDocNew_Username",true);
				formObject.setLocked("IncomingDocNew_workstep",true);
...
//++ Below Code added By Yash on Oct 14, 2017  to fix : "for loading the Part Match nationality " : Reported By Shashank on Oct 09, 2017++
			...
			//12th sept
				...
				try{
					...
					if(n>Compliance_row_count && Compliance_row_count==0)//sagarika for PCAS 2257
					{
						...
						{ 
							...
							if(matchFound.contains("true")){
								...
								CreditCard.mLogger.info("setting compliance Dob"+Dob);
								...
								CreditCard.mLogger.info("setting compliance Entered_Date"+Entered_Date);
								...
								CreditCard.mLogger.info( "furtherinfo: "+furtherinfo);
								formObject.setNGValue("Compliance_FurtherInfo",furtherinfo);
								CreditCard.mLogger.info( "furtherinfo: "+formObject.getNGValue("Compliance_FurtherInfo"));
					...
					CreditCard.mLogger.info( "Exception in compliance condition frag load: "+printException(ex));
				}
			}
