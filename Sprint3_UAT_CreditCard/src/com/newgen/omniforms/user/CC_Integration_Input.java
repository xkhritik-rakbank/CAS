...
//Designation_button7 cmplx_IncomeDetails_NoOfMonthsOtherbankStat2
	/*          Function Header:
				...
				if(tag_name.equalsIgnoreCase("Number")){
					...
					if(int_xml.containsKey(parent_tag))
					{
						...
						if(int_xml.containsKey(parent_tag))
						{
							...
							CreditCard.mLogger.info("RLOS COMMON"+" before contact details+ "+DB_List1);
							if(!DB_List1.isEmpty()){
						...
						List<List<String>> DB_List1 = formObject.getDataFromDataSource(sQuery);
						CreditCard.mLogger.info("TitlePrefix sQuery result "+DB_List1);
						if(!DB_List1.isEmpty()){
							String ENROLL_REWARDS_PartnerCode=DB_List1.get(0).get(0);	
			...
			if (!OutputXML_header.isEmpty()) {
				...
				if (!("".equalsIgnoreCase(Operation_name) || Operation_name==null)) {
					...
					if ("DEDUP_SUMMARY".equalsIgnoreCase(callName)) {
						...
						int_xml = Blacklist_Details_custom(DB_List,formObject,callName,Operation_name);
					}
					...
					else if ("CARD_DETAILS".equalsIgnoreCase(callName)){
						int_xml = credit_Card_Custom(DB_List, formObject, callName, Operation_name);
						CreditCard.mLogger.info("My input XML :"+int_xml);
					}
					...
					while (itr.hasNext()) {
						...
						if (final_xml.indexOf((entry.getKey())) > -1) {
							CreditCard.mLogger.info("RLOS"+ "itr_value: Key: "
									+ entry.getKey() + " Value: "
									+ entry.getValue());
							if("CARD_NOTIFICATION".equalsIgnoreCase(callName) && "AdditionalInfo".equalsIgnoreCase(entry.getKey())){
								final_xml = final_xml.insert(final_xml.lastIndexOf("<" + entry.getKey() + ">")
					...
					if ("DECTECH".equalsIgnoreCase(callName) && "CC-0030043272-process".equals(formObject.getWFWorkitemName()))
					{
						final_xml=final_xml.delete(0, final_xml.length());
						String dec_check ="<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Header><ServiceId>CallProcessManager</ServiceId><ServiceType>ProductEligibility</ServiceType><ServiceProviderId>DECTECH</ServiceProviderId><ServiceChannelId>CAS</ServiceChannelId><RequestID>CASTEST</RequestID><TimeStampyyyymmddhhmmsss>2010-10-10T10:10:00.000</TimeStampyyyymmddhhmmsss><RequestLifeCycleStage>CallProcessManagerRequest</RequestLifeCycleStage><MessageStatus>Success</MessageStatus></soap:Header><soap:Body> <CallProcessManager xmlns=\"http://tempuri.org/\"><applicationXML><![CDATA[<ProcessManagerRequest><Application><Channel>CC</Channel><CallType>PM</CallType><ApplicationNumber>CC-0030000340-process</ApplicationNumber></Application><ApplicationDetails><product_type>CON</product_type><app_category>S</app_category><requested_product>CC</requested_product><requested_limit>5000</requested_limit><sub_product>SAL</sub_product><requested_card_product>EKWEC-EXPAT</requested_card_product><application_type>NEWE</application_type><interest_rate>0.00</interest_rate><customer_type>NTB</customer_type><final_limit>3000</final_limit><emi>0.0</emi><manual_deviation>N</manual_deviation><application_date>2020-07-18T13:52:35</application_date></ApplicationDetails><ApplicantDetails><applicant_id>2856089</applicant_id><ref_no>CAS-0000013764-PROCESS</ref_no><wi_name>CC-0030000340-process</wi_name><cust_name>PARTHA PRATIM SENGUPTA</cust_name><emp_type>S</emp_type><dob>1971-05-26</dob><age>49.02</age><dbr>50.78</dbr><tai>42500.00</tai><nationality>IN</nationality><resident_flag>Y</resident_flag><world_check>Negative</world_check><blacklist_cust_type>I</blacklist_cust_type><negative_cust_type>I</negative_cust_type><no_of_cheque_bounce_int_3mon_Ind>0</no_of_cheque_bounce_int_3mon_Ind><no_of_DDS_return_int_3mon_Ind>0</no_of_DDS_return_int_3mon_Ind><external_blacklist_flag>I</external_blacklist_flag><los>1.07</los><confirmed_in_job>Y</confirmed_in_job><target_segment_code>CAC</target_segment_code><current_emp_catogery>CA</current_emp_catogery><year_in_uae>01.07</year_in_uae><ref_relationship>Friend</ref_relationship><visa_expiry_date>2021-01-05</visa_expiry_date><passport_expiry_date>2023-12-22</passport_expiry_date><emirates_visa>AUH</emirates_visa><emirates_work>AUH</emirates_work><gender>M</gender><cust_mobile_no>00971564175188</cust_mobile_no><salary_with_rakbank>N</salary_with_rakbank><designation>DIR</designation><emirates_of_residence>AUH</emirates_of_residence><emp_name>TUV RHEINLAND MIDDLE EAST LLC</emp_name><cust_type>I</cust_type><industry_sector>SERVICES</industry_sector><industry_macro>CONSULTANCY</industry_macro><industry_micro>ENGINEERING</industry_micro><aggregate_exposed>3000.00</aggregate_exposed><cc_employer_status>LO</cc_employer_status><pl_employer_status>OP</pl_employer_status><included_pl_aloc>Y</included_pl_aloc><included_cc_aloc>Y</included_cc_aloc><los_prev>00.00</los_prev><marketing_code>BAU</marketing_code><payroll_flag>false</payroll_flag><visa_sponsor>TUV RHEINLAND MIDDLE EAST LLC</visa_sponsor><head_offc_emirate>AUH</head_offc_emirate><no_of_partners>-1</no_of_partners><standing_instruction>N</standing_instruction><country_of_residence>AE</country_of_residence><vip_flag>N</vip_flag><title>MR.</title><gcc_national>N</gcc_national><customer_category>5</customer_category><employer_type>P</employer_type></ApplicantDetails><InternalBureauData><InternalBureau><applicant_id>2856089</applicant_id><full_name>PARTHA PRATIM SENGUPTA</full_name><total_out_bal>0</total_out_bal><total_overdue>0</total_overdue><cheque_return_3mon>0</cheque_return_3mon><dds_return_3mon>0</dds_return_3mon><cheque_return_6mon>0</cheque_return_6mon><dds_return_6mon>0</dds_return_6mon><internal_charge_off>N</internal_charge_off><company_flag>N</company_flag></InternalBureau><InternalBureauDBRTAICalc><basic>42500.00</basic><gross_salary>42500.00</gross_salary><accomodation_provided>N</accomodation_provided><net_salary_mon1>42500.00</net_salary_mon1><net_salary_3mon_ave>42500.00</net_salary_3mon_ave><salary_flag>N</salary_flag><is_tenancy_contract_custname>Y</is_tenancy_contract_custname></InternalBureauDBRTAICalc></InternalBureauData><ExternalBureauData><ExternalBureau><applicant_id>2856089</applicant_id><bureauone_ref_no>825474</bureauone_ref_no><full_name>PARTHA PRATIM SENGUPTA</full_name><total_out_bal>494117.00</total_out_bal><total_overdue>0.00</total_overdue><no_default_contract>0</no_default_contract><total_exposure>716238</total_exposure><worst_curr_pay>0</worst_curr_pay><worst_curr_pay_24>0</worst_curr_pay_24><worst_status_24>U</worst_status_24><no_of_rec>18</no_of_rec><cheque_return_3mon>0</cheque_return_3mon><dds_return_3mon>0</dds_return_3mon><no_months_aecb_history>17</no_months_aecb_history><aecb_score>673</aecb_score><range>E</range><company_flag>N</company_flag><dispute_alert>N</dispute_alert></ExternalBureau><Utilization24months><CB_application_id>M17403589</CB_application_id><Month_Utilization><Month>06-2020</Month><CreditLimit>100000</CreditLimit><OutstandingBalance>30112</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2020</Month><CreditLimit>100000</CreditLimit><OutstandingBalance>30056</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2020</Month><CreditLimit>100000</CreditLimit><OutstandingBalance>35056</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2020</Month><CreditLimit>100000</CreditLimit><OutstandingBalance>40056</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2020</Month><CreditLimit>100000</CreditLimit><OutstandingBalance>48614</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2020</Month><CreditLimit>100000</CreditLimit><OutstandingBalance>60618</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2019</Month><CreditLimit>100000</CreditLimit><OutstandingBalance>70277</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2019</Month><CreditLimit>100000</CreditLimit><OutstandingBalance>86756</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2019</Month><CreditLimit>50000</CreditLimit><OutstandingBalance>26756</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2019</Month><CreditLimit>50000</CreditLimit><OutstandingBalance>39541</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2019</Month><CreditLimit>50000</CreditLimit><OutstandingBalance>28430</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2019</Month><CreditLimit>50000</CreditLimit><OutstandingBalance>47025</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2019</Month><CreditLimit>50000</CreditLimit><OutstandingBalance>46685</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2019</Month><CreditLimit>50000</CreditLimit><OutstandingBalance>46285</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2019</Month><CreditLimit>50000</CreditLimit><OutstandingBalance>36956</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2019</Month><CreditLimit>50000</CreditLimit><OutstandingBalance>48479</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2019</Month><CreditLimit>50000</CreditLimit><OutstandingBalance>7343</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization></Utilization24months><Utilization24months><CB_application_id>C17675417</CB_application_id><Month_Utilization><Month>03-2020</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2020</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2020</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2019</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2019</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2019</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2019</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>796</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2019</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>1549</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2019</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>1241</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2019</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>516</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2019</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>1956</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2019</Month><CreditLimit>13000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization></Utilization24months><Utilization24months><CB_application_id>H19764896</CB_application_id><Month_Utilization><Month>07-2020</Month><CreditLimit>42500</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2020</Month><CreditLimit>42500</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2020</Month><CreditLimit>42500</CreditLimit><OutstandingBalance>116</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2020</Month><CreditLimit>42500</CreditLimit><OutstandingBalance>2706</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2020</Month><CreditLimit>42500</CreditLimit><OutstandingBalance>70</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2020</Month><CreditLimit>42500</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2020</Month><CreditLimit>42500</CreditLimit><OutstandingBalance>274</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization></Utilization24months><Utilization24months><CB_application_id>H20307776</CB_application_id><Month_Utilization><Month>06-2020</Month><CreditLimit>80000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2020</Month><CreditLimit>80000</CreditLimit><OutstandingBalance>79</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2020</Month><CreditLimit>80000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2020</Month><CreditLimit>80000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2020</Month><CreditLimit>80000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2020</Month><CreditLimit>80000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization></Utilization24months><Utilization24months><CB_application_id>218510360</CB_application_id><Month_Utilization><Month>06-2020</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2020</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2020</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2020</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2020</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2020</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>494</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>12830</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>12000</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>15055</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>18378</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization></Utilization24months><Utilization24months><CB_application_id>D17805272</CB_application_id><Month_Utilization><Month>06-2020</Month><CreditLimit>10000</CreditLimit><OutstandingBalance>267</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2020</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2020</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>122</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2020</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>23</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2020</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>2302</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2020</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>5202</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2019</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2019</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2019</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2019</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>47</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2019</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>12158</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2019</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>790</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2019</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>12513</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2019</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>1254</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2019</Month><CreditLimit>52000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization></Utilization24months><Utilization24months><CB_application_id>518044111</CB_application_id><Month_Utilization><Month>04-2020</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2020</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2020</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2020</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>9612</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>12438</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>15553</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>15038</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>16504</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2019</Month><CreditLimit>20000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization></Utilization24months><Utilization24months><CB_application_id>J18046204</CB_application_id><Month_Utilization><Month>04-2020</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2020</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2020</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2020</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2019</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2019</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>11817</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2019</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>19653</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2019</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>8361</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2019</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>8223</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2019</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2019</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>10441</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2019</Month><CreditLimit>40000</CreditLimit><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>04-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>03-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>02-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>01-2019</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>12-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>11-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>10-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>09-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>08-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>07-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>06-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization><Month_Utilization><Month>05-2018</Month><OutstandingBalance>0</OutstandingBalance></Month_Utilization></Utilization24months><History_24months><CB_application_id>M17403589</CB_application_id><History><Key>06-2020</Key><Status>OK</Status></History><History><Key>05-2020</Key><Status>OK</Status></History><History><Key>04-2020</Key><Status>OK</Status></History><History><Key>03-2020</Key><Status>OK</Status></History><History><Key>02-2020</Key><Status>OK</Status></History><History><Key>01-2020</Key><Status>OK</Status></History><History><Key>12-2019</Key><Status>OK</Status></History><History><Key>11-2019</Key><Status>OK</Status></History><History><Key>10-2019</Key><Status>OK</Status></History><History><Key>09-2019</Key><Status>OK</Status></History><History><Key>08-2019</Key><Status>OK</Status></History><History><Key>07-2019</Key><Status>OK</Status></History><History><Key>06-2019</Key><Status>MIN</Status></History><History><Key>05-2019</Key><Status>MIN</Status></History><History><Key>04-2019</Key><Status>MIN</Status></History><History><Key>03-2019</Key><Status>MIN</Status></History><History><Key>02-2019</Key><Status>MIN</Status></History><History><Key>01-2019</Key><Status>N/A</Status></History><History><Key>12-2018</Key><Status>N/A</Status></History><History><Key>11-2018</Key><Status>N/A</Status></History><History><Key>10-2018</Key><Status>N/A</Status></History><History><Key>09-2018</Key><Status>N/A</Status></History><History><Key>08-2018</Key><Status>N/A</Status></History><History><Key>07-2018</Key><Status>N/A</Status></History></History_24months><History_24months><CB_application_id>C17675417</CB_application_id><History><Key>03-2020</Key><Status>OK</Status></History><History><Key>02-2020</Key><Status>OK</Status></History><History><Key>01-2020</Key><Status>OK</Status></History><History><Key>12-2019</Key><Status>OK</Status></History><History><Key>11-2019</Key><Status>OK</Status></History><History><Key>10-2019</Key><Status>OK</Status></History><History><Key>09-2019</Key><Status>OK</Status></History><History><Key>08-2019</Key><Status>OK</Status></History><History><Key>07-2019</Key><Status>OK</Status></History><History><Key>06-2019</Key><Status>OK</Status></History><History><Key>05-2019</Key><Status>OK</Status></History><History><Key>04-2019</Key><Status>OK</Status></History><History><Key>03-2019</Key><Status>N/A</Status></History><History><Key>02-2019</Key><Status>N/A</Status></History><History><Key>01-2019</Key><Status>N/A</Status></History><History><Key>12-2018</Key><Status>N/A</Status></History><History><Key>11-2018</Key><Status>N/A</Status></History><History><Key>10-2018</Key><Status>N/A</Status></History><History><Key>09-2018</Key><Status>N/A</Status></History><History><Key>08-2018</Key><Status>N/A</Status></History><History><Key>07-2018</Key><Status>N/A</Status></History><History><Key>06-2018</Key><Status>N/A</Status></History><History><Key>05-2018</Key><Status>N/A</Status></History><History><Key>04-2018</Key><Status>N/A</Status></History></History_24months><History_24months><CB_application_id>H19764896</CB_application_id><History><Key>07-2020</Key><Status>OK</Status></History><History><Key>06-2020</Key><Status>OK</Status></History><History><Key>05-2020</Key><Status>OK</Status></History><History><Key>04-2020</Key><Status>OK</Status></History><History><Key>03-2020</Key><Status>OK</Status></History><History><Key>02-2020</Key><Status>OK</Status></History><History><Key>01-2020</Key><Status>OK</Status></History><History><Key>12-2019</Key><Status>N/A</Status></History><History><Key>11-2019</Key><Status>N/A</Status></History><History><Key>10-2019</Key><Status>N/A</Status></History><History><Key>09-2019</Key><Status>N/A</Status></History><History><Key>08-2019</Key><Status>N/A</Status></History><History><Key>07-2019</Key><Status>N/A</Status></History><History><Key>06-2019</Key><Status>N/A</Status></History><History><Key>05-2019</Key><Status>N/A</Status></History><History><Key>04-2019</Key><Status>N/A</Status></History><History><Key>03-2019</Key><Status>N/A</Status></History><History><Key>02-2019</Key><Status>N/A</Status></History><History><Key>01-2019</Key><Status>N/A</Status></History><History><Key>12-2018</Key><Status>N/A</Status></History><History><Key>11-2018</Key><Status>N/A</Status></History><History><Key>10-2018</Key><Status>N/A</Status></History><History><Key>09-2018</Key><Status>N/A</Status></History><History><Key>08-2018</Key><Status>N/A</Status></History></History_24months><History_24months><CB_application_id>H20307776</CB_application_id><History><Key>06-2020</Key><Status>MIN</Status></History><History><Key>05-2020</Key><Status>MIN</Status></History><History><Key>04-2020</Key><Status>MIN</Status></History><History><Key>03-2020</Key><Status>MIN</Status></History><History><Key>02-2020</Key><Status>MIN</Status></History><History><Key>01-2020</Key><Status>MIN</Status></History><History><Key>12-2019</Key><Status>N/A</Status></History><History><Key>11-2019</Key><Status>N/A</Status></History><History><Key>10-2019</Key><Status>N/A</Status></History><History><Key>09-2019</Key><Status>N/A</Status></History><History><Key>08-2019</Key><Status>N/A</Status></History><History><Key>07-2019</Key><Status>N/A</Status></History><History><Key>06-2019</Key><Status>N/A</Status></History><History><Key>05-2019</Key><Status>N/A</Status></History><History><Key>04-2019</Key><Status>N/A</Status></History><History><Key>03-2019</Key><Status>N/A</Status></History><History><Key>02-2019</Key><Status>N/A</Status></History><History><Key>01-2019</Key><Status>N/A</Status></History><History><Key>12-2018</Key><Status>N/A</Status></History><History><Key>11-2018</Key><Status>N/A</Status></History><History><Key>10-2018</Key><Status>N/A</Status></History><History><Key>09-2018</Key><Status>N/A</Status></History><History><Key>08-2018</Key><Status>N/A</Status></History><History><Key>07-2018</Key><Status>N/A</Status></History></History_24months><History_24months><CB_application_id>218510360</CB_application_id><History><Key>06-2020</Key><Status>OK</Status></History><History><Key>05-2020</Key><Status>OK</Status></History><History><Key>04-2020</Key><Status>OK</Status></History><History><Key>03-2020</Key><Status>OK</Status></History><History><Key>02-2020</Key><Status>OK</Status></History><History><Key>01-2020</Key><Status>OK</Status></History><History><Key>12-2019</Key><Status>OK</Status></History><History><Key>11-2019</Key><Status>OK</Status></History><History><Key>10-2019</Key><Status>OK</Status></History><History><Key>09-2019</Key><Status>OK</Status></History><History><Key>08-2019</Key><Status>OK</Status></History><History><Key>07-2019</Key><Status>OK</Status></History><History><Key>06-2019</Key><Status>N/A</Status></History><History><Key>05-2019</Key><Status>N/A</Status></History><History><Key>04-2019</Key><Status>N/A</Status></History><History><Key>03-2019</Key><Status>N/A</Status></History><History><Key>02-2019</Key><Status>N/A</Status></History><History><Key>01-2019</Key><Status>N/A</Status></History><History><Key>12-2018</Key><Status>N/A</Status></History><History><Key>11-2018</Key><Status>N/A</Status></History><History><Key>10-2018</Key><Status>N/A</Status></History><History><Key>09-2018</Key><Status>N/A</Status></History><History><Key>08-2018</Key><Status>N/A</Status></History><History><Key>07-2018</Key><Status>N/A</Status></History></History_24months><History_24months><CB_application_id>D17805272</CB_application_id><History><Key>06-2020</Key><Status>MIN</Status></History><History><Key>05-2020</Key><Status>MIN</Status></History><History><Key>04-2020</Key><Status>MIN</Status></History><History><Key>03-2020</Key><Status>MIN</Status></History><History><Key>02-2020</Key><Status>MIN</Status></History><History><Key>01-2020</Key><Status>MIN</Status></History><History><Key>12-2019</Key><Status>MIN</Status></History><History><Key>11-2019</Key><Status>MIN</Status></History><History><Key>10-2019</Key><Status>MIN</Status></History><History><Key>09-2019</Key><Status>MIN</Status></History><History><Key>08-2019</Key><Status>MIN</Status></History><History><Key>07-2019</Key><Status>MIN</Status></History><History><Key>06-2019</Key><Status>MIN</Status></History><History><Key>05-2019</Key><Status>MIN</Status></History><History><Key>04-2019</Key><Status>MIN</Status></History><History><Key>03-2019</Key><Status>N/A</Status></History><History><Key>02-2019</Key><Status>N/A</Status></History><History><Key>01-2019</Key><Status>N/A</Status></History><History><Key>12-2018</Key><Status>N/A</Status></History><History><Key>11-2018</Key><Status>N/A</Status></History><History><Key>10-2018</Key><Status>N/A</Status></History><History><Key>09-2018</Key><Status>N/A</Status></History><History><Key>08-2018</Key><Status>N/A</Status></History><History><Key>07-2018</Key><Status>N/A</Status></History></History_24months><History_24months><CB_application_id>518044111</CB_application_id><History><Key>04-2020</Key><Status>OK</Status></History><History><Key>03-2020</Key><Status>N/A</Status></History><History><Key>02-2020</Key><Status>OK</Status></History><History><Key>01-2020</Key><Status>OK</Status></History><History><Key>12-2019</Key><Status>OK</Status></History><History><Key>11-2019</Key><Status>OK</Status></History><History><Key>10-2019</Key><Status>OK</Status></History><History><Key>09-2019</Key><Status>OK</Status></History><History><Key>08-2019</Key><Status>OK</Status></History><History><Key>07-2019</Key><Status>OK</Status></History><History><Key>06-2019</Key><Status>OK</Status></History><History><Key>05-2019</Key><Status>OK</Status></History><History><Key>04-2019</Key><Status>N/A</Status></History><History><Key>03-2019</Key><Status>N/A</Status></History><History><Key>02-2019</Key><Status>N/A</Status></History><History><Key>01-2019</Key><Status>N/A</Status></History><History><Key>12-2018</Key><Status>N/A</Status></History><History><Key>11-2018</Key><Status>N/A</Status></History><History><Key>10-2018</Key><Status>N/A</Status></History><History><Key>09-2018</Key><Status>N/A</Status></History><History><Key>08-2018</Key><Status>N/A</Status></History><History><Key>07-2018</Key><Status>N/A</Status></History><History><Key>06-2018</Key><Status>N/A</Status></History><History><Key>05-2018</Key><Status>N/A</Status></History></History_24months><History_24months><CB_application_id>J18046204</CB_application_id><History><Key>04-2020</Key><Status>OK</Status></History><History><Key>03-2020</Key><Status>OK</Status></History><History><Key>02-2020</Key><Status>OK</Status></History><History><Key>01-2020</Key><Status>OK</Status></History><History><Key>12-2019</Key><Status>OK</Status></History><History><Key>11-2019</Key><Status>OK</Status></History><History><Key>10-2019</Key><Status>OK</Status></History><History><Key>09-2019</Key><Status>OK</Status></History><History><Key>08-2019</Key><Status>OK</Status></History><History><Key>07-2019</Key><Status>OK</Status></History><History><Key>06-2019</Key><Status>OK</Status></History><History><Key>05-2019</Key><Status>OK</Status></History><History><Key>04-2019</Key><Status>N/A</Status></History><History><Key>03-2019</Key><Status>N/A</Status></History><History><Key>02-2019</Key><Status>N/A</Status></History><History><Key>01-2019</Key><Status>N/A</Status></History><History><Key>12-2018</Key><Status>N/A</Status></History><History><Key>11-2018</Key><Status>N/A</Status></History><History><Key>10-2018</Key><Status>N/A</Status></History><History><Key>09-2018</Key><Status>N/A</Status></History><History><Key>08-2018</Key><Status>N/A</Status></History><History><Key>07-2018</Key><Status>N/A</Status></History><History><Key>06-2018</Key><Status>N/A</Status></History><History><Key>05-2018</Key><Status>N/A</Status></History></History_24months><History_24months><CB_application_id>H19244936</CB_application_id><History><Key>02-2020</Key><Status>OK</Status></History><History><Key>01-2020</Key><Status>OK</Status></History><History><Key>12-2019</Key><Status>OK</Status></History><History><Key>11-2019</Key><Status>OK</Status></History><History><Key>10-2019</Key><Status>N/A</Status></History><History><Key>09-2019</Key><Status>N/A</Status></History><History><Key>08-2019</Key><Status>N/A</Status></History><History><Key>07-2019</Key><Status>N/A</Status></History><History><Key>06-2019</Key><Status>N/A</Status></History><History><Key>05-2019</Key><Status>N/A</Status></History><History><Key>04-2019</Key><Status>N/A</Status></History><History><Key>03-2019</Key><Status>N/A</Status></History><History><Key>02-2019</Key><Status>N/A</Status></History><History><Key>01-2019</Key><Status>N/A</Status></History><History><Key>12-2018</Key><Status>N/A</Status></History><History><Key>11-2018</Key><Status>N/A</Status></History><History><Key>10-2018</Key><Status>N/A</Status></History><History><Key>09-2018</Key><Status>N/A</Status></History><History><Key>08-2018</Key><Status>N/A</Status></History><History><Key>07-2018</Key><Status>N/A</Status></History><History><Key>06-2018</Key><Status>N/A</Status></History><History><Key>05-2018</Key><Status>N/A</Status></History><History><Key>04-2018</Key><Status>N/A</Status></History><History><Key>03-2018</Key><Status>N/A</Status></History></History_24months><History_24months><CB_application_id>N21004298</CB_application_id><History><Key>07-2020</Key><Status>OK</Status></History><History><Key>06-2020</Key><Status>OK</Status></History><History><Key>05-2020</Key><Status>OK</Status></History><History><Key>04-2020</Key><Status>OK</Status></History><History><Key>03-2020</Key><Status>OK</Status></History><History><Key>02-2020</Key><Status>OK</Status></History><History><Key>01-2020</Key><Status>N/A</Status></History><History><Key>12-2019</Key><Status>N/A</Status></History><History><Key>11-2019</Key><Status>N/A</Status></History><History><Key>10-2019</Key><Status>N/A</Status></History><History><Key>09-2019</Key><Status>N/A</Status></History><History><Key>08-2019</Key><Status>N/A</Status></History><History><Key>07-2019</Key><Status>N/A</Status></History><History><Key>06-2019</Key><Status>N/A</Status></History><History><Key>05-2019</Key><Status>N/A</Status></History><History><Key>04-2019</Key><Status>N/A</Status></History><History><Key>03-2019</Key><Status>N/A</Status></History><History><Key>02-2019</Key><Status>N/A</Status></History><History><Key>01-2019</Key><Status>N/A</Status></History><History><Key>12-2018</Key><Status>N/A</Status></History><History><Key>11-2018</Key><Status>N/A</Status></History><History><Key>10-2018</Key><Status>N/A</Status></History><History><Key>09-2018</Key><Status>N/A</Status></History><History><Key>08-2018</Key><Status>N/A</Status></History></History_24months><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><external_bureau_individual_products_id>218510360</external_bureau_individual_products_id><contract_type>01</contract_type><provider_no>B09</provider_no><phase>A</phase><role_of_customer>A</role_of_customer><start_date>2019-07-24</start_date><outstanding_balance>0</outstanding_balance><payments_amount>0</payments_amount><worst_status>U</worst_status><worst_status_date>2020-06-30</worst_status_date><credit_limit>20000</credit_limit><overdue_amount>0</overdue_amount><no_of_days_payment_delay>0</no_of_days_payment_delay><mob>12.00</mob><last_repayment_date>2020-06-01</last_repayment_date><currently_current>Y</currently_current><current_utilization>0</current_utilization><dpd_30_last_6_mon>0</dpd_30_last_6_mon><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><dpd_5_in_last_12_mon>0</dpd_5_in_last_12_mon><no_months_aecb_history>12</no_months_aecb_history><delinquent_in_last_3months>0</delinquent_in_last_3months><cac_indicator>N</cac_indicator><company_flag>N</company_flag><cac_bank_name>ADCB</cac_bank_name><take_over_indicator>N</take_over_indicator><consider_for_obligation>Y</consider_for_obligation><duplicate_flag>N</duplicate_flag></ExternalBureauIndividualProducts><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><external_bureau_individual_products_id>518044111</external_bureau_individual_products_id><contract_type>01</contract_type><provider_no>B04</provider_no><phase>C</phase><role_of_customer>A</role_of_customer><start_date>2019-05-26</start_date><close_date>2020-04-29</close_date><outstanding_balance>0</outstanding_balance><payments_amount>0</payments_amount><worst_status>U</worst_status><worst_status_date>2020-04-30</worst_status_date><credit_limit>20000</credit_limit><overdue_amount>0</overdue_amount><no_of_days_payment_delay>0</no_of_days_payment_delay><mob>13.00</mob><last_repayment_date>2020-04-01</last_repayment_date><currently_current>Y</currently_current><dpd_30_last_6_mon>0</dpd_30_last_6_mon><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><dpd_5_in_last_12_mon>0</dpd_5_in_last_12_mon><no_months_aecb_history>12</no_months_aecb_history><delinquent_in_last_3months>0</delinquent_in_last_3months><cac_indicator>N</cac_indicator><company_flag>N</company_flag><cac_bank_name>ADCB</cac_bank_name><take_over_indicator>N</take_over_indicator><consider_for_obligation>N</consider_for_obligation><duplicate_flag>N</duplicate_flag></ExternalBureauIndividualProducts><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><external_bureau_individual_products_id>C17675417</external_bureau_individual_products_id><contract_type>01</contract_type><provider_no>B05</provider_no><phase>C</phase><role_of_customer>A</role_of_customer><start_date>2019-04-16</start_date><close_date>2020-03-10</close_date><outstanding_balance>0</outstanding_balance><payments_amount>0</payments_amount><worst_status>U</worst_status><worst_status_date>2020-03-31</worst_status_date><credit_limit>13000</credit_limit><overdue_amount>0</overdue_amount><no_of_days_payment_delay>0</no_of_days_payment_delay><mob>15.00</mob><last_repayment_date>2020-03-01</last_repayment_date><currently_current>Y</currently_current><dpd_30_last_6_mon>0</dpd_30_last_6_mon><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><dpd_5_in_last_12_mon>0</dpd_5_in_last_12_mon><no_months_aecb_history>12</no_months_aecb_history><delinquent_in_last_3months>0</delinquent_in_last_3months><cac_indicator>N</cac_indicator><company_flag>N</company_flag><cac_bank_name>ADCB</cac_bank_name><take_over_indicator>N</take_over_indicator><consider_for_obligation>N</consider_for_obligation><duplicate_flag>N</duplicate_flag></ExternalBureauIndividualProducts><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><external_bureau_individual_products_id>D17805272</external_bureau_individual_products_id><contract_type>01</contract_type><provider_no>B06</provider_no><phase>A</phase><role_of_customer>A</role_of_customer><start_date>2019-03-31</start_date><outstanding_balance>267</outstanding_balance><payments_amount>0</payments_amount><worst_status>U</worst_status><worst_status_date>2020-06-30</worst_status_date><credit_limit>10000</credit_limit><overdue_amount>0</overdue_amount><no_of_days_payment_delay>0</no_of_days_payment_delay><mob>15.00</mob><last_repayment_date>2020-06-01</last_repayment_date><currently_current>Y</currently_current><current_utilization>2.67</current_utilization><dpd_30_last_6_mon>0</dpd_30_last_6_mon><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><dpd_5_in_last_12_mon>0</dpd_5_in_last_12_mon><no_months_aecb_history>15</no_months_aecb_history><delinquent_in_last_3months>0</delinquent_in_last_3months><cac_indicator>N</cac_indicator><company_flag>N</company_flag><cac_bank_name>ADCB</cac_bank_name><take_over_indicator>N</take_over_indicator><consider_for_obligation>Y</consider_for_obligation><duplicate_flag>N</duplicate_flag></ExternalBureauIndividualProducts><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><external_bureau_individual_products_id>H19244936</external_bureau_individual_products_id><contract_type>44</contract_type><provider_no>B02</provider_no><phase>C</phase><role_of_customer>A</role_of_customer><start_date>2019-11-12</start_date><close_date>2020-02-26</close_date><outstanding_balance>0</outstanding_balance><total_amount>150000</total_amount><payments_amount>1</payments_amount><total_no_of_instalments>18</total_no_of_instalments><no_of_remaining_instalments>0</no_of_remaining_instalments><worst_status>U</worst_status><worst_status_date>2020-02-29</worst_status_date><overdue_amount>0</overdue_amount><no_of_days_payment_delay>0</no_of_days_payment_delay><mob>8.00</mob><last_repayment_date>2020-02-01</last_repayment_date><currently_current>Y</currently_current><dpd_30_last_6_mon>0</dpd_30_last_6_mon><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><dpd_5_in_last_12_mon>0</dpd_5_in_last_12_mon><no_months_aecb_history>0</no_months_aecb_history><delinquent_in_last_3months>0</delinquent_in_last_3months><company_flag>N</company_flag><cac_bank_name>ADCB</cac_bank_name><take_over_indicator>N</take_over_indicator><consider_for_obligation>N</consider_for_obligation><duplicate_flag>N</duplicate_flag></ExternalBureauIndividualProducts><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><external_bureau_individual_products_id>H19764896</external_bureau_individual_products_id><contract_type>01</contract_type><provider_no>B07</provider_no><phase>A</phase><role_of_customer>A</role_of_customer><start_date>2020-01-02</start_date><outstanding_balance>0</outstanding_balance><payments_amount>0</payments_amount><worst_status>U</worst_status><worst_status_date>2020-07-31</worst_status_date><credit_limit>42500</credit_limit><overdue_amount>0</overdue_amount><no_of_days_payment_delay>0</no_of_days_payment_delay><mob>6.00</mob><last_repayment_date>2020-07-01</last_repayment_date><currently_current>Y</currently_current><current_utilization>0</current_utilization><dpd_30_last_6_mon>0</dpd_30_last_6_mon><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><dpd_5_in_last_12_mon>0</dpd_5_in_last_12_mon><no_months_aecb_history>7</no_months_aecb_history><delinquent_in_last_3months>0</delinquent_in_last_3months><cac_indicator>N</cac_indicator><company_flag>N</company_flag><cac_bank_name>ADCB</cac_bank_name><take_over_indicator>N</take_over_indicator><consider_for_obligation>Y</consider_for_obligation><duplicate_flag>N</duplicate_flag></ExternalBureauIndividualProducts><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><external_bureau_individual_products_id>H20307776</external_bureau_individual_products_id><contract_type>01</contract_type><provider_no>B03</provider_no><phase>A</phase><role_of_customer>A</role_of_customer><start_date>2020-01-09</start_date><outstanding_balance>0</outstanding_balance><payments_amount>0</payments_amount><worst_status>U</worst_status><worst_status_date>2020-06-30</worst_status_date><credit_limit>80000</credit_limit><overdue_amount>0</overdue_amount><no_of_days_payment_delay>0</no_of_days_payment_delay><mob>6.00</mob><last_repayment_date>2020-06-01</last_repayment_date><currently_current>Y</currently_current><current_utilization>0</current_utilization><dpd_30_last_6_mon>0</dpd_30_last_6_mon><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><dpd_5_in_last_12_mon>0</dpd_5_in_last_12_mon><no_months_aecb_history>6</no_months_aecb_history><delinquent_in_last_3months>0</delinquent_in_last_3months><cac_indicator>N</cac_indicator><company_flag>N</company_flag><cac_bank_name>ADCB</cac_bank_name><take_over_indicator>N</take_over_indicator><consider_for_obligation>Y</consider_for_obligation><duplicate_flag>N</duplicate_flag></ExternalBureauIndividualProducts><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><external_bureau_individual_products_id>J18046204</external_bureau_individual_products_id><contract_type>01</contract_type><provider_no>B04</provider_no><phase>C</phase><role_of_customer>A</role_of_customer><start_date>2019-05-26</start_date><close_date>2020-04-29</close_date><outstanding_balance>0</outstanding_balance><payments_amount>0</payments_amount><worst_status>U</worst_status><worst_status_date>2020-04-30</worst_status_date><credit_limit>40000</credit_limit><overdue_amount>0</overdue_amount><no_of_days_payment_delay>0</no_of_days_payment_delay><mob>13.00</mob><last_repayment_date>2020-04-01</last_repayment_date><currently_current>Y</currently_current><dpd_30_last_6_mon>0</dpd_30_last_6_mon><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><dpd_5_in_last_12_mon>0</dpd_5_in_last_12_mon><no_months_aecb_history>12</no_months_aecb_history><delinquent_in_last_3months>0</delinquent_in_last_3months><cac_indicator>N</cac_indicator><company_flag>N</company_flag><cac_bank_name>ADCB</cac_bank_name><take_over_indicator>N</take_over_indicator><consider_for_obligation>N</consider_for_obligation><duplicate_flag>N</duplicate_flag></ExternalBureauIndividualProducts><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><external_bureau_individual_products_id>M17403589</external_bureau_individual_products_id><contract_type>01</contract_type><provider_no>B02</provider_no><phase>A</phase><role_of_customer>A</role_of_customer><start_date>2019-01-10</start_date><close_date>2024-01-31</close_date><outstanding_balance>30112</outstanding_balance><payments_amount>0</payments_amount><worst_status>U</worst_status><worst_status_date>2020-06-30</worst_status_date><credit_limit>100000</credit_limit><overdue_amount>0</overdue_amount><no_of_days_payment_delay>0</no_of_days_payment_delay><mob>18.00</mob><last_repayment_date>2020-06-01</last_repayment_date><currently_current>Y</currently_current><current_utilization>30.11</current_utilization><dpd_30_last_6_mon>0</dpd_30_last_6_mon><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><dpd_5_in_last_12_mon>0</dpd_5_in_last_12_mon><no_months_aecb_history>17</no_months_aecb_history><delinquent_in_last_3months>0</delinquent_in_last_3months><cac_indicator>Y</cac_indicator><qc_emi>417</qc_emi><qc_amount>5000</qc_amount><company_flag>N</company_flag><cac_bank_name>ADCB</cac_bank_name><take_over_indicator>N</take_over_indicator><consider_for_obligation>Y</consider_for_obligation><duplicate_flag>N</duplicate_flag><avg_utilization>56</avg_utilization></ExternalBureauIndividualProducts><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><external_bureau_individual_products_id>N21004298</external_bureau_individual_products_id><contract_type>44</contract_type><provider_no>B02</provider_no><phase>A</phase><role_of_customer>A</role_of_customer><start_date>2020-02-26</start_date><close_date>2024-03-05</close_date><outstanding_balance>463738</outstanding_balance><total_amount>500000</total_amount><payments_amount>11755</payments_amount><total_no_of_instalments>48</total_no_of_instalments><no_of_remaining_instalments>44</no_of_remaining_instalments><worst_status>U</worst_status><worst_status_date>2020-07-31</worst_status_date><overdue_amount>0</overdue_amount><no_of_days_payment_delay>0</no_of_days_payment_delay><mob>4.00</mob><last_repayment_date>2020-07-01</last_repayment_date><currently_current>Y</currently_current><current_utilization>0</current_utilization><dpd_30_last_6_mon>0</dpd_30_last_6_mon><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><dpd_5_in_last_12_mon>0</dpd_5_in_last_12_mon><no_months_aecb_history>6</no_months_aecb_history><delinquent_in_last_3months>0</delinquent_in_last_3months><company_flag>N</company_flag><cac_bank_name>ADCB</cac_bank_name><take_over_indicator>N</take_over_indicator><consider_for_obligation>Y</consider_for_obligation><duplicate_flag>N</duplicate_flag></ExternalBureauIndividualProducts><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><external_bureau_individual_products_id>O20739445</external_bureau_individual_products_id><contract_type>85</contract_type><provider_no>T10</provider_no><phase>A</phase><role_of_customer>A</role_of_customer><start_date>2019-01-27</start_date><worst_status>U</worst_status><worst_status_date>2020-06-30</worst_status_date><overdue_amount>0</overdue_amount><no_of_days_payment_delay>0</no_of_days_payment_delay><mob>17.00</mob><currently_current>N</currently_current><current_utilization>0</current_utilization><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><dpd_5_in_last_12_mon>0</dpd_5_in_last_12_mon><no_months_aecb_history>8</no_months_aecb_history><delinquent_in_last_3months>0</delinquent_in_last_3months><company_flag>N</company_flag><cac_bank_name>ADCB</cac_bank_name><consider_for_obligation>N</consider_for_obligation><duplicate_flag>N</duplicate_flag></ExternalBureauIndividualProducts><ExternalBureauIndividualProducts><applicant_id>2856089</applicant_id><contract_type>01</contract_type><phase>A</phase><role_of_customer>A</role_of_customer><start_date>2020-07-28</start_date><close_date>2024-07-28</close_date><credit_limit>5000</credit_limit><currently_current>N</currently_current><dpd_30_last_6_mon>0</dpd_30_last_6_mon><dpd_60p_in_last_12_mon>0</dpd_60p_in_last_12_mon><delinquent_in_last_3months>0</delinquent_in_last_3months><cac_indicator>N</cac_indicator><cac_bank_name>ADCB</cac_bank_name><take_over_indicator>N</take_over_indicator><company_flag>N</company_flag><consider_for_obligation>Y</consider_for_obligation><duplicate_flag>N</duplicate_flag></ExternalBureauIndividualProducts><ExternalBureauPipelineProducts><applicant_ID>2856089</applicant_ID><external_bureau_pipeline_products_id>419680113</external_bureau_pipeline_products_id><ppl_provider_no>B03</ppl_provider_no><ppl_type_of_contract>01</ppl_type_of_contract><ppl_type_of_product>Requested</ppl_type_of_product><ppl_phase>PIPELINE</ppl_phase><ppl_role>A</ppl_role><ppl_date_of_last_update>2020-01-02</ppl_date_of_last_update><ppl_no_of_instalments>0</ppl_no_of_instalments><ppl_credit_limit>80000</ppl_credit_limit><ppl_no_of_days_in_pipeline>198</ppl_no_of_days_in_pipeline><company_flag>N</company_flag><ppl_consider_for_obligation>Y</ppl_consider_for_obligation><ppl_duplicate_flag>N</ppl_duplicate_flag></ExternalBureauPipelineProducts><ExternalBureauPipelineProducts><applicant_ID>2856089</applicant_ID><external_bureau_pipeline_products_id>518343231</external_bureau_pipeline_products_id><ppl_provider_no>B09</ppl_provider_no><ppl_type_of_contract>01</ppl_type_of_contract><ppl_type_of_product>Disbursed</ppl_type_of_product><ppl_phase>PIPELINE</ppl_phase><ppl_role>A</ppl_role><ppl_date_of_last_update>2019-09-01</ppl_date_of_last_update><ppl_no_of_instalments>0</ppl_no_of_instalments><ppl_credit_limit>5000</ppl_credit_limit><ppl_no_of_days_in_pipeline>321</ppl_no_of_days_in_pipeline><company_flag>N</company_flag><ppl_consider_for_obligation>Y</ppl_consider_for_obligation><ppl_duplicate_flag>N</ppl_duplicate_flag></ExternalBureauPipelineProducts><ExternalBureauPipelineProducts><applicant_ID>2856089</applicant_ID><external_bureau_pipeline_products_id>917512941</external_bureau_pipeline_products_id><ppl_provider_no>B06</ppl_provider_no><ppl_type_of_contract>15</ppl_type_of_contract><ppl_type_of_product>Requested</ppl_type_of_product><ppl_phase>PIPELINE</ppl_phase><ppl_role>A</ppl_role><ppl_date_of_last_update>2019-03-26</ppl_date_of_last_update><ppl_total_amount>20000</ppl_total_amount><ppl_no_of_instalments>48</ppl_no_of_instalments><ppl_no_of_days_in_pipeline>480</ppl_no_of_days_in_pipeline><company_flag>N</company_flag><ppl_consider_for_obligation>Y</ppl_consider_for_obligation><ppl_duplicate_flag>N</ppl_duplicate_flag></ExternalBureauPipelineProducts><ExternalBureauPipelineProducts><applicant_ID>2856089</applicant_ID><external_bureau_pipeline_products_id>F19116874</external_bureau_pipeline_products_id><ppl_provider_no>B02</ppl_provider_no><ppl_type_of_contract>21</ppl_type_of_contract><ppl_type_of_product>Requested</ppl_type_of_product><ppl_phase>PIPELINE</ppl_phase><ppl_role>A</ppl_role><ppl_date_of_last_update>2019-10-31</ppl_date_of_last_update><ppl_total_amount>48000</ppl_total_amount><ppl_no_of_instalments>48</ppl_no_of_instalments><ppl_no_of_days_in_pipeline>261</ppl_no_of_days_in_pipeline><company_flag>N</company_flag><ppl_consider_for_obligation>Y</ppl_consider_for_obligation><ppl_duplicate_flag>N</ppl_duplicate_flag></ExternalBureauPipelineProducts><ExternalBureauPipelineProducts><applicant_ID>2856089</applicant_ID><external_bureau_pipeline_products_id>H19988666</external_bureau_pipeline_products_id><ppl_provider_no>B11</ppl_provider_no><ppl_type_of_contract>00</ppl_type_of_contract><ppl_type_of_product>Requested</ppl_type_of_product><ppl_phase>PIPELINE</ppl_phase><ppl_role>A</ppl_role><ppl_date_of_last_update>2020-02-10</ppl_date_of_last_update><ppl_no_of_instalments>0</ppl_no_of_instalments><ppl_credit_limit>50000</ppl_credit_limit><ppl_no_of_days_in_pipeline>159</ppl_no_of_days_in_pipeline><company_flag>N</company_flag><ppl_consider_for_obligation>N</ppl_consider_for_obligation><ppl_duplicate_flag>N</ppl_duplicate_flag></ExternalBureauPipelineProducts><ExternalBureauPipelineProducts><applicant_ID>2856089</applicant_ID><external_bureau_pipeline_products_id>K17900333</external_bureau_pipeline_products_id><ppl_provider_no>B04</ppl_provider_no><ppl_type_of_contract>01</ppl_type_of_contract><ppl_type_of_product>Disbursed</ppl_type_of_product><ppl_phase>PIPELINE</ppl_phase><ppl_role>A</ppl_role><ppl_date_of_last_update>2020-04-01</ppl_date_of_last_update><ppl_no_of_instalments>0</ppl_no_of_instalments><ppl_credit_limit>5000</ppl_credit_limit><ppl_no_of_days_in_pipeline>108</ppl_no_of_days_in_pipeline><company_flag>N</company_flag><ppl_consider_for_obligation>N</ppl_consider_for_obligation><ppl_duplicate_flag>N</ppl_duplicate_flag></ExternalBureauPipelineProducts><ExternalBureauPipelineProducts><applicant_ID>2856089</applicant_ID><external_bureau_pipeline_products_id>L17549279</external_bureau_pipeline_products_id><ppl_provider_no>B05</ppl_provider_no><ppl_type_of_contract>01</ppl_type_of_contract><ppl_type_of_product>Requested</ppl_type_of_product><ppl_phase>PIPELINE</ppl_phase><ppl_role>A</ppl_role><ppl_date_of_last_update>2019-04-01</ppl_date_of_last_update><ppl_no_of_instalments>0</ppl_no_of_instalments><ppl_credit_limit>3000</ppl_credit_limit><ppl_no_of_days_in_pipeline>474</ppl_no_of_days_in_pipeline><company_flag>N</company_flag><ppl_consider_for_obligation>Y</ppl_consider_for_obligation><ppl_duplicate_flag>N</ppl_duplicate_flag></ExternalBureauPipelineProducts><ExternalBureauPipelineProducts><applicant_ID>2856089</applicant_ID><external_bureau_pipeline_products_id>N20592898</external_bureau_pipeline_products_id><ppl_provider_no>B02</ppl_provider_no><ppl_type_of_contract>44</ppl_type_of_contract><ppl_type_of_product>Disbursed</ppl_type_of_product><ppl_phase>PIPELINE</ppl_phase><ppl_role>A</ppl_role><ppl_date_of_last_update>2020-03-03</ppl_date_of_last_update><ppl_total_amount>500000</ppl_total_amount><ppl_no_of_instalments>48</ppl_no_of_instalments><ppl_no_of_days_in_pipeline>137</ppl_no_of_days_in_pipeline><company_flag>N</company_flag><ppl_consider_for_obligation>N</ppl_consider_for_obligation><ppl_duplicate_flag>N</ppl_duplicate_flag></ExternalBureauPipelineProducts><ExternalBureauPipelineProducts><applicant_ID>2856089</applicant_ID><external_bureau_pipeline_products_id>Q17536981</external_bureau_pipeline_products_id><ppl_provider_no>B04</ppl_provider_no><ppl_type_of_contract>01</ppl_type_of_contract><ppl_type_of_product>Requested</ppl_type_of_product><ppl_phase>PIPELINE</ppl_phase><ppl_role>A</ppl_role><ppl_date_of_last_update>2019-03-30</ppl_date_of_last_update><ppl_no_of_instalments>0</ppl_no_of_instalments><ppl_credit_limit>5000</ppl_credit_limit><ppl_no_of_days_in_pipeline>476</ppl_no_of_days_in_pipeline><company_flag>N</company_flag><ppl_consider_for_obligation>Y</ppl_consider_for_obligation><ppl_duplicate_flag>N</ppl_duplicate_flag></ExternalBureauPipelineProducts><ExternalBureauPipelineProducts><applicant_ID>2856089</applicant_ID><external_bureau_pipeline_products_id>R19287011</external_bureau_pipeline_products_id><ppl_provider_no>B07</ppl_provider_no><ppl_type_of_contract>01</ppl_type_of_contract><ppl_type_of_product>Requested</ppl_type_of_product><ppl_phase>PIPELINE</ppl_phase><ppl_role>A</ppl_role><ppl_date_of_last_update>2019-11-21</ppl_date_of_last_update><ppl_no_of_instalments>0</ppl_no_of_instalments><ppl_credit_limit>0</ppl_credit_limit><ppl_no_of_days_in_pipeline>240</ppl_no_of_days_in_pipeline><company_flag>N</company_flag><ppl_consider_for_obligation>Y</ppl_consider_for_obligation><ppl_duplicate_flag>N</ppl_duplicate_flag></ExternalBureauPipelineProducts></ExternalBureauData></ProcessManagerRequest>]]></applicationXML></CallProcessManager></soap:Body></soap:Envelope>";
						final_xml = final_xml.append(dec_check);
					}
	...
	//FormReference formObject = FormContext.getCurrentInstance().getFormReference();
		...
		if(("CUSTOMER_DETAILS").equalsIgnoreCase(callName)){
			...
			response="<soap:Envelope><soap:Header><ServiceId>CallProcessManager</ServiceId><ServiceType>ProductEligibility</ServiceType><ServiceProviderId>DECTECH</ServiceProviderId><ServiceChannelId>CAS</ServiceChannelId><RequestID>CAS164864148176016</RequestID><TimeStampyyyymmddhhmmsss>2022-03-30T15:58:06.540</TimeStampyyyymmddhhmmsss><RequestLifeCycleStage>CallProcessManagerResponse</RequestLifeCycleStage><MessageStatus>Success</MessageStatus></soap:Header><soap:Body><CallProcessManagerResponse><CallProcessManagerResult><ProcessManagerResponse><Application><Channel>CC</Channel><CallType>PM</CallType><ApplicationNumber>CAS-0000071324-PROCESS</ApplicationNumber><ReturnDateTime>20220330155805</ReturnDateTime><SystemErrorCode></SystemErrorCode><SystemErrorMessage></SystemErrorMessage><ReturnError/></Application><Instinct_Actions><Instinct_Action_Output_XML /></Instinct_Actions><PM_Results><Random_Number>491</Random_Number><DBR>0.00</DBR><Decision_Results><PM_Decision_Results_Data><PM_Decision_Results><AppKey>CAS-0000071324-PROCESSCC</AppKey><Decision_Objective>1</Decision_Objective><Decision_Sequence_Number>1</Decision_Sequence_Number><Last_Update_Date>2022-03-30T15:58:04.047+04:00</Last_Update_Date><Default_Decision>A</Default_Decision><Default_Reason>A999 - System Approve</Default_Reason><Default_Document>0</Default_Document><System_Decision>A</System_Decision><System_Document>0</System_Document><Decision_Node_Id>2.1</Decision_Node_Id><Decision_Test_Group>0</Decision_Test_Group></PM_Decision_Results></PM_Decision_Results_Data><PM_Reason_Codes_Data><PM_Reason_Codes><Decision_Objective>1</Decision_Objective><Decision_Sequence_Number>1</Decision_Sequence_Number><Sequence_Number>1</Sequence_Number><Reason_Decision>A</Reason_Decision><Reason_Code>A999</Reason_Code><Reason_Description>System Approve</Reason_Description><Criteria_Name /><Letter_Code /><Document /><Letter_Reason /></PM_Reason_Codes></PM_Reason_Codes_Data></Decision_Results><Strategy_Results><PM_Strategy_MaxLendingAmount_Data><PM_Strategy_MaxLendingAmount_Results><Policy_Number>1</Policy_Number><Adjustment_Number>0</Adjustment_Number><Max_Lending_Amount>27800.00</Max_Lending_Amount><Last_Update_Date>2022-03-30T15:58:04.26+04:00</Last_Update_Date><Entry_Name>Output TAI Multiplier 3 Max 30000</Entry_Name><Use_Requested_Limit_Flag>false</Use_Requested_Limit_Flag><Existing_Limit_Increase_Flag>false</Existing_Limit_Increase_Flag><Limit_Increase_Percent>0.00</Limit_Increase_Percent><Use_Characteristic_As_Limit_Flag>true</Use_Characteristic_As_Limit_Flag><Limit_Table_Id>1</Limit_Table_Id><Limit_Field_Number>22</Limit_Field_Number><Use_Characteristic_As_Limit_Multiplier>3.000</Use_Characteristic_As_Limit_Multiplier><Fixed_Amount_Flag>false</Fixed_Amount_Flag><Fixed_Amount>0</Fixed_Amount><Base_Percentage_Increase_Flag>false</Base_Percentage_Increase_Flag><Base_Percentage_Increase_Percent>0.00</Base_Percentage_Increase_Percent><Limit_Minimum>0</Limit_Minimum><Limit_Maximum>30000</Limit_Maximum><Limit_Rounding_Factor1>100</Limit_Rounding_Factor1><Limit_Rounding_Factor2>100</Limit_Rounding_Factor2><Limit_Rounding_Factor3>100</Limit_Rounding_Factor3><Limit_Rounding_Factor4>100</Limit_Rounding_Factor4><Limit_Rounding_Cutoff1>100000</Limit_Rounding_Cutoff1><Limit_Rounding_Cutoff2>200000</Limit_Rounding_Cutoff2><Limit_Rounding_Cutoff3>300000</Limit_Rounding_Cutoff3><Limit_Reason_Code /><Max_Limit_Table_Id>0</Max_Limit_Table_Id><Max_Limit_Field_Number>0</Max_Limit_Field_Number><Max_Limit_Multiplier>0.00</Max_Limit_Multiplier><Use_Round_Up_Factor1_Flag>false</Use_Round_Up_Factor1_Flag><Use_Round_Up_Factor2_Flag>false</Use_Round_Up_Factor2_Flag><Use_Round_Up_Factor3_Flag>false</Use_Round_Up_Factor3_Flag><Use_Round_Up_Factor4_Flag>false</Use_Round_Up_Factor4_Flag><Strategy_Node_Id>1.2.2.4.2.2.2.4</Strategy_Node_Id><Strategy_Test_Group>0</Strategy_Test_Group><Tree_Error_Field_Label /><Tree_Error_Field_Value /></PM_Strategy_MaxLendingAmount_Results></PM_Strategy_MaxLendingAmount_Data></Strategy_Results><Strategy_Results><PM_Strategy_PricingTerm_Data><PM_Strategy_PricingTerm_Results><Last_Update_Date>2022-03-30T15:58:04.303+04:00</Last_Update_Date><Entry_Name>Zero</Entry_Name><Interest_Rate>0.00</Interest_Rate><Max_Loan_Term>0</Max_Loan_Term><Strategy_Node_Id>2</Strategy_Node_Id><Strategy_Test_Group>0</Strategy_Test_Group></PM_Strategy_PricingTerm_Results></PM_Strategy_PricingTerm_Data></Strategy_Results><Scoring_Results><PM_Scoring_Results_Data><PM_Scoring_Results><Scoring_Sequence_Number>1</Scoring_Sequence_Number><Scoring_Objective>2</Scoring_Objective><Last_Update_Date>2022-03-30T15:58:04.333+04:00</Last_Update_Date><Score>0.000000</Score><Score_Node_Id>1</Score_Node_Id><Scorecard_Id>Null Scorecard</Scorecard_Id><Grade>0</Grade><Score_Test_Group>0</Score_Test_Group></PM_Scoring_Results></PM_Scoring_Results_Data></Scoring_Results><Scoring_Results><PM_Scoring_Results_Data><PM_Scoring_Results><Scoring_Sequence_Number>1</Scoring_Sequence_Number><Scoring_Objective>1</Scoring_Objective><Last_Update_Date>2022-03-30T15:58:04.89+04:00</Last_Update_Date><Score>587.000000</Score><Score_Node_Id>2.1.1</Score_Node_Id><Scorecard_Id>Scorecard Credit History GE 12 Months</Scorecard_Id><Grade>0</Grade><Score_Test_Group>0</Score_Test_Group></PM_Scoring_Results></PM_Scoring_Results_Data></Scoring_Results><Decision_Results><PM_Decision_Results_Data><PM_Decision_Results><AppKey>CAS-0000071324-PROCESSCC</AppKey><Decision_Objective>2</Decision_Objective><Decision_Sequence_Number>1</Decision_Sequence_Number><Last_Update_Date>2022-03-30T15:58:05.523+04:00</Last_Update_Date><Default_Decision>A</Default_Decision><Default_Reason>A999 - System Approve</Default_Reason><Default_Document>0</Default_Document><System_Decision>A</System_Decision><System_Document>0</System_Document><Decision_Node_Id>2.1</Decision_Node_Id><Decision_Test_Group>0</Decision_Test_Group></PM_Decision_Results></PM_Decision_Results_Data><PM_Reason_Codes_Data><PM_Reason_Codes><Decision_Objective>2</Decision_Objective><Decision_Sequence_Number>1</Decision_Sequence_Number><Sequence_Number>1</Sequence_Number><Reason_Decision>A</Reason_Decision><Reason_Code>A999</Reason_Code><Reason_Description>System Approve</Reason_Description><Criteria_Name /><Letter_Code /><Document /><Letter_Reason /></PM_Reason_Codes></PM_Reason_Codes_Data></Decision_Results><Strategy_Results><PM_Strategy_Verification_Data><PM_Strategy_Verification_Results><Last_Update_Date>2022-03-30T15:58:05.6+04:00</Last_Update_Date><Entry_Name>Eligible Cards Expat_CB</Entry_Name><Number_Of_Visits>0</Number_Of_Visits><Visits><Code>1</Code><Type_Of_Visit>KALYAN-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>108</Code><Type_Of_Visit>EKWEC-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>28</Code><Type_Of_Visit>MY RAK CARD-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>38</Code><Type_Of_Visit>REDCARD-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>48</Code><Type_Of_Visit>TITANIUM-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>53</Code><Type_Of_Visit>VCLASSIC-EXPATRIATE</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>57</Code><Type_Of_Visit>VGOLD-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>6</Code><Type_Of_Visit>MPL-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>62</Code><Type_Of_Visit>WORLD-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>69</Code><Type_Of_Visit>MCBAA-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>83</Code><Type_Of_Visit>MCBWE-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Number_Of_Calls>0</Number_Of_Calls><Calls><Code></Code><Type_Of_Call></Type_Of_Call><Mandatory_Flag></Mandatory_Flag></Calls><Strategy_Node_Id>2.1.2.2.2.4.2.1.1</Strategy_Node_Id><Strategy_Test_Group>0</Strategy_Test_Group></PM_Strategy_Verification_Results></PM_Strategy_Verification_Data></Strategy_Results></PM_Results><PM_Outputs><Application><Is_Banking_Customer>N</Is_Banking_Customer><Is_New_Score_Card>YES</Is_New_Score_Card><Is_Refer_Designation>N</Is_Refer_Designation><Output_Accommodation_Allowance>0.00</Output_Accommodation_Allowance><Output_Additional_Amount>27800.00</Output_Additional_Amount><Output_Affordable_EMI>4545.50</Output_Affordable_EMI><Output_AVG_EMI_Client>0.00</Output_AVG_EMI_Client><Output_AVG_EMI_Policy>0.00</Output_AVG_EMI_Policy><Output_BBG_Existing_DBR>0.00</Output_BBG_Existing_DBR><Output_BBG_Final_DBR>0.00</Output_BBG_Final_DBR><Output_CFF_Client>0.00</Output_CFF_Client><Output_CFF_Policy>0.00</Output_CFF_Policy><Output_CPV_Waiver>N</Output_CPV_Waiver><Output_Decision>A</Output_Decision><Output_Delegation_Authority>CA</Output_Delegation_Authority><Output_Eligible_Amount>27800.00</Output_Eligible_Amount><Output_Eligible_Amount_Path>Max Lending Amount Sub Process Type Segmentation CC [SAL]\\NOT CC Minimum AECB Score requirement not met\\NOT Salaried AECB No Hit Flag\\Max Lending Amount Target Segment Code [Others]\\NOT UAE National Test program\\NOT Employee type SP or not confirmed in job with LOS LT 6\\No Months AECB History [&amp;gt;= 12]\\Output TAI Segmentation [7500 - 9999.99]</Output_Eligible_Amount_Path><Output_Eligible_Cards>[{\"Card_Product\":\"TITANIUM-EXPAT\",\"Credit_Limit\":27800.00,\"Flag\":\"N\"},{\"Card_Product\":\"KALYAN-EXPAT\",\"Credit_Limit\":27800.00,\"Flag\":\"N\"},{\"Card_Product\":\"EKWEC-EXPAT\",\"Credit_Limit\":27800.00,\"Flag\":\"N\"},{\"Card_Product\":\"MY RAK CARD-EXPAT\",\"Credit_Limit\":27800.00,\"Flag\":\"N\"},{\"Card_Product\":\"REDCARD-EXPAT\",\"Credit_Limit\":27800.00,\"Flag\":\"N\"},{\"Card_Product\":\"VCLASSIC-EXPATRIATE\",\"Credit_Limit\":27800.00,\"Flag\":\"N\"},{\"Card_Product\":\"VGOLD-EXPAT\",\"Credit_Limit\":27800.00,\"Flag\":\"N\"},{\"Card_Product\":\"MPL-EXPAT\",\"Credit_Limit\":27800.00,\"Flag\":\"N\"},{\"Card_Product\":\"WORLD-EXPAT\",\"Credit_Limit\":27800.00,\"Flag\":\"N\"},{\"Card_Product\":\"MCBAA-EXPAT\",\"Credit_Limit\":27800.00,\"Flag\":\"N\"},{\"Card_Product\":\"MCBWE-EXPAT\",\"Credit_Limit\":27800.00,\"Flag\":\"N\"}]</Output_Eligible_Cards><Output_Eligible_Multiple>0.000</Output_Eligible_Multiple><Output_Existing_DBR>1.08</Output_Existing_DBR><Output_Final_Amount>27800.00</Output_Final_Amount><Output_Final_DBR>10.05</Output_Final_DBR><Output_Interest_Rate>0.00</Output_Interest_Rate><Output_Loan_Client>0.00</Output_Loan_Client><Output_Loan_Eligibility>0.00</Output_Loan_Eligibility><Output_Loan_Policy>0.00</Output_Loan_Policy><Output_Net_Salary_DBR>0.00</Output_Net_Salary_DBR><Output_NTC_Amount>0.00</Output_NTC_Amount><Output_Num_Eligible_Cards>9</Output_Num_Eligible_Cards><Output_Salary_Multiples>2.99</Output_Salary_Multiples><Output_TAI>9291.00</Output_TAI></Application></PM_Outputs></ProcessManagerResponse></CallProcessManagerResult></CallProcessManagerResponse></soap:Body></soap:Envelope>";
...
/*commented by sagarika due to duplicacy
				...
				if (!("".equalsIgnoreCase(socketServerIP) && socketServerIP == null && socketServerPort==0)) {
					...
					if (num > 0) {
						...
						if(!"".equalsIgnoreCase(mqOutputResponse)){
							CreditCard.mLogger.info("Inside if loop --->"+mqOutputResponse);
							mqOutputResponse = getOutWtthMessageID(mqOutputResponse);
							CreditCard.mLogger.info("If loop after line 698"+mqOutputResponse);
						}
	...
	public String getOutWtthMessageID(String message_ID){
		...
		try{
			...
			try
			{
				...
				CreditCard.mLogger.info("Inside try loop "+Loop_wait_count);
			}
			catch(Exception ex)
			{
				Loop_wait_count=10;
				CreditCard.mLogger.info("Inside catch loop "+ Loop_wait_count);
			}
		
			for(int Loop_count=0;Loop_count<Loop_wait_count;Loop_count++){
				if(result.size()>0){
					outputxml = result.get(0).get(0);
					CreditCard.mLogger.info("inside if loop --->"+ outputxml);
					break; 
				}
				else{
					Thread.sleep(1000);
					result=formObject.getDataFromDataSource(str_query);
					CreditCard.mLogger.info("inside else loop --->"+ outputxml);
				}
			}
			
			if("".equalsIgnoreCase(outputxml)){
				outputxml="Error12345";
			}
		...
		try {
			for (int i = 0; i < OutputXML.size(); i++) {
				...
				if (cifId != null && !"".equalsIgnoreCase(cifId) && !"null".equalsIgnoreCase(cifId)) {
					...
					//below code added by nikhil 21-07
					add_xml_str = add_xml_str+ "<linked_liability>"+ (formObject.getNGValue("cmplx_Customer_CIFNo").equals(cifId)?"N":"Y") + "</linked_liability>";
					...
					else if ("Loans".equalsIgnoreCase(OutputXML.get(i).get(63)))
					{
						if (LoanType.equalsIgnoreCase("MURABAHA")){
							...
							//Deepak changes done for production issue of new SchemeCardProduct
							try{
								String SchemeCardProduct_Query = "select top 1 code from NG_MASTER_SchemeCardProduct where description like '%"+SchemeCardProduct+"%'";
								//CreditCard.mLogger.info("SchemeCardProduct_Query"+ SchemeCardProduct_Query);
								List<List<String>> SchemeCardProduct_XML = formObject.getNGDataFromDataCache(SchemeCardProduct_Query);
								//CreditCard.mLogger.info("SchemeCardProduct_Query"+ SchemeCardProduct_XML);
								if(!SchemeCardProduct_XML.isEmpty()){
									String SchemeCardProduct_DB = SchemeCardProduct_XML.get(0).get(0);
									add_xml_str = add_xml_str + "<contract_type>"+SchemeCardProduct_DB+"</contract_type>";
								}

							}
							catch(Exception e){
								CreditCard.mLogger.info("Exception occured in SchemeCardProduct_Query"+ e.getMessage());
							}
							...
							else if ((SchemeCardProduct.toUpperCase()).contains("AMAL RAK FINANCE")){
								add_xml_str = add_xml_str + "<contract_type>IRFL</contract_type>";
							}
							else if ((SchemeCardProduct.toUpperCase()).contains("PERSONAL RAK FINANCE")){
								add_xml_str = add_xml_str + "<contract_type>RFL</contract_type>";
							}*/
						}
		...
		try{
			...
			if(formObject.isVisible("CC_Loan_Frame3")){
				...
				if("true".equalsIgnoreCase(formObject.getNGValue(listViewname, chosenRow, 0))){
					...
					add_xml_str = add_xml_str + "<RVC><RVCPackage>"+formObject.getNGValue(listViewname, chosenRow, 2)+"</RVCPackage>";
					...
					add_xml_str = add_xml_str + "<RVCActivationDate>"+common.Convert_dateFormat(formObject.getNGValue(listViewname, chosenRow, 5), "dd/MM/yyyy","yyyy-MM-dd")+"</RVCActivationDate></RVC>";
				}
				}
			}
			return add_xml_str;
	...
	public String getSIDetails(){
		CreditCard.mLogger.info("RLOSCommon java file inside getSIDetails : ");
		FormReference formObject = FormContext.getCurrentInstance().getFormReference();
		String  add_xml_str ="";
	...
	public String getRelationshipDescription(String code){
		FormReference formObject = FormContext.getCurrentInstance().getFormReference();
		@SuppressWarnings("unused")
		String desc=code;
		String query="select Description from NG_MASTER_Relationship where code='"+code+"' and IsActive='Y'";
		List<List<String>> list = formObject.getDataFromDataSource(query);
		if(list.get(0).get(0)!=null){
			desc= list.get(0).get(0);
		}
		return desc;
	}
	public String getAccountInfo(){
		...
		if(emptype.equalsIgnoreCase("Self Employed")){						    
			acctNo = formObject.getNGValue("cmplx_IncomeDetails_Account_self_num");															
		}
		else{
			acctNo = formObject.getNGValue("cmplx_IncomeDetails_Account_num_sal");
		}
		...
		str_xml+="<AcctId>"+acctNo+"</AcctId>";
		str_xml+="<AcctType>"+acctType+"</AcctType>";
	...
	public String InternalBureauPipelineProducts() {
		...
		FormReference formObject = FormContext.getCurrentInstance().getFormReference();
		String sQuery = "SELECT cifid,LoanType,custroletype,lastupdatedate,totalamount,totalnoofinstalments,totalloanamount,agreementId,NoOfDaysInPipeline,case when Consider_For_Obligations is null or Consider_For_Obligations='True' then 'Y' else 'N' end as Consider_For_Obligations,NextInstallmentAmt,SchemeCardProd FROM ng_RLOS_CUSTEXPOSE_LoanDetails  with (nolock) where Wi_Name = '"
			+ formObject.getWFWorkitemName()
	...
	public String ExternalBureauData() 
	{
		...
		try {
			...
			if (OutputXML.size()==0) 
			{
				...
				CreditCard.mLogger.info( "aecb_score :"+aecb_score+" range :: "+range+" refNo:: "+refNo);
				...
				for (int i = 0; i < OutputXML.size(); i++) {
					...
					if (OutputXML.get(i).get(16) != null	&& !OutputXML.get(i).get(16).isEmpty()	&& !OutputXML.get(i).get(16).equals("")	&& !OutputXML.get(i).get(16).equalsIgnoreCase("null")) {
						EnquiryDate = OutputXML.get(i).get(16).toString();
					}
					
					// below code for changing date format 
					CreditCard.mLogger.info("EnquiryDate :" + EnquiryDate);
					
					Date parseDateCC = new SimpleDateFormat("dd-MM-yyyy").parse(EnquiryDate);
					CreditCard.mLogger.info("parseDateCC :" + parseDateCC);
					
					SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss");
					CreditCard.mLogger.info("formatter :" + formatter);
					
					String enquire_date_format_CC = formatter.format(parseDateCC);
					CreditCard.mLogger.info("enquire_date_format :" + enquire_date_format_CC);
					
					String Company_flag = "N";
					if(CifId.equals(formObject.getNGValue("cmplx_CompanyDetails_cmplx_CompanyGrid",1,3)))
					{
						Company_flag = "Y";
						String Ref_query = "select ReferenceNo,AECB_Score,Range from NG_RLOS_CUSTEXPOSE_Derived with(nolock) where Child_Wi ='"+Wi_Name+"' and Request_Type='ExternalExposure' and CifId='"+CifId+"'";
						//String add_xml_str = "";
						try {
					...
					add_xml_str = add_xml_str + "<aecb_score>"+aecb_score+"</aecb_score>";
					add_xml_str = add_xml_str + "<range>"+range+"</range>";
					CreditCard.mLogger.debug(" AECB_Enquiry_date : EnquiryDate "+EnquiryDate);
					
					
					add_xml_str = add_xml_str + "<Bureau_Enquiry_Date>"+enquire_date_format_CC+"</Bureau_Enquiry_Date>";
...
//OtherBankCAC
			...
			if(!(OutputXML.get(i).get(35) == null || OutputXML.get(i).get(35).equals("")) ){  // added by deepanshu
				MaximumOverDueAmount = OutputXML.get(i).get(35).toString();
			}
			
			if(!(OutputXML.get(i).get(36) == null || OutputXML.get(i).get(36).equals("")) ){  // added by deepanshu
				Pmtfreq = OutputXML.get(i).get(36).toString();
			}
			
			if(!(OutputXML.get(i).get(37) == null || OutputXML.get(i).get(37).equals("")) ){  // added by deepanshu
				MaxOverDueAmountDate = OutputXML.get(i).get(37).toString();
			}
			// changes by deepanshu
			
			CreditCard.mLogger.info("MaxOverdueAmountDate :" + MaxOverDueAmountDate);
			
			Date parseDate = new SimpleDateFormat("dd-MM-yyyy").parse(MaxOverDueAmountDate);
			CreditCard.mLogger.info("parseDate :" + parseDate);
			
			SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
			CreditCard.mLogger.info("formatter :" + formatter);
			
			String MaxOverdueAmountDateFormat = formatter.format(parseDate);
			CreditCard.mLogger.info("MaxOverdueAmountDateFormat :" + MaxOverdueAmountDateFormat);
			...
			add_xml_str = add_xml_str + "<maximum_overdue_amount>" + MaximumOverDueAmount + "</maximum_overdue_amount>";// added by deppanshu
			...
			add_xml_str = add_xml_str + "<qc_amount>" + QC_Amt + "</qc_amount><company_flag>"+Company_flag+"</company_flag><cac_bank_name>" + CAC_BANK_NAME+ "</cac_bank_name><take_over_indicator>" + TakeOverIndicator + "</take_over_indicator><consider_for_obligation>" + consider_for_obligation + "</consider_for_obligation><duplicate_flag>"+Duplicate_flag+"</duplicate_flag><avg_utilization>"+avg_utilization+"</avg_utilization><payment_frequency>"+Pmtfreq+"</payment_frequency><maximum_overdue_date>"+MaxOverdueAmountDateFormat+"</maximum_overdue_date></ExternalBureauIndividualProducts>";
	...
	Author                              : Sarthak             
	Description                         : Function for Card Details

	 ***********************************************************************************  */
	
	
	private Map<String, String> credit_Card_Custom(List<List<String>> DB_List,FormReference formObject,String callName,String operationName){
		...
		try {
			...
			for (List<String> mylist : DB_List) {
				CreditCard.mLogger.info("Credit Card Custom 1st for loop");
				// for(int i=0;i<col_n.length();i++)
				for (int i = 0; i < 8; i++) {
					// CreditCard.mLogger.info("rec: "+records.item(rec));
					CreditCard.mLogger.info("Credit Card Custom @nd for loop");
					CreditCard.mLogger.info(""+ "column length values"+ col_n);
					String[] col_name = col_n.split(",");
					recordFileMap.put(col_name[i], mylist.get(i));
					
					CreditCard.mLogger.info("Record FIle Map "+recordFileMap);
				}
				
				int_xml = GenDefault_Input_DB(int_xml,recordFileMap,formObject,callName);
				CreditCard.mLogger.info("Input XML Credit Card Custom "+int_xml);
			...
			CreditCard.mLogger.info("Exception occured in Card Details "+ e.getMessage());
		}
		return int_xml;	
	 ...
	 ***********************************************************************************  */
	private Map<String, String> Blacklist_Details_custom(List<List<String>> DB_List,FormReference formObject,String callName, String Operation_name) {
		...
		try{
			for (List<String> mylist : DB_List) {
				...
				if ("CIFID".equalsIgnoreCase(tag_name) && "Corporate".equals(Operation_name)) 
				{
					String Company_cif = formObject.getNGValue("cmplx_CompanyDetails_cmplx_CompanyGrid",1,3);
					String xml_str = int_xml.get(parent_tag);
					xml_str = xml_str + "<" + tag_name + ">" + Company_cif + "</" + tag_name + ">";
		...
		try{
			for (List<String> mylist : DB_List) {
				...
				if( "SUPPLEMENT".equalsIgnoreCase(CC_Comn.MultipleAppGridSelectedRow("MultipleApp_AppType"))){	
					...
					if("PersonDetails".equalsIgnoreCase(tag_name)){
					...
					else if("RelationshipDetails".equalsIgnoreCase(tag_name) && int_xml.containsKey(parent_tag)){
						...
						int count=formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid");
						//	CreditCard.mLogger.info("sagarika cal"+count);
						for(int i=0;i<count;i++)
						{
							//CreditCard.mLogger.info("sagarika cal");
							if(formObject.getNGValue("cmplx_DEC_MultipleApplicantsGrid",formObject.getSelectedIndex("cmplx_DEC_MultipleApplicantsGrid"),2).equalsIgnoreCase(formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,3)))
							{
								age=Float.parseFloat(common.getAge(formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,4)));
								CreditCard.mLogger.info("sagarika cal"+age);
							}
						}
						...
						if((age<21)){
							CreditCard.mLogger.info("sagarika age"+count);
							String xml_str = int_xml.get(parent_tag);
			...
			for (List<String> mylist : DB_List) {
				...
				{	
					 if ("PhnLocalCode".equalsIgnoreCase(tag_name)) {
						...
						else if(!"".equalsIgnoreCase(phn_no) && phn_no.startsWith("971")){
							phn_no = phn_no.substring(3);
							}
					...
					//Added by shivang for PCASP-2758,2112
					else if("EmployerCode".equals(tag_name)&& "CUSTOMER_UPDATE_REQ".equalsIgnoreCase(callName) && "Self Employed".equalsIgnoreCase(emptype)){					
						String xml_str = int_xml.get(parent_tag);
						xml_str = xml_str + "<" + tag_name + ">"+formObject.getNGValue("cmplx_CompanyDetails_cmplx_CompanyGrid",1,40)+ "</" + tag_name + ">";
						int_xml.put(parent_tag, xml_str);
					}
					else if("EmploymentType".equals(tag_name)&& "CUSTOMER_UPDATE_REQ".equalsIgnoreCase(callName) && "Self Employed".equalsIgnoreCase(emptype)){					
						String xml_str = int_xml.get(parent_tag);
						xml_str = xml_str + "<" + tag_name + ">"+"Self Employed"+ "</" + tag_name + ">";
						int_xml.put(parent_tag, xml_str);
					}
					else if("Desig".equals(tag_name)&& "CUSTOMER_UPDATE_REQ".equalsIgnoreCase(callName) && "Self Employed".equalsIgnoreCase(emptype)){					
						String xml_str = int_xml.get(parent_tag);
						xml_str = xml_str + "<" + tag_name + ">"+formObject.getNGValue("cmplx_Customer_Designation")+ "</" + tag_name + ">";
						int_xml.put(parent_tag, xml_str);
					}
					 //Deepak Changes for Estatement flag
					else if("FlagValue".equals(tag_name)&& "CUSTOMER_UPDATE_REQ".equalsIgnoreCase(callName) && "EStatementFlags".equalsIgnoreCase(parent_tag)){					
						String xml_str = int_xml.get(parent_tag);
						xml_str = xml_str + "<" + tag_name + ">" + ("Yes".equalsIgnoreCase(formObject.getNGValue(form_control))?"Y":"N") + "</" + tag_name + ">";
						int_xml.put(parent_tag, xml_str);
					}
					else{
						int_xml = GenDefault_Input_DB(int_xml,recordFileMap,formObject,callName);
				...
				else if( "SUPPLEMENT".equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),12)))
				{
					...
					//changes done by Shivang for Production HD Incident 3008530
						...
						if( formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),12).equalsIgnoreCase("Supplement") && formObject.getLVWRowCount("SupplementCardDetails_cmplx_SupplementGrid")>0){ 
						 ...
						 if(!"".equalsIgnoreCase(ph_no) && ph_no.indexOf("00971") > -1) 
						{
							phlocal = ph_no.substring(5);
							xml_str = xml_str + "<" + tag_name + ">" +phlocal + "</" + tag_name + ">";
	...
	private Map<String, String> CARD_NOTIFICATION_Custom(List<List<String>> DB_List,FormReference formObject,String callName,String Operation_name) {
		...
		try{
			for (List<String> mylist : DB_List) {
				...
				else if("PRIMARY".equalsIgnoreCase(Operation_name) && "CorpCIFID".equalsIgnoreCase(tag_name)){
					CreditCard.mLogger.info("inside CorpCIFID");
					String subProd=formObject.getNGValue("Sub_Product");
					if(subProd.equalsIgnoreCase("BTC") ){
						CreditCard.mLogger.info("inside BTC condition");
						String Company_CIF = formObject.getNGValue("cmplx_CompanyDetails_cmplx_CompanyGrid",1,3);
						String xml_str = int_xml.get(parent_tag);
						xml_str = xml_str+"<"+tag_name+">"+Company_CIF+"</"+ tag_name+">";
						CreditCard.mLogger.info("inside BTC condition xml_str: "+xml_str);
						int_xml.put(parent_tag, xml_str);
					}
				...
				//Deepak Changes done on 24 Aud for PCAS-2516
					...
					String xml_str = int_xml.get(parent_tag);
					String Selected_card_crn = formObject.getNGValue("CC_Creation_CRN");
					int CRNgridRowCount = formObject.getLVWRowCount("cmplx_CardDetails_cmplx_CardCRNDetails");
					CreditCard.mLogger.info("for adding feeProf+ "+xml_str + "Selected_card_crn: "+ Selected_card_crn);
					String feeProf = "";
					for(int i=0;i<CRNgridRowCount;i++){
						if(formObject.getNGValue("cmplx_CardDetails_cmplx_CardCRNDetails",i,2).equalsIgnoreCase(Selected_card_crn)){
							CreditCard.mLogger.info("for feeProfCRN match i: "+i + " feeProf "+ feeProf);
				...
				else if("AccountNumber".equalsIgnoreCase(tag_name)){
					String emptype = formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0,6);
					CreditCard.mLogger.info("emptype: "+emptype);
					String xml_str;
					String accountNo="";
					if("Self Employed".equalsIgnoreCase(emptype)){
						accountNo = formObject.getNGValue("cmplx_IncomeDetails_Account_self_num");
					}
					else{
						accountNo = formObject.getNGValue("cmplx_IncomeDetails_Account_num_sal");
					}
					try{
					xml_str = int_xml.get(parent_tag);
					if((!"".equalsIgnoreCase(accountNo))&& accountNo!=null){
						xml_str = xml_str +"<ProductType>Account</ProductType><ProductSubType>LAA</ProductSubType>";
						xml_str = xml_str +"<AccountNumber>" +accountNo+ "</AccountNumber>";
					}
					else{
						xml_str = xml_str +"<ProductType>Credit Card</ProductType><ProductSubType>LAA</ProductSubType>";
					}
					int_xml.put(parent_tag, xml_str);
					//CreditCard.mLogger.info("RLOS COMMON"+" AccountNumber:+ "+xml_str);
					}catch(Exception ex){
						CreditCard.mLogger.info("Exception in AccountNumber tag: "+CC_Common.printException(ex));
					}
				}
				//Added By Shivang for pcasp-2307,2308  
					...
					try{
					xml_str = int_xml.get(parent_tag);
					//changed by shivang for PCASP-3052	
					if(emptype.equalsIgnoreCase("Self Employed")){					    
						xml_str += "<CustClassCode>"+formObject.getNGValue("cmplx_CompanyDetails_cmplx_CompanyGrid",1,29)+"</CustClassCode>";																
					}
					else{
						xml_str += "<CustClassCode>"+formObject.getNGValue("cmplx_EmploymentDetails_ClassificationCode")+"</CustClassCode>";
					}
					int_xml.put(parent_tag, xml_str);
					//CreditCard.mLogger.info("RLOS COMMON"+" CustClass Code:+ "+xml_str);
					}catch(Exception ex){
						CreditCard.mLogger.info("Exception in CustClassCode tag: "+CC_Common.printException(ex));
					}
				}
				...
				//Added by shivang for PCASP-2357
					...
					try{
						...
						CreditCard.mLogger.info("Exception in BusinessInfo aggregate tag: "+CC_Common.printException(ex));
					}					
				}
				...
				//tag added by saurabh on 8th Feb 19 for default value points.
					...
					String branchUserQuery = "select top 1 userid as DSA from NG_MASTER_SourceCode with(nolock) where userid=(select DSA_Name from NG_CC_EXTTABLE with(nolock) where CC_Wi_Name='"+formObject.getWFWorkitemName()+"')"; 
					CreditCard.mLogger.info("inside 1st DSAId card_notification req1 branchUserQuery :"+branchUserQuery);
					List<List<String>> result = formObject.getDataFromDataSource(branchUserQuery);
					CreditCard.mLogger.info("inside 1st DSAId card_notification req1 result :"+result);
				...
				else if( "PRIMARY".equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),12)) || ("SUPPLEMENT".equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),12)) && formObject.getNGValue("cmplx_Customer_PAssportNo").equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),13))  ))
				{
					...
					else if(tag_name.equalsIgnoreCase("ResidenceSince"))
					{
						...
						try{
							...
							CreditCard.mLogger.info("Exception occured in SalaryDate:  "+e.getMessage());
							sal_day=5;
						}
	...
	private Map<String, String> NEW_CREDITCARD_Custom(List<List<String>> DB_List,FormReference formObject,String callName) {
		...
		try{
			for (List<String> mylist : DB_List) {
				...
				String tag_name =  recordFileMap.get("xmltag_name");
				String form_control = recordFileMap.get("form_control");
				//CreditCard.mLogger.infocard creation deep parent_tag:  "+parent_tag);
				...
				//Deepak Code commented for CR PCSP-475 to send value from master 
					...
					if(int_xml.containsKey(parent_tag))
					{
						try{
							...
							String ProfileSerNo_Query =""; 
							if("PRIMARY".equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),12))){
								ProfileSerNo_Query="select top 1 MAST_PROF_PRIM from ng_master_cardProduct with(nolock) where CODE ='"+formObject.getNGValue("CC_Creation_Product")+"'";
							}
							/*else if("Supplement".equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),12)) 
									&& formObject.getNGValue("cmplx_Customer_PAssportNo").equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),13))){
								ProfileSerNo_Query="select top 1 MAST_PROF_SUPP_CLUND from ng_master_cardProduct with(nolock) where CODE ='"+formObject.getNGValue("CC_Creation_Product")+"'";
							}*/
							else{
								String selected_card_limit = formObject.getNGValue("CC_Creation_CardLimit");
								String primary_card_limit=formObject.getNGValue("Final_Limit");
								if(Integer.parseInt(selected_card_limit)==Integer.parseInt(primary_card_limit)){
									ProfileSerNo_Query="select top 1 MAST_PROF_SUPP_CLOVR from ng_master_cardProduct with(nolock) where CODE ='"+formObject.getNGValue("CC_Creation_Product")+"'";
								}
								else{
									ProfileSerNo_Query="select top 1 MAST_PROF_SUPP_CLUND from ng_master_cardProduct with(nolock) where CODE ='"+formObject.getNGValue("CC_Creation_Product")+"'";
								}
							}
							CreditCard.mLogger.info("Profileserno query: "+ ProfileSerNo_Query);
							record = formObject.getNGDataFromDataCache(ProfileSerNo_Query);
					...
					if(int_xml.containsKey(parent_tag))
					{
						try{
							...
							if(card_product==null|| card_product.equals("")){
								...
								String applicantCrn = formObject.getNGValue("CC_Creation_CRN");
								if (tag_name.equalsIgnoreCase("InterestProfile")) {
									intrest_Query = "select top 1 interestFP as code from ng_rlos_gr_cardDetailsCRN where CRN_winame='"+formObject.getWFWorkitemName()+"' and CRN='"+applicantCrn+"'";
									//intrest_Query = "select top 1 code from ng_master_InterestProfile with (nolock) where Product = '" + card_product + "'";
								} else if ((tag_name.equalsIgnoreCase("FeeProfile")) || (tag_name.equalsIgnoreCase("FeeProfileSerNo"))) {
									intrest_Query = "select top 1 FeeProfile as code from ng_rlos_gr_cardDetailsCRN where CRN_winame='"+formObject.getWFWorkitemName()+"' and CRN='"+applicantCrn+"'";
									//intrest_Query = "select top 1 code from NG_MASTER_feeprofile with (nolock) where Product = '" + card_product + "'";
								} else if ((tag_name.equalsIgnoreCase("TransactionFeeProfile")) || (tag_name.equalsIgnoreCase("TxnProfileSerNo"))) {
									intrest_Query="select top 1 TransactionFP as code from ng_rlos_gr_cardDetailsCRN where CRN_winame='"+formObject.getWFWorkitemName()+"' and CRN='"+applicantCrn+"'";
									//intrest_Query = "select top 1 code from ng_master_TransactionFeeProfile with (nolock) where Product = '" + card_product + "'";
								}
	...
	public String fetchAddressFlagVal() {
		try{
			...
			if(Cust_type.equalsIgnoreCase("Primary")){
				//Changes Done By deepak for Prod Bug
...
*/
	...
	public String getcontact_details(){
		...
		try{
					...
					if(!selfEmpcase){
						...
						try{//Done by aman for CR 0712
							...
							if(primaryApp)
								...
								Empdetails_xml_str += "<Department>"+Designation+"</Department>";
							if(primaryApp){
						...
						try{
							...
							if(primaryApp)
								Empdetails_xml_str += "<EmployerId>"+formObject.getNGValue("cmplx_CompanyDetails_cmplx_CompanyGrid",1,40)+"</EmployerId>";
							if(primaryApp)
								Empdetails_xml_str += "<EmployerName>"+formObject.getNGValue("cmplx_CompanyDetails_cmplx_CompanyGrid",1,0)+"</EmployerName>";
							
							if(primaryApp){
								Empdetails_xml_str += "<Designation>"+formObject.getNGValue("cmplx_Customer_Designation")+"</Designation>";
							}
							else{
								Empdetails_xml_str += "<Designation>"+getSuppCardnotifdata("Designation")+"</Designation>";
							}
							...
							if(primaryApp){
								Empdetails_xml_str += "<Occupation>"+formObject.getNGValue("cmplx_Customer_Designation")+"</Occupation>";
							}
							else{
								Empdetails_xml_str += "<Occupation>"+getSuppCardnotifdata("Occupation")+"</Occupation>";
							}
			...
			public String getpoaAuthSign(){
				String desig = null;
				try{
					FormReference formObject = FormContext.getCurrentInstance().getFormReference();
					//Query Modified by Shivang for PCASP-2350
					String cif = formObject.getNGValue("CifLabel");
					String query = "select top 1 POAholders from ng_rlos_gr_AuthSignDetails with(nolock) where ChildMapping = (select parentmapping_auth from NG_RLOS_GR_CompanyDetails with(nolock)  where applicantCategory='Authorised signatory' and comp_winame = '"+formObject.getWFWorkitemName()+"') and AuthSignCIFNo='"+cif+"' ";
					List<List<String>> result = formObject.getDataFromDataSource(query);
					if(result!=null && result.size()>0 && result.get(0).size()>0){
						desig = result.get(0).get(0);
					}
			...
			public String getFinancialServices_details(String Call_name){
				...
				try{
					...
					if(rowCount>0){
						...
						/*int chosenRow = -1;//currently 0 for testing but has to be -1.
						...
						for(int chosenRow =0 ;chosenRow<formObject.getLVWRowCount(listViewname);chosenRow++ )
						{
							...
							//Date
							//Deepak Changes done to send current date as service date.
							//String Service_date = formObject.getNGValue(listViewname, chosenRow, gridColumnNames.indexOf("Date"));
							Date currentDate=new Date();
							SimpleDateFormat sf=new SimpleDateFormat("yyyy-MM-dd");
							String Service_date=sf.format(currentDate);
							...
							String paymentPurpose = formObject.getNGValue(listViewname, chosenRow, gridColumnNames.indexOf("Payment Purpose"));//Changed by shivang for PCASP-3191
							...
							if(Call_name.equalsIgnoreCase("CARD_NOTIFICATION")){
								...
								//Financial_xml_str+="<ServiceApprovalCode>"+formObject.getNGValue("cmplx_DEC_HighDeligatinAuth")+"</ServiceApprovalCode>";
								...
								//Deepak code change for Credit card number in place of account number
								if("LOC".equalsIgnoreCase(serviceType) && "A".equalsIgnoreCase(payMode)){
									Financial_xml_str+="<AdditionalInfo>";
									Financial_xml_str+="<RefType>NameOnCard</RefType>";
									Financial_xml_str+="<RefValue>"+nameOnCard+"</RefValue>";
						            Financial_xml_str+="</AdditionalInfo>";
								}
								else{
									...
									//Changed by shivang for PCASP-2931
									if(checkValue(nameOnCard)){
										Financial_xml_str+="<CustomerName>"+nameOnCard+"</CustomerName>";
									}
									Financial_xml_str+="</OtherBankInfo>";
								}
			...
			public String getLien_details(String Call_name){
				...
				try{
					...
					if (add_row_count>0){
						...
						String Lien_no="";
						String Lien_amount ="";
						String Lien_maturity_date ="";
						//Changes for sending Account No. in LienNumber tag in CAPS for Secured Card
						if(subProd.equalsIgnoreCase("SEC") ||(subProd.equalsIgnoreCase("BTC") && apptype.equalsIgnoreCase("SMES"))){
							for(int i=0;i<add_row_count;i++){
								if(formObject.getNGValue("cmplx_FinacleCore_liendet_grid",i,7).equalsIgnoreCase("true")){
									Lien_no = formObject.getNGValue("cmplx_FinacleCore_liendet_grid",i,0); 
									Lien_amount = formObject.getNGValue("cmplx_FinacleCore_liendet_grid",i,2); 
									Lien_maturity_date = formObject.getNGValue("cmplx_FinacleCore_liendet_grid",i,6);
									break;
								}
							}
						}
						else{
						 Lien_no = formObject.getNGValue("cmplx_FinacleCore_liendet_grid", 0, 1); //0
						 Lien_amount = formObject.getNGValue("cmplx_FinacleCore_liendet_grid", 0, 2); //0
						 Lien_maturity_date = formObject.getNGValue("cmplx_FinacleCore_liendet_grid", 0, 6); //0
						}
						...
						if(Call_name.equalsIgnoreCase("CARD_SERVICES_REQUEST")){
							...
							if(!("".equals(Lien_maturity_date))){
								lien_xml_str = lien_xml_str+ "<LienMaturityDt>"+Lien_maturity_date.substring(0,10)+"</LienMaturityDt>";
							}
							else{
								lien_xml_str = lien_xml_str+ "<LienMaturityDt>"+"2099-12-31"+"</LienMaturityDt>";
							}
						}
						else if(Call_name.equalsIgnoreCase("CARD_NOTIFICATION")){
							...
							if(!("".equals(Lien_maturity_date))){
								lien_xml_str = lien_xml_str+ "<MaturityDate>"+Lien_maturity_date.substring(0,10)+"</MaturityDate>";
							}
							else{
								lien_xml_str = lien_xml_str+ "<MaturityDate>"+"2099-12-31"+"</MaturityDate>";
							}
						}
			...
			private Map<String, String> DECTECH_Custom(List<List<String>> DB_List,FormReference formObject,String callName) {
				...
				try{
					for (List<String> mylist : DB_List) {
						...
						String tag_name =  recordFileMap.get("xmltag_name");
						String emp_type = "";
						CreditCard.mLogger.info("tag_name: "+ tag_name + "parent_tag: "+parent_tag);
					...
					int_xml.put(parent_tag, xml_str);
							...
							if(formObject.getNGValue("Application_Type").equalsIgnoreCase("RELT")||formObject.getNGValue("Application_Type").equalsIgnoreCase("RELTN")||formObject.getNGValue("Application_Type").equalsIgnoreCase("BELT"))
							{
							 fd_amount=formObject.getNGValue("cmplx_FinacleCore_tot_fd_amt");
							}
							else
								fd_amount=formObject.getNGValue("cmplx_FinacleCore_Final_FD_Amount");
							String xml_str =  int_xml.get(parent_tag);
						...
						else if("actual_fdamount".equalsIgnoreCase(tag_name)){
							...
							{
							String actualFDAmt="";
							String query="select isnull(sum(cast(ActualFDAmount as float)),'') as ActualFDAmount from (select AvailableBalance as ActualFDAmount from ng_RLOS_CUSTEXPOSE_AcctDetails where Child_Wi='"+formObject.getWFWorkitemName()+"' and AcctId=(select top 1 Account_Number from NG_RLOS_GR_LienDet where lien_wi_name='"+formObject.getWFWorkitemName()+"' and Consider_for_Obligation='true') union all select top 1 lienamt as ActualFDAmount from NG_RLOS_GR_LienDet where lien_wi_name='"+formObject.getWFWorkitemName()+"' and Consider_for_Obligation='true') as t";
							 List<List<String>> result = formObject.getDataFromDataSource(query);
							 if(result!=null && result.size()>0){
								 actualFDAmt = result.get(0).get(0);
							 }
							 String xml_str = int_xml.get(parent_tag);
							 xml_str = xml_str + "<" + tag_name + ">" + actualFDAmt + "</" + tag_name + ">";
							 int_xml.put(parent_tag, xml_str);
							}
						}
							...
							try{
								...
								String query = "select count (distinct passinfo) from (select distinct AuthSignPassPortNo as passinfo from ng_rlos_gr_AuthSignDetails with(nolock) where ChildMapping = (select parentmapping_auth from NG_RLOS_GR_CompanyDetails with(nolock)  where applicantCategory='Business' and comp_winame = '"+formObject.getWFWorkitemName()+"') union all select distinct PassportNo as passinfo  from NG_RLOS_GR_PartnerDetails with(nolock) where ChildMapping = (select parentmapping_partner from NG_RLOS_GR_CompanyDetails with(nolock)  where applicantCategory='Business' and comp_winame = '"+formObject.getWFWorkitemName()+"') ) as ext";
								List<List<String>> result = formObject.getDataFromDataSource(query);
								if(result!=null && result.size()>0 && result.get(0).size()>0){
									no_of_partners = result.get(0).get(0);
								}
							}
							catch(Exception e){
						...
						//start by sagarika
							...
							CreditCard.mLogger.info("sa@self");
							if(int_xml.containsKey(parent_tag))
							{
								CreditCard.mLogger.info("sa@self_p");
								if("PA".equalsIgnoreCase(formObject.getNGValue("Sub_Product")) || "Self Employed".equalsIgnoreCase(emp_type)){
									//	RLOS.mLogger.info("sagarika");
									CreditCard.mLogger.info("sa@self_p11");
									...
									CreditCard.mLogger.info("sa@self_p"+avg_credit_turnover);
									...
									//	CreditCard.mLogger.info("sa@self_p"+avg_bal);
										CreditCard.mLogger.info("sa@self_p freq"+avg_credit_turnover_freq);
										...
										avg_credit_turnover3rd_str=formObject.getNGValue("cmplx_FinacleCore_avg_credit_3month").equals("")?"0":formObject.getNGValue("cmplx_FinacleCore_avg_credit_3month");
										avg_credit_turnover6th_str=formObject.getNGValue("cmplx_FinacleCore_avg_credit_6month").equals("") ?"0":formObject.getNGValue("cmplx_FinacleCore_avg_credit_6month");
										avg_credit_turnover6th_str="";
										
										//	RLOS.mLogger.info("avg_credit_turnover3rd value after"+avg_credit_turnover3rd);
									
									CreditCard.mLogger.info("avg_bal@ value after"+avg_bal);
									...
									/*	avg_bal_6=Double.parseDouble(avg_bal);
										...
										CreditCard.mLogger.info("avg_bal_3 value"+formObject.getNGValue("cmplx_FinacleCore_total_avg_last13"));
										avg_bal_3_str=formObject.getNGValue("cmplx_FinacleCore_total_avg_last13").equals("")?"0":formObject.getNGValue("cmplx_FinacleCore_total_avg_last13");
										avg_bal_6_str=formObject.getNGValue("cmplx_FinacleCore_total_avg_last_16").equals("")?"0":formObject.getNGValue("cmplx_FinacleCore_total_avg_last_16");
										avg_bal_6_str="";
										CreditCard.mLogger.info("avg_bal_3 str"+avg_bal_3_str);
						...
						else if("pl_employer_status".equalsIgnoreCase(tag_name))
						{
							...
							if (int_xml.containsKey(parent_tag)) {
								...
								if (confirmedinjob != null) {
									if ("Yes".equalsIgnoreCase(confirmedinjob)) 
									{
										confirmedinjob = "Y";
									} 
									else 
						...
						//Production change for sending CES flag to Dectech Dated 22Apr2021
							...
							if (int_xml.containsKey(parent_tag)) {
								//Deepak Changes done new value of CES flag
								//String ces = "true".equalsIgnoreCase(formObject.getNGValue("cmplx_EmploymentDetails_CESflag")) ? "Y" : "N";
								String ces = formObject.getNGValue("cmplx_EmploymentDetails_CESflag");
								if (ces != null) {
									String xml_str = int_xml.get(parent_tag);
							...
							//Deepak Query changed for production change of SI and BTC Card Issue
							...
							String subProd=formObject.getNGValue("Sub_Product");
							if(subProd.equalsIgnoreCase("BTC") ){
								squerynoc = "SELECT count(Child_wi) FROM (select SI_WIname as Child_wi from ng_rlos_gr_SI where SI_WIname='" + formObject.getWFWorkitemName() + "') as SI_details";
							}
							else{
								squerynoc = "SELECT count(Child_wi) FROM (select Child_wi from ng_rlos_FinancialSummary_SiDtls with (nolock) WHERE Child_wi='" + formObject.getWFWorkitemName() + "' UNION ALL select SI_WIname as Child_wi from ng_rlos_gr_SI where SI_WIname='" + formObject.getWFWorkitemName() + "') as SI_details";
							}
					...
					if(int_xml.containsKey(parent_tag))
					{
						...
						int_xml.put(parent_tag, xml_str);
							...
							String squeryBorrow="select isnull(borrowingCustomer,'') from ng_RLOS_CUSTEXPOSE_CardDetails with (nolock) WHERE  Child_wi ='"+formObject.getWFWorkitemName()+"' and cifid='"+formObject.getNGValue("cmplx_Customer_CIFNo")+"' ";
						...
						//end
							...
							if(int_xml.containsKey(parent_tag))
							{
								...
								//--Commented and added by shivanshi for ppct-61 on 10-10-20201--String aeQuery = "select (select isNull((Sum(convert(float,replace([OutstandingBalance],'NA','0')))),0)  from ng_RLOS_CUSTEXPOSE_CardinstallmentDetails installment join ng_RLOS_CUSTEXPOSE_CardDetails carddetails with (nolock) on carddetails.CardEmbossNum=installment.CardcrnNumber and installment.Child_Wi=carddetails.Child_Wi  where  carddetails.Consider_For_Obligations='true' and carddetails.CardStatus in ('A','ACTIVE') and carddetails.child_wi ='"+formObject.getWFWorkitemName()+"' and SchemeCardProd like '%LOC%' AND OutstandingBalance not like '%-%') +(select isNull((Sum(convert(float,replace([CreditLimit],'NA','0')))),0) as OutstandingAmt from (select DISTINCT max( liab.CreditLimit) as CreditLimit from ng_RLOS_CUSTEXPOSE_CardDetails liab, ng_master_cardProduct prod with (nolock) where  Consider_For_Obligations='true' and CardStatus in ('A','ACTIVE') and child_wi ='"+formObject.getWFWorkitemName()+"' and SchemeCardProd not like '%LOC%' AND CreditLimit not like '%-%' and liab.SchemeCardProd=prod.CODE group by case when prod.ReqProduct='Conventional' then prod.ReqProduct else liab.SchemeCardProd end) as TempTable)+( select isNull((Sum(convert(float,replace([final_limit],'NA','0')))),0) from ng_rlos_EligAndProdInfo with (nolock) where wi_name ='"+formObject.getWFWorkitemName()+"') + (select isNull((Sum(convert(float,replace([CreditLimit],'NA','0')))),0) as OutstandingAmt from ng_RLOS_CUSTEXPOSE_LoanDetails where (LoanType like '%PL%' or LoanType like '%PERSONAL%') and SchemeCardProd like '%P_XPAT_CASHLOAN%' and child_wi ='"+formObject.getWFWorkitemName()+"') as aggregateExposure";
								String aeQuery = "select (select isNull((Sum(convert(float,replace([carddetails].OutstandingAmt,'NA','0')))),0)  from ng_RLOS_CUSTEXPOSE_CardinstallmentDetails installment join ng_RLOS_CUSTEXPOSE_CardDetails carddetails with (nolock) on carddetails.CardEmbossNum=installment.CardcrnNumber and installment.Child_Wi=carddetails.Child_Wi  where  carddetails.Consider_For_Obligations='true' and carddetails.CardStatus in ('A','ACTIVE') and carddetails.child_wi ='"+formObject.getWFWorkitemName()+"' and SchemeCardProd like '%LOC%' AND OutstandingBalance not like '%-%') +(select isNull((Sum(convert(float,replace([CreditLimit],'NA','0')))),0) as OutstandingAmt from (select DISTINCT max( liab.CreditLimit) as CreditLimit from ng_RLOS_CUSTEXPOSE_CardDetails liab, ng_master_cardProduct prod with (nolock) where  Consider_For_Obligations='true' and CardStatus in ('A','ACTIVE') and child_wi ='"+formObject.getWFWorkitemName()+"' and SchemeCardProd not like '%LOC%' AND CreditLimit not like '%-%' and liab.SchemeCardProd=prod.CODE group by case when prod.ReqProduct='Conventional' then prod.ReqProduct else liab.SchemeCardProd end) as TempTable)+( select isNull((Sum(convert(float,replace([final_limit],'NA','0')))),0) from ng_rlos_EligAndProdInfo with (nolock) where wi_name ='"+formObject.getWFWorkitemName()+"') + (select isNull((Sum(convert(float,replace([TotalOutstandingAmt],'NA','0')))),0) as OutstandingAmt from ng_RLOS_CUSTEXPOSE_LoanDetails where (LoanType like '%PL%' or LoanType like '%PERSONAL%') and SchemeCardProd like '%P_XPAT_CASHLOAN%' and child_wi ='"+formObject.getWFWorkitemName()+"') as aggregateExposure";
							...
							if (int_xml.containsKey(parent_tag)) {
								String xml_str = int_xml.get(parent_tag);
								//CreditCard.mLogger.info("RLOS COMMON"+" before adding BlacklistDetails+ " + xml_str);
								xml_str = xml_str + CC_Comn.getBlacklistDetails("Blacklist");
								//CreditCard.mLogger.info("RLOS COMMON"+" after BlacklistDetails+ " + xml_str);
								int_xml.put(parent_tag, xml_str);
							}
							...
							if (int_xml.containsKey(parent_tag)) {
								String xml_str = int_xml.get(parent_tag);
								//CreditCard.mLogger.info("RLOS COMMON"+" before adding NegatedDetails+ " + xml_str);
								xml_str = xml_str + CC_Comn.getBlacklistDetails("Negated");
								//CreditCard.mLogger.info("RLOS COMMON"+" after NegatedDetails+ " + xml_str);
								int_xml.put(parent_tag, xml_str);
							}
							...
							CreditCard.mLogger.debug("temp:" + temp);
							if (!"".equalsIgnoreCase(temp)) {
								if (xml_str == null) {
									//CreditCard.mLogger.info("RLOS COMMON"+ " before adding bhrabc"+ xml_str);
									xml_str = "";
						...
						else if ("CourtCase".equalsIgnoreCase(tag_name)) {

							String xml_str = int_xml.get(parent_tag);
							//CreditCard.mLogger.info("RLOS COMMON"+" before adding ExternalBureauPipelineProducts+ "+ xml_str);
							String temp =getCourtCase();
							if (!"".equalsIgnoreCase(temp)) {
								if (xml_str == null) {
									//CreditCard.mLogger.info("RLOS COMMON"+ " before adding bhrabc"+ xml_str);
									xml_str = "";
	...
	Description                         : Function to Generate Input XML for DB INPUT
						...
						if ("Y".equalsIgnoreCase(is_repetitive)&& int_xml.containsKey(tag_name)) {
							...
							if ("".equalsIgnoreCase(form_control.trim())&& "".equalsIgnoreCase(default_val.trim())) {
								...
								form_control_val = default_val;
									//String subProduct = formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0,12);
								//CreditCard.mLogger.info("Sub product inside else shivanshi");
			...
			public String getExtensions_details(boolean primary){
				...
				desctoFormCtrl.put("PS:Card:F170","C 10103:Y");*/
                    ...
                    if(primary){
						//Extension 10053 & 10054 are changed from A to C based on change request via Ritu. //Change reverted for Primary as per Ritu email on 13 june 22 - UAT 2 Mobile number
                        ...
                        desctoFormCtrl.put("PS:Account:F164","A 21001:N");
                    	 ...
                    	 /*desctoFormCtrl.put("PS:Account:F169","C 10053:Supp_MobileNo1");
                         desctoFormCtrl.put("PS:Account:F170","C 10054:Supp_Email1");*/
                    }
            ...
            desctoFormCtrl.put("PS:Account:F171","A 10058 :Send SMS Option    ");
                    ...
                    for(Map.Entry<String, String> entry : desctoFormCtrl.entrySet()){
                        ...
                        else if(entry.getKey().contains("F169") && "SUPPLEMENT".equalsIgnoreCase(App_type)){
                        	 String query = "select top 1 MobileNo from ng_RLOS_GR_SupplementCardDetails with(nolock) where supplement_WIname = '"+formObject.getWFWorkitemName()+"' and PassportNo='"+selectPassport+"'";
                             ext_xml_str += addExtensionValue(entry.getKey(),entry.getValue(),formObject.getDataFromDataSource(query).get(0).get(0), extcount);
                             extcount++;
                             continue;
                        }
                        else if(entry.getKey().contains("F170") && "SUPPLEMENT".equalsIgnoreCase(App_type)){
                        	String query = "select top 1 Email_ID from ng_RLOS_GR_SupplementCardDetails with(nolock) where supplement_WIname = '"+formObject.getWFWorkitemName()+"' and PassportNo='"+selectPassport+"'";
                             ext_xml_str += addExtensionValue(entry.getKey(),entry.getValue(),formObject.getDataFromDataSource(query).get(0).get(0), extcount);
                             extcount++;
                             continue;
                        }
			...
			//rubi
			public String getCardExtensions_details(boolean primary){
                CreditCard.mLogger.info("RLOSCommon java file inside getExtensions_details : ");
                String  ext_xml_str ="";
                try{
                    FormReference formObject = FormContext.getCurrentInstance().getFormReference();
                    ...
                    if(primary){
                    	...
                    	//new extensions added by rubi guidance 
                    	desctoFormCtrl.put("PS:Account:F169","C 10050:AlternateContactDetails_MobileNo1");
                        desctoFormCtrl.put("PS:Account:F170","C 10051:AlternateContactDetails_Email1");
                    }
                    //Deepak changes done for Air Arabia in extension 5 feb -PCSP 653
                    String card_intrest_profile = formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),11);
					if(card_intrest_profile.contains("Arabia")){
...
/*					if(mapKey.contains("F160") || mapKey.contains("F161"))
					...
					{*/
					String Field_no = mapValue.split(":")[0].substring(2).trim();
					return "<extension fieldNo=\""+Field_no+"\" value=\""+value+"\" respId=\""+extcount_val+"\"></extension>";
				...
				try{
					...
					if(callName.equalsIgnoreCase("NEW_CUSTOMER_REQ")){
						...
						if( "SUPPLEMENT".equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),12)) && formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid")>0){ 
							for(int i=0;i<formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid");i++){
								if(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),13).equals(formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,3))){
									...
									String selectproduct_value = formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),5);
									if(CombinedLimit_Eligibility(selectproduct_value)){
										str=str+"<CombinedCreditLimit>0</CombinedCreditLimit>";
									}
									else{
						...
						if( "SUPPLEMENT".equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),12)) && formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid")>0){ 
							for(int i=0;i<formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid");i++){
								if(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),13).equals(formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,3))){
									String title=formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,14);
									
									String sQuery="select Enroll_RewardCode from ng_master_title where code='"+title+"'";
									//CreditCard.mLogger.info("TitlePrefix sQuery: "+sQuery);
									List<List<String>> DB_List1 = formObject.getDataFromDataSource(sQuery);
									//CreditCard.mLogger.info("TitlePrefix sQuery result "+DB_List1);
									
									if(!DB_List1.isEmpty()){
										title=DB_List1.get(0).get(0);	
									}
									
									str=str+"<PersonNm><TitlePrefix>"+title+"</TitlePrefix>";
									str=str+"<FirstNm>"+formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,0)+"</FirstNm>";
									str=str+"<LastNm>"+formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,2)+"</LastNm>";
									String dob ="";
									try{
										String dob_date =formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,4);
										DateFormat for1 = new SimpleDateFormat("dd/MM/YYYY");
										DateFormat for2 = new SimpleDateFormat("ddMMMyyyy");
										Date con_dob_date = for1.parse(dob_date);
										//CreditCard.mLogger.info("RLOS COMMON"+" before contact details+ "+con_dob_date);
										dob = for2.format(con_dob_date);
									}
									catch(Exception e){
										CreditCard.mLogger.info("CC Integration "+ " Exception occured in DEDUP_SUMMARY_Custom + "+e.getMessage());
										CreditCard.mLogger.info("CC_INtegration Exception in CARD services custom function:  "+CC_Common.printException(e));
			...
			public String getFATCA_details(FormReference formObject){
				...
				try{
					...
					for(int i=0;i<formObject.getLVWRowCount("cmplx_FATCA_cmplx_GR_FatcaDetails");i++){
						...
						if(applicantName.split("-")[1].trim().replaceAll(" ","").equalsIgnoreCase(formObject.getNGValue("CC_Creation_CustomerName").trim().replaceAll(" ","")))
						{	
			...
			public static String getHistory()
			{
				...
				//Deepak query updated to include account as well - 13/08/22
				String Query ="select CardEmbossNum,replace(history,'Key','monthyear') as History from ng_rlos_cust_extexpo_CardDetails with(nolock) where child_wi='"+formObject.getWFWorkitemName()+"' and (History is not null or History!='') union all select AgreementId,replace(history,'Key','monthyear') from ng_rlos_cust_extexpo_LoanDetails with(nolock) where child_wi='"+formObject.getWFWorkitemName()+"' and (History is not null or History!='') union all select AcctId,replace(history,'Key','monthyear') from ng_rlos_cust_extexpo_AccountDetails with(nolock) where child_wi='"+formObject.getWFWorkitemName()+"' and (History is not null or History!='')";
				CreditCard.mLogger.debug("query: " + Query);
				String add_xml_str = "";
				try
				{
					...
					for (int i = 0; i < OutputXML.size(); i++) {
						...
						CreditCard.mLogger.debug("history Tag :" +HistoryTag);
						if(!"".equals(HistoryTag) && HistoryTag.startsWith("<"))
						{
							...
							CreditCard.mLogger.debug("add_xml_str : "+add_xml_str);
						}
					}
				}
		catch(Exception ex)
		{CreditCard.mLogger.info("Exception in get History");

		}
		return add_xml_str;
	}
			
			public static String getCourtCase()
			{
				FormReference formObject = FormContext.getCurrentInstance().getFormReference();
				String Query ="select CodOrganization,ProviderCaseNo,ReferenceDate," +
						"CaseCategoryCode,CaseOpenDate,isnull(CaseCloseDate,'') as CaseCloseDate,CaseStatusCode," +
						"InitialTotalClaimAmount from ng_rlos_cust_extexpo_CaseDetails where Child_WI='"+ formObject.getWFWorkitemName()+"'";
				CreditCard.mLogger.info("inside getCourtCase Query: "+ Query);
				String add_xml_str = "";

				try
				{
					List<List<String>> OutputXML = formObject.getDataFromDataSource(Query);
					CreditCard.mLogger.info("inside getCourtCase OutputXML: "+ OutputXML.toString());
					for (int i = 0; i < OutputXML.size(); i++) {
						String CodOrganization = "";
						String ProviderCaseNo = "";
						String ReferenceDate = "";
						String CaseCategoryCode = "";
						String CaseOpenDate = "";
						String CaseCloseDate = "";
						String CaseStatusCode="";
						String InitialTotalClaimAmount = "";

						if (!(OutputXML.get(i).get(0) == null || OutputXML.get(i).get(0).equals(""))) {

							CodOrganization = OutputXML.get(i).get(0).toString();
						}

						if (!(OutputXML.get(i).get(1) == null || OutputXML.get(i).get(1).equals(""))) {

							ProviderCaseNo = OutputXML.get(i).get(1).toString();
						}

						if (!(OutputXML.get(i).get(2) == null || OutputXML.get(i).get(2).equals(""))) {

							ReferenceDate = OutputXML.get(i).get(2).toString();
						}

						if (!(OutputXML.get(i).get(3) == null || OutputXML.get(i).get(3).equals(""))) {

							CaseCategoryCode = OutputXML.get(i).get(3).toString();
						}

						if (!(OutputXML.get(i).get(4) == null || OutputXML.get(i).get(4).equals(""))) {

							CaseOpenDate = OutputXML.get(i).get(4).toString();
						}

						if (!(OutputXML.get(i).get(5) == null || OutputXML.get(i).get(5).equals(""))) {

							CaseCloseDate = OutputXML.get(i).get(5).toString();
						}

						if (!(OutputXML.get(i).get(6) == null || OutputXML.get(i).get(6).equals(""))) {

							CaseStatusCode = OutputXML.get(i).get(6).toString();
						}

						if (!(OutputXML.get(i).get(7) == null || OutputXML.get(i).get(7).equals(""))) {

							InitialTotalClaimAmount = OutputXML.get(i).get(7).toString();
						}
						...
						add_xml_str = add_xml_str + "<CourtCase><CodOrganization>"+CodOrganization+"</CodOrganization>";
						add_xml_str = add_xml_str + "<ProviderCaseNo>"+ProviderCaseNo+"</ProviderCaseNo>";
						add_xml_str = add_xml_str + "<ReferenceDate>"+ReferenceDate+"</ReferenceDate>";
						add_xml_str = add_xml_str + "<CaseCategoryCode>"+CaseCategoryCode+"</CaseCategoryCode>";
						add_xml_str = add_xml_str + "<OpenDate>"+CaseOpenDate+"</OpenDate>";
						add_xml_str = add_xml_str + "<CloseDate>"+CaseCloseDate+"</CloseDate>";
						add_xml_str = add_xml_str + "<CaseStatusCode>"+CaseStatusCode+"</CaseStatusCode>";
						add_xml_str = add_xml_str + "<InitialTotalClaimAmount>"+InitialTotalClaimAmount+"</InitialTotalClaimAmount></CourtCase>";
						CreditCard.mLogger.info("inside getCourtCase add_xml_str: "+ add_xml_str);
					}
				}
				catch(Exception ex)
				{CreditCard.mLogger.info("Exception in get getCourtCase" + ex.getMessage());
	...
	public static String getUtilization()
	{
		...
		//Deepak query updated to include account as well - 13/08/22
		String Query ="select CardEmbossNum,Utilizations24Months from ng_rlos_cust_extexpo_CardDetails with(nolock) where child_wi='"+formObject.getWFWorkitemName()+"' and (Utilizations24Months is not null or Utilizations24Months!='') union all select AgreementId,Utilizations24Months from ng_rlos_cust_extexpo_LoanDetails with(nolock) where child_wi='"+formObject.getWFWorkitemName()+"' and (Utilizations24Months is not null or Utilizations24Months!='') union all select AcctId,Utilizations24Months from ng_rlos_cust_extexpo_AccountDetails with(nolock) where child_wi='"+formObject.getWFWorkitemName()+"' and (Utilizations24Months is not null or Utilizations24Months!='')";
		String add_xml_str = "";
		try
		{
			List<List<String>> OutputXML = formObject.getDataFromDataSource(Query);
	...
	public boolean CombinedLimit_Eligibility(String card_product){
		...
		try{
			...
			CreditCard.mLogger.info("Exception in while retriving info regarding CombinedLimit_Eligibility" + e.getMessage());
		}
		return result_val;
	}
	public  String getSkywardNo(String skywardno){
		...
		try{
			...
			CreditCard.mLogger.info("getSkywardNo Exception in getSkywardNo custom function:  "+ex.getMessage());
		}
		return updatedSkyNO;
	...
	private Map<String, String> COMPLIANCE_CHECK_Custom(List<List<String>> DB_List,FormReference formObject,String callName,String Operation_name) {
		...
		Map<String, String> recordFileMap = new HashMap<String, String>();
				...
				try{
					//CreditCard.mLogger.info("Size of DB list ::"+DB_List.size());
					for(int j=0;j<DB_List.size();j++){
						List<String> mylist1=new ArrayList<String>();
						mylist1.addAll(DB_List.get(j));
						//CreditCard.mLogger.info("MyList ::"+mylist1);
						for (int i = 0; i < 8; i++) {
							
							//CreditCard.mLogger.info("Tags from DB:: "+col_n +" tags name::"+mylist1);	
							String[] col_name = col_n.split(",");
							recordFileMap.put(col_name[i], mylist1.get(i));
							
						}
						//CreditCard.mLogger.info("Tags from DB::"+recordFileMap.toString()+" :: "+DB_List);
						String parent_tag =  recordFileMap.get("parent_tag_name");
						String tag_name =  recordFileMap.get("xmltag_name");
						CreditCard.mLogger.info("Compliacnce check WINumber @sag"+tag_name.toString());
						if("ReferenceNo".equalsIgnoreCase(tag_name) )
						{
							CreditCard.mLogger.info("Compliacnce check WINumber");
							String WINumber="";//
							WINumber = formObject.getNGValue("CC_Wi_Name").split("-")[1];					
							...
							+"</"+ tag_name+">";
							int_xml.put(parent_tag, xml_str);
							CreditCard.mLogger.info("Compliacnce check WINumber"+ WINumber);
						}
							...
							else if("PassportExpiryDate".equalsIgnoreCase(tag_name) )
							{
								...
								PassportExpiry=new Common_Utils(CreditCard.mLogger).Convert_dateFormat(PassportExpiry, "dd/mm/yyyy", "dd-mm-yyyy");
								String xml_str = int_xml.get(parent_tag);
							...
							else if("DateOfBirthOrIncorporation".equalsIgnoreCase(tag_name) )
							{
								...
								DOB=new Common_Utils(CreditCard.mLogger).Convert_dateFormat(DOB, "dd/mm/yyyy", "dd-mm-yyyy");
								String xml_str = int_xml.get(parent_tag);
			...
			public static String getCustomerType(){
				...
				if(empttype!=null){	
					if (empttype.contains(NGFUserResourceMgr_CreditCard.getGlobalVar("CC_SelfEmployed"))){
						recordType="C";
					}				
					else {
						recordType="I";
