...
cmplx_DEC_VerificationRequired
	...
	public void formPopulated(FormEvent pEvent) 
	{
        ...
        try{
        	...
        	formObject.setNGValue("Mandatory_Frames", NGFUserResourceMgr_CreditCard.getGlobalVar("OV_Frame_Name"));
	...
	public void saveFormStarted(FormEvent pEvent) throws ValidatorException {
		...
		if("Approve".equalsIgnoreCase(formObject.getNGValue("cmplx_DEC_Decision"))){
			CreditCard.mLogger.info( "Inside Approve SFS OV WI: "+formObject.getWFWorkitemName());
			CreditCard.mLogger.info( "Value of ORIGINAL_VALIDATION is : "+formObject.getNGValue("ORIGINAL_VALIDATION"));
	...
	public void submitFormStarted(FormEvent pEvent) throws ValidatorException {
		...
		CreditCard.mLogger.info( "Inside PL OV_dec submitFormStarted()" +formObject.getNGValue("OV_dec"));
			 
		CreditCard.mLogger.info( "Inside SFS OV WI: "+formObject.getNGValue("cmplx_DEC_Decision"));
		...
		if("Approve".equalsIgnoreCase(formObject.getNGValue("cmplx_DEC_Decision"))){
			...
			CreditCard.mLogger.info( "Inside Reject SFS OV WI: "+formObject.getWFWorkitemName());
		...
		CreditCard.mLogger.info( "Value of ORIGINAL_VALIDATION is : "+formObject.getNGValue("ORIGINAL_VALIDATION"));
			...
			CreditCard.mLogger.info( "Inside Exception submitFormstarted");
		}
		finally{
		...
		*/
		...
		//	formObject.setLocked("AltContactDetails_Frame1",true);
			...
			else if(!formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0,2).equalsIgnoreCase("IM"))
			{
				...
				formObject.setEnabled("CardDetails_Frame1",true);
			}
