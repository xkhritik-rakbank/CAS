...
public class CC_Telesales_Agent extends CC_Common implements FormListener
{
	...
	public void formPopulated(FormEvent pEvent) 
	{
		try{
			...
			//added by gaurav
			CreditCard.mLogger.info( "Customer_Consents:  telesalesagent cc");
			if("IM".equals(formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0, 2)))
			{		
				CreditCard.mLogger.info( "Customer_Consents:  telesalesagent cc before adjustframe");
				formObject.setVisible("Customer_Consents_container", true);
				adjustFrameTops("KYC_container,OECD_container,ReferenceDetails_container,Customer_Consents");
				CreditCard.mLogger.info( "Customer_Consents:  telesalesagent cc after adjustframe");
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
		...
		//	formObject.setLocked("Customer_Frame1",true);
			...
			loadPicklist4();
			//deepak to enable LOB, LOS and save button -- 06/06/2022
			formObject.setEnabled("cmplx_EmploymentDetails_DOJ",true);
			...
			//deepak to enable tenor, interest rate and save button -- 06/06/2022
