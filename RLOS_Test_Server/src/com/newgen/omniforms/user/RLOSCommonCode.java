...
if("Primary".equalsIgnoreCase(formObject.getNGValue("cmplx_DecisionHistory_MultipleApplicantsGrid",formObject.getSelectedIndex("cmplx_DecisionHistory_MultipleApplicantsGrid"), 0))){
			...
			else if("Customer_save".equalsIgnoreCase(pEvent.getSource().getName()))
			{
				...
				String resukt[] = formObject.saveFragment("EmploymentDetails");
				RLOS.mLogger.info("Inside customer save result"+resukt);
			...
			{			
				...
				formObject.saveFragment("FATCA_container");
		...
		//Added by Prabhakar drop-4 point-3
			...
			//Modified by Prabhakar drop-4 point-3
				...
				formObject.saveFragment("KYC_container");
				popupFlag = "Y";
				...
				formObject.saveFragment("OECD_container");
				popupFlag = "Y";
				...
				formObject.saveFragment("ReferenceDetails_container");
				popupFlag = "Y";
