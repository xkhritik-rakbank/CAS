...
<%
	...
	String sQuery = "select CifId,AcctId from ng_RLOS_CUSTEXPOSE_AcctDetails where Wi_Name ='"+wi_name+"' ";
		 ...
		 Map<Integer, String> map = tagValuesMap;
		  for (Map.Entry<Integer, String> entry : map.entrySet())
		  {
			  ...
			  if(cifValues.equalsIgnoreCase(""))
				  cifValues = val_child_arr[0]+":"+val_child_arr[1];
			  else
				  cifValues =cifValues+","+val_child_arr[0]+":"+val_child_arr[1];
