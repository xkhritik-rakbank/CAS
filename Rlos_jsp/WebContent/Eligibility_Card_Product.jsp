...
function fetchGridData()
{
	...
	var sQry="";
		if(activityName=='CA'){//RLOS
			 sQry="select s_no,Product,Card_Product,'',Eligible_Card,final_limit,Decision,Declined_Reason,Deviation_Code_Refer,'',Delegation_Authorithy,Score_Grade,CC_Waiver FROM  "+table_name+" with (nolock) WHERE wi_name = '"+winame+"'";
		}
		else{
