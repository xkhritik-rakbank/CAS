	...
	<head>
		...
		function integ( btn_id ) {
			...
			var finalxmlResponse = null;
				$.ajax({
					type: "GET",
					url: "/webdesktop/resources/scripts/MultipleCardNo.jsp",
				...
				var req_name_arr = req_name.split(',');
					for (var i=0;i<req_name_arr.length;i++)
					{
						...
						$.ajax({
							...
							data: { request_name: req_name_arr[i], is_mobility : "N", SeesionId:sessionId ,wi_name:wi_name ,activityName:activityName ,param_json:param_json, cardNo:cardNo} ,
							dataType: "text",
							async: true,
							success: function (response) {
