...
public class RLOS_Query extends RLOSCommon implements FormListener
{
	...
	public void call_Frame_Expanded(ComponentEvent pEvent)
	{
		...
		else if ("CompanyDetails".equalsIgnoreCase(pEvent.getSource().getName())) 
		{
			...
			if("BTC".equalsIgnoreCase(formObject.getNGValue("Subproduct_productGrid"))){
				formObject.setVisible("CompanyDetails_Label8", true);
				formObject.setVisible("CompanyDetails_effecLOB", true);	

			}

			else if("Se".equalsIgnoreCase(formObject.getNGValue("Subproduct_productGrid"))/* && formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",i,9).equalsIgnoreCase("Primary")*/){
       ...
       {        
		...
		else if ("CardDetails".equalsIgnoreCase(pEvent.getSource().getName())) 
		{
			...
			if("BTC".equalsIgnoreCase(formObject.getNGValue("Subproduct_productGrid")) || "Se".equalsIgnoreCase(formObject.getNGValue("Subproduct_productGrid"))){
		...
		else if ("Supplementary_Container".equalsIgnoreCase(pEvent.getSource().getName())) 
		{
			...
			if ("Salaried pensioner".equalsIgnoreCase(formObject.getNGValue("empType"))){
		...
		else if ("CustomerDocumentsContainer".equalsIgnoreCase(pEvent.getSource().getName()))
		{
		...
		else if ("OutgoingDocumentsContainer".equalsIgnoreCase(pEvent.getSource().getName()))
		{
		...
		else if ("DecisioningFields".equalsIgnoreCase(pEvent.getSource().getName()))
		{
		...
		else if ("DeviationHistoryContainer".equalsIgnoreCase(pEvent.getSource().getName()))
		{
	...
	public void call_Fragement_Loaded(ComponentEvent pEvent)
	{
		...
		if("M".equalsIgnoreCase(formObject.getNGValue("initiationChannel")) ){
			...
			if ("Customer".equalsIgnoreCase(pEvent.getSource().getName())) {
				...
				else if("FZD".equalsIgnoreCase(formObject.getNGValue("cmplx_EmploymentDetails_targetSegCode")) || "FZE".equalsIgnoreCase(formObject.getNGValue("cmplx_EmploymentDetails_targetSegCode"))){
				...
				if("Credit Card".equalsIgnoreCase(formObject.getNGValue("Product_Type"))){
	...
	public void call_Value_Changed(ComponentEvent pEvent)
	{
		...
		if ("SubProd".equalsIgnoreCase(pEvent.getSource().getName())){
			...
			if ("Credit Card".equalsIgnoreCase(req_prod)){
				if("PU".equalsIgnoreCase(subprod)||"IM".equalsIgnoreCase(subprod)||"PULI".equalsIgnoreCase(subprod)||"LI".equalsIgnoreCase(subprod))
				{
		...
		if ("AppType".equalsIgnoreCase(pEvent.getSource().getName()))
		{
			...
			if (("Conventional".equalsIgnoreCase(TypeofProduct))&& "EXP".equalsIgnoreCase(subprod)&&("NEWE".equalsIgnoreCase(apptype))){
			...
			if (("Conventional".equalsIgnoreCase(TypeofProduct)&&"EXP".equalsIgnoreCase(subprod))&&("TOPE".equalsIgnoreCase(apptype))){
			...
			if (("Conventional".equalsIgnoreCase(TypeofProduct)&&"EXP".equalsIgnoreCase(subprod))&&("RESCE".equalsIgnoreCase(apptype))){
			...
			if (("Conventional".equalsIgnoreCase(TypeofProduct)&& "NAT".equalsIgnoreCase(subprod))&&("TOPN".equalsIgnoreCase(apptype))){
			...
			if (("Conventional".equalsIgnoreCase(TypeofProduct)&&"NAT".equalsIgnoreCase(subprod))&&("TKON".equalsIgnoreCase(apptype))){
			...
			if (("Conventional".equalsIgnoreCase(TypeofProduct)&&"NAT".equalsIgnoreCase(subprod))&&("NEWN".equalsIgnoreCase(apptype))){
			...
			if (("Conventional".equalsIgnoreCase(TypeofProduct)&&"NAT".equalsIgnoreCase(subprod))&&("RESCN".equalsIgnoreCase(apptype))){
			...
			if (("Islamic".equalsIgnoreCase(TypeofProduct))&& "EXP".equalsIgnoreCase(subprod)&&("TKOE".equalsIgnoreCase(apptype))){
			...
			if (("Islamic".equalsIgnoreCase(TypeofProduct))&& "EXP".equalsIgnoreCase(subprod)&&("NEWE".equalsIgnoreCase(apptype))){
				RLOS.mLogger.info( "2Value of AppType is:"+formObject.getNGValue("AppType"));
				formObject.clear("Scheme");
				formObject.setNGValue("Scheme","--Select--");
			...
			if (("Islamic".equalsIgnoreCase(TypeofProduct)&&"EXP".equalsIgnoreCase(subprod))&&("TOPE".equalsIgnoreCase(apptype))){
				RLOS.mLogger.info( "3Value of AppType is:"+formObject.getNGValue("AppType"));
			...
			if (("Islamic".equalsIgnoreCase(TypeofProduct)&&"EXP".equalsIgnoreCase(subprod))&&("RESCE".equalsIgnoreCase(apptype))){
				RLOS.mLogger.info( "4Value of AppType is:"+formObject.getNGValue("AppType"));
			...
			if (("Islamic".equalsIgnoreCase(TypeofProduct)&& "NAT".equalsIgnoreCase(subprod))&&("TOPN".equalsIgnoreCase(apptype))){
				RLOS.mLogger.info( "5Value of AppType is:"+formObject.getNGValue("AppType"));
				formObject.clear("Scheme");
				formObject.setNGValue("Scheme","--Select--");
			...
			if (("Islamic".equalsIgnoreCase(TypeofProduct)&&"NAT".equalsIgnoreCase(subprod))&&("TKON".equalsIgnoreCase(apptype))){
				RLOS.mLogger.info( "6Value of AppType is:"+formObject.getNGValue("AppType"));
				formObject.clear("Scheme");
				formObject.setNGValue("Scheme","--Select--");
			...
			if (("Islamic".equalsIgnoreCase(TypeofProduct)&&"NAT".equalsIgnoreCase(subprod))&&("NEWN".equalsIgnoreCase(apptype))){
				RLOS.mLogger.info( "7Value of AppType is:"+formObject.getNGValue("AppType"));
				formObject.clear("Scheme");
				formObject.setNGValue("Scheme","--Select--");
			...
			if (("Islamic".equalsIgnoreCase(TypeofProduct)&&"NAT".equalsIgnoreCase(subprod))&&("RESCN".equalsIgnoreCase(apptype))){
				RLOS.mLogger.info( "8Value of AppType is:"+formObject.getNGValue("AppType"));
				formObject.clear("Scheme");
				formObject.setNGValue("Scheme","--Select--");
