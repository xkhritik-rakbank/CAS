...
public class CC_Fulfillment_RM extends CC_Common implements FormListener
{
	/**
	 * 
	 */
	...
	public void formLoaded(FormEvent pEvent)
	{
		...
		SKLogger_CC.writeLog("CC Fullfillment", "Inside formLoaded()" + pEvent.getSource().getName());
	...
	{
	     try{
	    	 SKLogger_CC.writeLog("CC Fullfillment","Inside CC_Fullfillment CC");
	...
	public void eventDispatched(ComponentEvent pEvent) throws ValidatorException {
		String alert_msg="";
		SKLogger_CC.writeLog("Inside CC_Fullfillment eventDispatched()", "EventName:" + pEvent.getType() + "#ControlName#" + pEvent.getSource().getName());
	  formObject =FormContext.getCurrentInstance().getFormReference();

      switch(pEvent.getType()) {

          case FRAME_EXPANDED:
				SKLogger_CC.writeLog(" In CC_Fullfillment eventDispatched()", "EventName:" + pEvent.getType() + "#ControlName#" + pEvent.getSource().getName());
          ...
          case FRAGMENT_LOADED:
			...
			case MOUSE_CLICKED:
				...
				if(pEvent.getSource().getName().equalsIgnoreCase("Customer_save")){
					SKLogger_CC.writeLog("CC_Fullfillment", "Inside Customer_save button: ");
					...
					SKLogger_CC.writeLog(" In CC_Fullfillment eventDispatched()", "EventName:" + pEvent.getType() + "#ControlName#" + pEvent.getSource().getName());
					 if (pEvent.getSource().getName().equalsIgnoreCase("cmplx_DEC_Decision")) {
						 if(formObject.getWFActivityName().equalsIgnoreCase("CAD_Analyst1"))	
						 {
							...
							SKLogger_CC.writeLog(" In CC_Fullfillment VALChanged---New Value of CAD_dec is: ", formObject.getNGValue("cmplx_DEC_Decision"));
							...
							SKLogger_CC.writeLog(" In CC_Fullfillment VALChanged---New Value of decision is: ", formObject.getNGValue("cmplx_DEC_Decision"));
						 	  }
					 	}
	...
	public void initialize() {
		SKLogger_CC.writeLog("PersonnalLoanS>  CC_Fullfillment", "Inside PL PROCESS initialize()" );
		  formObject =FormContext.getCurrentInstance().getFormReference();
	...
	public void saveFormCompleted(FormEvent pEvent) throws ValidatorException {
		SKLogger_CC.writeLog("PersonnalLoanS>  CC_Fullfillment", "Inside PL PROCESS saveFormCompleted()" + pEvent.getSource());
		  formObject =FormContext.getCurrentInstance().getFormReference();
	...
	public void saveFormStarted(FormEvent pEvent) throws ValidatorException {
		  formObject =FormContext.getCurrentInstance().getFormReference();
		SKLogger_CC.writeLog("PersonnalLoanS>  CC_Fullfillment", "Inside PL PROCESS saveFormStarted()" + pEvent.getSource());
	...
	public void submitFormCompleted(FormEvent pEvent) throws ValidatorException {
		SKLogger_CC.writeLog("PersonnalLoanS>  CC_Fullfillment", "Inside PL PROCESS submitFormCompleted()" + pEvent.getSource());
		
	}

	
	public void submitFormStarted(FormEvent pEvent) throws ValidatorException {
		SKLogger_CC.writeLog("PersonnalLoanS>  CC_Fullfillment", "Inside PL PROCESS submitFormStarted()" + pEvent.getSource());
