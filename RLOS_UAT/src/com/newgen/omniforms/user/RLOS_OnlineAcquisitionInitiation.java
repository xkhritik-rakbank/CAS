...

{
	...
	{
		System.out.println("Inside OnlineAcquisitionInitiation RLOS");
		SKLogger.writeLog("RLOS Online Acquisition Initiation", "Inside formLoaded()" + pEvent.getSource().getName());
		
	}
	public void formPopulated(FormEvent pEvent) {
        FormReference formObject = FormContext.getCurrentInstance().getFormReference();
        try{
            System.out.println("Inside Online Acquisition Initiation RLOS");
            SKLogger.writeLog("RLOS Online Acquisition Initiation", "Inside formPopulated()" + pEvent.getSource());
            SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
            String currDate = format.format(Calendar.getInstance().getTime());
             SKLogger.writeLog("RLOS Online Acquisition Initiation", "currTime:" + currDate);
        ...
        {
            SKLogger.writeLog("RLOS Online Acquisition Initiation", "Exception:"+e.getMessage());
        }
    }
			...
			if (pEvent.getSource().getName().equalsIgnoreCase("IncomingDocuments"))
			  {
				  HashMap<String,String> hm= new HashMap<String,String>(); // not nullable HashMap
					...
					popupFlag="N";
					 SKLogger.writeLog("RLOS Online Acquisition Initiation Inside ","IncomingDocuments");
			 ...
			 if (pEvent.getSource().getName().equalsIgnoreCase("DeferralDocuments")) 
		        {
					...
					popupFlag="N";
					SKLogger.writeLog("RLOS Online Acquisition Initiation eventDispatched()","DeferralDocuments");
	...
	public void saveFormCompleted(FormEvent pEvent) {
		SKLogger.writeLog("RLOS Online Acquisition Initiation","inside saveFormCompleted()" + pEvent);
	...
	public void submitFormCompleted(FormEvent pEvent)
		...
		SKLogger.writeLog("RLOS Online Acquisition Initiation", "Inside submitFormCompleted()" + pEvent);


	}

	public void continueExecution(String eventHandler, HashMap<String, String> m_mapParams) {
		SKLogger.writeLog("RLOS Online Acquisition Initiation", "Inside continueExecution()" + eventHandler);
	}
