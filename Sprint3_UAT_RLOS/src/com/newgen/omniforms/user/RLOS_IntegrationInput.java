	...
	public String dummyResponse(String callName)
	{
		...
		if(("CUSTOMER_DETAILS").equalsIgnoreCase(callName))
		{
			...
			if("Credit Card".equalsIgnoreCase(prod))
				response="<APMQPUTGET_Output><MQ_RESPONSE_XML><?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Header><ServiceId>CallProcessManager</ServiceId><ServiceType>ProductEligibility</ServiceType><ServiceProviderId>DECTECH</ServiceProviderId><ServiceChannelId>CAS</ServiceChannelId><RequestID>CAS16456285350842</RequestID><TimeStampyyyymmddhhmmsss>2022-02-23T19:02:20.439</TimeStampyyyymmddhhmmsss><RequestLifeCycleStage>CallProcessManagerResponse</RequestLifeCycleStage><MessageStatus>Success</MessageStatus></soap:Header><soap:Body><CallProcessManagerResponse xmlns=\"http://tempuri.org/\"><CallProcessManagerResult><ProcessManagerResponse><Application><Channel>CC</Channel><CallType>PM</CallType><ApplicationNumber>CAS-0000067073-PROCESS</ApplicationNumber><ReturnDateTime>20220223190219</ReturnDateTime><SystemErrorCode></SystemErrorCode><SystemErrorMessage></SystemErrorMessage><ReturnError RecordNumber=\"0\" /></Application><Instinct_Actions><Instinct_Action_Output_XML /></Instinct_Actions><PM_Results><Random_Number>366</Random_Number><DBR>0.00</DBR><Decision_Results name=\"MAC\"><PM_Decision_Results_Data><PM_Decision_Results><AppKey>CAS-0000067073-PROCESSCC</AppKey><Decision_Objective>1</Decision_Objective><Decision_Sequence_Number>1</Decision_Sequence_Number><Last_Update_Date>2022-02-23T19:02:17.373+04:00</Last_Update_Date><Default_Decision>A</Default_Decision><Default_Reason>A999 - System Approve</Default_Reason><Default_Document>0</Default_Document><System_Decision>A</System_Decision><System_Document>0</System_Document> <Decision_Node_Id>2.1</Decision_Node_Id><Decision_Test_Group>0</Decision_Test_Group></PM_Decision_Results></PM_Decision_Results_Data><PM_Reason_Codes_Data><PM_Reason_Codes><Decision_Objective>1</Decision_Objective><Decision_Sequence_Number>1</Decision_Sequence_Number><Sequence_Number>1</Sequence_Number><Reason_Decision>A</Reason_Decision><Reason_Code>A999</Reason_Code><Reason_Description>System Approve</Reason_Description><Criteria_Name /><Letter_Code /><Document /><Letter_Reason /></PM_Reason_Codes></PM_Reason_Codes_Data></Decision_Results><Strategy_Results name=\"Eligibility\"><PM_Strategy_MaxLendingAmount_Data><PM_Strategy_MaxLendingAmount_Results><Policy_Number>1</Policy_Number><Adjustment_Number>0</Adjustment_Number><Max_Lending_Amount>130900.00</Max_Lending_Amount><Last_Update_Date>2022-02-23T19:02:17.697+04:00</Last_Update_Date><Entry_Name>Output TAI Multiplier 4.5 Max 150000</Entry_Name><Use_Requested_Limit_Flag>false</Use_Requested_Limit_Flag><Existing_Limit_Increase_Flag>false</Existing_Limit_Increase_Flag><Limit_Increase_Percent>0.00</Limit_Increase_Percent><Use_Characteristic_As_Limit_Flag>true</Use_Characteristic_As_Limit_Flag><Limit_Table_Id>1</Limit_Table_Id><Limit_Field_Number>22</Limit_Field_Number><Use_Characteristic_As_Limit_Multiplier>4.500</Use_Characteristic_As_Limit_Multiplier><Fixed_Amount_Flag>false</Fixed_Amount_Flag><Fixed_Amount>0</Fixed_Amount><Base_Percentage_Increase_Flag>false</Base_Percentage_Increase_Flag><Base_Percentage_Increase_Percent>0.00</Base_Percentage_Increase_Percent><Limit_Minimum>0</Limit_Minimum><Limit_Maximum>150000</Limit_Maximum><Limit_Rounding_Factor1>100</Limit_Rounding_Factor1><Limit_Rounding_Factor2>100</Limit_Rounding_Factor2><Limit_Rounding_Factor3>100</Limit_Rounding_Factor3><Limit_Rounding_Factor4>100</Limit_Rounding_Factor4><Limit_Rounding_Cutoff1>100000</Limit_Rounding_Cutoff1><Limit_Rounding_Cutoff2>200000</Limit_Rounding_Cutoff2><Limit_Rounding_Cutoff3>300000</Limit_Rounding_Cutoff3><Limit_Reason_Code /><Max_Limit_Table_Id>0</Max_Limit_Table_Id><Max_Limit_Field_Number>0</Max_Limit_Field_Number><Max_Limit_Multiplier>0.00</Max_Limit_Multiplier><Use_Round_Up_Factor1_Flag>false</Use_Round_Up_Factor1_Flag><Use_Round_Up_Factor2_Flag>false</Use_Round_Up_Factor2_Flag><Use_Round_Up_Factor3_Flag>false</Use_Round_Up_Factor3_Flag><Use_Round_Up_Factor4_Flag>false</Use_Round_Up_Factor4_Flag><Strategy_Node_Id>1.2.2.4.2.2.2.2</Strategy_Node_Id><Strategy_Test_Group>0</Strategy_Test_Group><Tree_Error_Field_Label /><Tree_Error_Field_Value /></PM_Strategy_MaxLendingAmount_Results></PM_Strategy_MaxLendingAmount_Data></Strategy_Results><Strategy_Results name=\"Interest Rate\"><PM_Strategy_PricingTerm_Data><PM_Strategy_PricingTerm_Results><Last_Update_Date>2022-02-23T19:02:17.74+04:00</Last_Update_Date><Entry_Name>Zero</Entry_Name><Interest_Rate>0.00</Interest_Rate><Max_Loan_Term>0</Max_Loan_Term><Strategy_Node_Id>2</Strategy_Node_Id><Strategy_Test_Group>0</Strategy_Test_Group></PM_Strategy_PricingTerm_Results></PM_Strategy_PricingTerm_Data></Strategy_Results><Scoring_Results name=\"Recalculation\"><PM_Scoring_Results_Data><PM_Scoring_Results><Scoring_Sequence_Number>1</Scoring_Sequence_Number><Scoring_Objective>2</Scoring_Objective><Last_Update_Date>2022-02-23T19:02:17.783+04:00</Last_Update_Date><Score>0.000000</Score><Score_Node_Id>1</Score_Node_Id><Scorecard_Id>Null Scorecard</Scorecard_Id><Grade>0</Grade><Score_Test_Group>0</Score_Test_Group></PM_Scoring_Results></PM_Scoring_Results_Data></Scoring_Results><Scoring_Results name=\"Application Score\"><PM_Scoring_Results_Data><PM_Scoring_Results><Scoring_Sequence_Number>1</Scoring_Sequence_Number><Scoring_Objective>1</Scoring_Objective><Last_Update_Date>2022-02-23T19:02:18.337+04:00</Last_Update_Date><Score>587.000000</Score><Score_Node_Id>2.1.1</Score_Node_Id><Scorecard_Id>MCF New Score Card</Scorecard_Id><Grade>0</Grade><Score_Test_Group>0</Score_Test_Group></PM_Scoring_Results></PM_Scoring_Results_Data></Scoring_Results><Decision_Results name=\"Eligibility Decision\"><PM_Decision_Results_Data><PM_Decision_Results><AppKey>CAS-0000067073-PROCESSCC</AppKey><Decision_Objective>2</Decision_Objective><Decision_Sequence_Number>1</Decision_Sequence_Number><Last_Update_Date>2022-02-23T19:02:18.95+04:00</Last_Update_Date><Default_Decision>A</Default_Decision><Default_Reason>A999 - System Approve</Default_Reason><Default_Document>0</Default_Document><System_Decision>A</System_Decision><System_Document>0</System_Document><Decision_Node_Id>2.1</Decision_Node_Id><Decision_Test_Group>0</Decision_Test_Group></PM_Decision_Results></PM_Decision_Results_Data><PM_Reason_Codes_Data><PM_Reason_Codes><Decision_Objective>2</Decision_Objective><Decision_Sequence_Number>1</Decision_Sequence_Number><Sequence_Number>1</Sequence_Number><Reason_Decision>A</Reason_Decision><Reason_Code>A999</Reason_Code><Reason_Description>System Approve</Reason_Description><Criteria_Name /><Letter_Code /><Document /><Letter_Reason /></PM_Reason_Codes></PM_Reason_Codes_Data></Decision_Results><Strategy_Results name=\"Additional Eligible Cards\"><PM_Strategy_Verification_Data><PM_Strategy_Verification_Results><Last_Update_Date>2022-02-23T19:02:19.053+04:00</Last_Update_Date><Entry_Name>Eligible Cards Expat</Entry_Name><Number_Of_Visits>0</Number_Of_Visits><Visits><Code>1</Code><Type_Of_Visit>KALYAN-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>108</Code><Type_Of_Visit>EKWEC-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>11</Code><Type_Of_Visit>MRBH GOLD EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>110</Code><Type_Of_Visit>EKWEI-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>16</Code><Type_Of_Visit>MRBH PLTM EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>23</Code><Type_Of_Visit>MRBH WORLD EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>28</Code><Type_Of_Visit>MY RAK CARD-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>33</Code><Type_Of_Visit>MY RAK ISLAMIC-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>38</Code><Type_Of_Visit>REDCARD-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>48</Code><Type_Of_Visit>TITANIUM-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>53</Code><Type_Of_Visit>VCLASSIC-EXPATRIATE</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>57</Code><Type_Of_Visit>VGOLD-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>6</Code><Type_Of_Visit>MPL-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>62</Code><Type_Of_Visit>WORLD-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>69</Code><Type_Of_Visit>MCBAA-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>76</Code><Type_Of_Visit>MCBPC-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Visits><Code>83</Code><Type_Of_Visit>MCBWE-EXPAT</Type_Of_Visit><Mandatory_Flag>False</Mandatory_Flag></Visits><Number_Of_Calls>0</Number_Of_Calls><Calls><Code></Code><Type_Of_Call></Type_Of_Call><Mandatory_Flag></Mandatory_Flag></Calls><Strategy_Node_Id>2.1.2.2.2.4.2.1</Strategy_Node_Id><Strategy_Test_Group>0</Strategy_Test_Group> </PM_Strategy_Verification_Results></PM_Strategy_Verification_Data></Strategy_Results></PM_Results><PM_Outputs><Application><Is_Banking_Customer>N</Is_Banking_Customer><Is_New_Score_Card>YES</Is_New_Score_Card><Is_Refer_Designation>N</Is_Refer_Designation><Output_Accommodation_Allowance>0.00</Output_Accommodation_Allowance><Output_Additional_Amount>120000.00</Output_Additional_Amount><Output_Affordable_EMI>10445.00</Output_Affordable_EMI><Output_AVG_EMI_Client>0.00</Output_AVG_EMI_Client><Output_AVG_EMI_Policy>0.00</Output_AVG_EMI_Policy><Output_BBG_Existing_DBR>0.00</Output_BBG_Existing_DBR><Output_BBG_Final_DBR>0.00</Output_BBG_Final_DBR><Output_CFF_Client>0.00</Output_CFF_Client><Output_CFF_Policy>0.00</Output_CFF_Policy><Output_CPV_Waiver>N</Output_CPV_Waiver><Output_Decision>A</Output_Decision><Output_Delegation_Authority>MGR</Output_Delegation_Authority><Output_Eligible_Amount>130900.00</Output_Eligible_Amount><Output_Eligible_Amount_Path>Max Lending Amount Sub Process Type Segmentation CC [SAL]\\NOT CC Minimum AECB Score requirement not met\\NOT Salaried AECB No Hit Flag\\Max Lending Amount Target Segment Code [Others]\\NOT UAE National Test program\\NOT Employee type SP or not confirmed in job with LOS LT 6\\No Months AECB History [&amp;gt;= 12]\\Output TAI Segmentation [25000 - 34999.99]</Output_Eligible_Amount_Path><Output_Eligible_Cards>[{\"Card_Product\":\"EKWMC-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"KALYAN-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"EKWEC-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"MRBH GOLD EXPAT\",\"Credit_Limit\":0.00,\"Flag\":\"N\"},{\"Card_Product\":\"EKWEI-EXPAT\",\"Credit_Limit\":0.00,\"Flag\":\"N\"},{\"Card_Product\":\"MRBH PLTM EXPAT\",\"Credit_Limit\":0.00,\"Flag\":\"N\"},{\"Card_Product\":\"MRBH WORLD EXPAT\",\"Credit_Limit\":0.00,\"Flag\":\"N\"},{\"Card_Product\":\"MY RAK CARD-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"MY RAK ISLAMIC-EXPAT\",\"Credit_Limit\":0.00,\"Flag\":\"N\"},{\"Card_Product\":\"REDCARD-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"TITANIUM-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"VCLASSIC-EXPATRIATE\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"VGOLD-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"MPL-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"WORLD-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"MCBAA-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"MCBPC-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"},{\"Card_Product\":\"MCBWE-EXPAT\",\"Credit_Limit\":120000.00,\"Flag\":\"N\"}]</Output_Eligible_Cards><Output_Eligible_Multiple>0.000</Output_Eligible_Multiple><Output_Existing_DBR>14.10</Output_Existing_DBR><Output_Final_Amount>120000.00</Output_Final_Amount><Output_Final_DBR>26.47</Output_Final_DBR><Output_Interest_Rate>0.00</Output_Interest_Rate><Output_Loan_Client>0.00</Output_Loan_Client><Output_Loan_Eligibility>0.00</Output_Loan_Eligibility><Output_Loan_Policy>0.00</Output_Loan_Policy><Output_Net_Salary_DBR>26.47</Output_Net_Salary_DBR><Output_NTC_Amount>0.00</Output_NTC_Amount><Output_Num_Eligible_Cards>9</Output_Num_Eligible_Cards><Output_Salary_Multiples>4.12</Output_Salary_Multiples><Output_TAI>29092.00</Output_TAI></Application></PM_Outputs></ProcessManagerResponse></CallProcessManagerResult></CallProcessManagerResponse></soap:Body></soap:Envelope></MQ_RESPONSE_XML></APMQPUTGET_Output>";
				else
		...
		try{
			...
			else
			{
				for (int i = 0; i<OutputXML.size();i++)
				{
					...
					RLOS.mLogger.info("EnquiryDate :" + EnquiryDate);
					
					String enquire_date_format = EnquiryDate;
					...
					try{
						...
						enquire_date_format = formatter.format(parseDateCC);
						RLOS.mLogger.info("MaxOverdueAmountDateFormat :" + enquire_date_format);
					}
					catch(Exception e){
						RLOS.mLogger.info("Exception occured in conversion of MaxOverDueAmountDate :" + e.getMessage());
					}
					...
					add_xml_str = add_xml_str + "<aecb_score>"+aecb_score+"</aecb_score>";
					add_xml_str = add_xml_str + "<range>"+range+"</range>";
					add_xml_str = add_xml_str + "<AECB_Enquiry_date>"+enquire_date_format+"</AECB_Enquiry_date>";
	...
	public String ExternalBureauIndividualProducts() throws ParseException{
		...
		for (int i = 0; i<OutputXML.size();i++){
         ...
         //PCASI-1096 by shweta
			...
			if (!(OutputXML.get(i).get(34) == null || OutputXML.get(i).get(34).equals(""))){  // added by deepanshu
				MaximumOverDueAmount = OutputXML.get(i).get(34).toString();
			}
			...
			if (!(OutputXML.get(i).get(35) == null || OutputXML.get(i).get(35).equals(""))){  // added by deepanshu
				Pmtfreq = OutputXML.get(i).get(35).toString();
			}
			
			if (!(OutputXML.get(i).get(36) == null || OutputXML.get(i).get(36).equals(""))){  // added by deepanshu
				MaxOverdueAmountDate = OutputXML.get(i).get(36).toString();
			}
			// changes here for change date format by deepanshu	
			
			RLOS.mLogger.info("MaxOverdueAmountDate :" + MaxOverdueAmountDate);
			
			Date parseDate = new SimpleDateFormat("dd-MM-yyyy").parse(MaxOverdueAmountDate);
			RLOS.mLogger.info("parseDate :" + parseDate);
			
			SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
			RLOS.mLogger.info("formatter :" + formatter);
			
			String MaxOverdueAmountDateFormat = formatter.format(parseDate);
			RLOS.mLogger.info("MaxOverdueAmountDateFormat :" + MaxOverdueAmountDateFormat);
				...
				if("PRIMARY".equalsIgnoreCase(formObject.getNGValue("cmplx_DecisionHistory_MultipleApplicantsGrid",formObject.getSelectedIndex("cmplx_DecisionHistory_MultipleApplicantsGrid"),0))){	
					...
					//Deepak Changes done for product Processor
						...
						if("Y".equalsIgnoreCase(formObject.getNGValue("is_cc_waiver_require"))){
							...
							ProductProcessor_val = "FINACLECORE,RLS";
							//ProductProcessor_val = "FINCORE,RLS,CAPS"; temp changes
						}
...
*/
...

	{
		...
		String Query ="select CardEmbossNum,replace(history,'Key','monthyear') as History from ng_rlos_cust_extexpo_CardDetails with(nolock) where wi_name='"+formObject.getWFWorkitemName()+"' and (History is not null or History!='') union all select AgreementId,replace(history,'Key','monthyear') as History from ng_rlos_cust_extexpo_LoanDetails with(nolock) where wi_name='"+formObject.getWFWorkitemName()+"' and (History is not null or History!='') union all select AcctId,replace(history,'Key','monthyear') as History from ng_rlos_cust_extexpo_AccountDetails with(nolock) where wi_name='"+formObject.getWFWorkitemName()+"' and (History is not null or History!='')";
		String add_xml_str = "";
		try
		{
	...
	public static String getCourtCase()
	{
		...
		String Query ="select CodOrganization,ProviderCaseNo,ReferenceDate," +
				"CaseCategoryCode,CaseOpenDate,CaseCloseDate,CaseStatusCode," +
				"InitialTotalClaimAmount from ng_rlos_cust_extexpo_CaseDetails where WI_NAME='"+ formObject.getWFWorkitemName()+"'";
		...
		try
		{
			...
			for (int i = 0; i < OutputXML.size(); i++) {
				...
				if (!(OutputXML.get(i).get(2) == null || OutputXML.get(i).get(2).equals(""))) {
					...
					CodOrganization = OutputXML.get(i).get(2).toString();
				}

				if (!(OutputXML.get(i).get(3) == null || OutputXML.get(i).get(3).equals(""))) {

					ProviderCaseNo = OutputXML.get(i).get(3).toString();
				}

				if (!(OutputXML.get(i).get(4) == null || OutputXML.get(i).get(4).equals(""))) {

					ReferenceDate = OutputXML.get(i).get(4).toString();
				}

				if (!(OutputXML.get(i).get(5) == null || OutputXML.get(i).get(5).equals(""))) {

					CaseCategoryCode = OutputXML.get(i).get(5).toString();
				}

				if (!(OutputXML.get(i).get(6) == null || OutputXML.get(i).get(6).equals(""))) {

					CaseOpenDate = OutputXML.get(i).get(6).toString();
				}

				if (!(OutputXML.get(i).get(7) == null || OutputXML.get(i).get(7).equals(""))) {

					CaseCloseDate = OutputXML.get(i).get(7).toString();
				}

				if (!(OutputXML.get(i).get(8) == null || OutputXML.get(i).get(8).equals(""))) {

					CaseStatusCode = OutputXML.get(i).get(8).toString();
				}

				if (!(OutputXML.get(i).get(9) == null || OutputXML.get(i).get(9).equals(""))) {

					InitialTotalClaimAmount = OutputXML.get(i).get(9).toString();
				}
		...
		{RLOS.mLogger.info("Exception in get getCourtCase" + ex.getMessage());
	...
	public static String getUtilization()
	{
		...
		//Deepak query updated to include account as well - 13/08/22
		String Query ="select CardEmbossNum,Utilizations24Months from ng_rlos_cust_extexpo_CardDetails with(nolock) where wi_name='"+formObject.getWFWorkitemName()+"' and (Utilizations24Months is not null or Utilizations24Months!='') union all select AgreementId,Utilizations24Months from ng_rlos_cust_extexpo_LoanDetails with(nolock) where wi_name='"+formObject.getWFWorkitemName()+"' and (Utilizations24Months is not null or Utilizations24Months!='') union all select AcctId,Utilizations24Months from ng_rlos_cust_extexpo_AccountDetails with(nolock) where wi_name='"+formObject.getWFWorkitemName()+"' and (Utilizations24Months is not null or Utilizations24Months!='')";
		String add_xml_str = "";
		try
		{
		List<List<String>> OutputXML = formObject.getDataFromDataSource(Query);
