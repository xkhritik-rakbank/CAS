...
public class RLOS_Customer_Hold extends RLOSCommon implements FormListener
{
	...
	}//AlternateContactDetails_MobileNo1
	public void formPopulated(FormEvent pEvent) 
	{
		...
		/*	formObject.setNGValue("RM_Name",getDataFromSourceCodeMaster("supervisor_name"));
			...
			if(formObject.getNGValue("Product_Type").contains(NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_PersonalLoan")) 
					&& formObject.getNGValue("cmplx_Customer_age")!=null &&  isCustomerMinor(formObject))
			{
			...
			{		
				...
				adjustFrameTops("KYC_container,OECD_container,ReferenceDetails_container,CustomerConsent");
	...
	public void saveFormCompleted(FormEvent pEvent) {
		//RLOS.mLogger.info( "Inside saveFormCompleted()" + pEvent);SOLID
