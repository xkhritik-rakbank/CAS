...
public class CC_Integration_Input extends Common implements java.io.Serializable{
	...
	public String getRVCDetails(){
		...
		try{
			...
			CreditCard.mLogger.info("PLCommon getCustAddress_details method"+ " Exception Occure in generate Address XMl"+ex.getMessage()+new CC_Common().printException(ex));
			return add_xml_str;
		}
	}
	/*          Function Header:
	...
	private Map<String, String> NEW_CUSTOMER_Custom(List<List<String>> DB_List,FormReference formObject,String callName) {
		...
		try{
			for (List<String> mylist : DB_List) {
				...
				if( "SUPPLEMENT".equalsIgnoreCase(formObject.getNGValue("cmplx_DEC_MultipleApplicantsGrid",formObject.getSelectedIndex("cmplx_DEC_MultipleApplicantsGrid"),0))){	
					if("PersonDetails".equalsIgnoreCase(tag_name)){
						...
						String xml_str = int_xml.get(parent_tag);
						String ph_no="";
						 if( "SUPPLEMENT".equalsIgnoreCase(formObject.getNGValue("cmplx_DEC_MultipleApplicantsGrid",formObject.getSelectedIndex("cmplx_DEC_MultipleApplicantsGrid"),0)) && formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid")>0){ 
							for(int i=0;i<formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid");i++){
								if(formObject.getNGValue("cmplx_DEC_MultipleApplicantsGrid",formObject.getSelectedIndex("cmplx_DEC_MultipleApplicantsGrid"), 2).equals(formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,3))){
		...
		try{
			for (List<String> mylist : DB_List) {
				...
				if("ReferenceDetails".equalsIgnoreCase(tag_name)){
					...
					String cardProd = formObject.getNGValue("CC_Creation_Product");
					String Ctype ="";
					String Query="select distinct CARDTYPE from ng_master_cardProduct where CODE = '"+cardProd+"'";
				...
				//below code by saurabh on 15th Dec 17
				 ...
				 else if( "SUPPLEMENT".equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),13)))
				 {
					 ...
					 if("CIFID".equalsIgnoreCase(tag_name) ){
							...
							CreditCard.mLogger.info("RLOS COMMON"+ " after adding supplement" + tag_name+" :"+xml_str);
							int_xml.put(parent_tag, xml_str);
						}
				...
				if("ReferenceDetails".equalsIgnoreCase(tag_name)){
					...
					if(int_xml.containsKey(parent_tag))
					{
						try{
							...
							if("SUPPLEMENT".equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),13)))
							{
								 for(int i=0;i<formObject.getLVWRowCount("SupplementCardDetails_cmplx_SupplementGrid");i++){
									 if(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),14).equals(formObject.getNGValue("SupplementCardDetails_cmplx_SupplementGrid",i,3)))
										 {
								...
								card_product = formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0,5);
				 ...
				 if( "PRIMARY".equalsIgnoreCase(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),13)))
				 {
				 if("PeriodicCashLimit".equalsIgnoreCase(tag_name) || "StatementCycle".equalsIgnoreCase(tag_name)){
	...
	public String getcontact_details(){
		...
		Contactdetails_xml_str = "<ContactDetails><PrefModeOfContact>Phone</PrefModeOfContact><PhnDet><PhoneType>MobileNumber1</PhoneType><PhnCountryCode>971</PhnCountryCode><CityCode></CityCode><PhnLocalCode>00971</PhnLocalCode>";
		try{
			FormReference formObject = FormContext.getCurrentInstance().getFormReference();
			if("PRIMARY".equals(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),13)))
			{
				Contactdetails_xml_str=Contactdetails_xml_str+"<PhoneNumber>"+formObject.getNGValue("cmplx_Customer_MobileNo")+"</PhoneNumber>";
			...
			else if( formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),13).equalsIgnoreCase("Supplement") && formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid")>0){ 
				 for(int i=0;i<formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid");i++){
					 if(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),14).equals(formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,3)))
						 {
							...
							Contactdetails_xml_str = Contactdetails_xml_str+"<CityCode></CityCode><PhnLocalCode>00971</PhnLocalCode><PhoneNumber></PhoneNumber><PhnPrefFlag>N</PhnPrefFlag></PhnDet></ContactDetails>";
		...
		try{
			...
			if (add_row_count>=0){
				...
				if(Call_name.equalsIgnoreCase("CARD_SERVICES_REQUEST")){
					...
					if(!(Lien_maturity_date.equals("") || Lien_maturity_date.equals(null))){
		 ...
		 if( "SUPPLEMENT".equalsIgnoreCase(formObject.getNGValue("cmplx_DEC_MultipleApplicantsGrid",formObject.getSelectedIndex("cmplx_DEC_MultipleApplicantsGrid"),0)) && formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid")>0){ 
			for(int i=0;i<formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid");i++){
				if(formObject.getNGValue("cmplx_DEC_MultipleApplicantsGrid",formObject.getSelectedIndex("cmplx_DEC_MultipleApplicantsGrid"), 2).equals(formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,3))){
					...
					str=str+"<MaritalStatus></MaritalStatus>";
	...
	public String getSupplement_DocDetails(FormReference formObject,String callName){
		...
		if(callName.equalsIgnoreCase("NEW_CUSTOMER_REQ")){
		 if( "SUPPLEMENT".equalsIgnoreCase(formObject.getNGValue("cmplx_DEC_MultipleApplicantsGrid",formObject.getSelectedIndex("cmplx_DEC_MultipleApplicantsGrid"),0)) && formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid")>0){ 
			for(int i=0;i<formObject.getLVWRowCount("SupplementCardDetails_cmplx_supplementGrid");i++){
				if(formObject.getNGValue("cmplx_DEC_MultipleApplicantsGrid",formObject.getSelectedIndex("cmplx_DEC_MultipleApplicantsGrid"), 2).equals(formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,3))){
					str=str+generateDocDetailsTag_NewCustomerReq(Arrays.asList("PPT","4/22/2015",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,15),formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,5),formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",0,3)));
					str=str+generateDocDetailsTag_NewCustomerReq(Arrays.asList("VISA","4/22/2015",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,23),"AE",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,22)));
					str=str+generateDocDetailsTag_NewCustomerReq(Arrays.asList("EMID","4/22/2015",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,18),formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,5),formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",0,7)));
				}
			}
		}
		}
				 ...
				 for(int i=0;i<formObject.getLVWRowCount("SupplementCardDetails_cmplx_SupplementGrid");i++){
					 if(formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),14).equals(formObject.getNGValue("SupplementCardDetails_cmplx_SupplementGrid",i,3))){
						 ...
						 if(callName.equalsIgnoreCase("CUSTOMER_UPDATE_REQ")){
							 str=str+generateDocDetailsTag_CIFUpdate(Arrays.asList("PPT",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,3),"4/22/2015",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,15)));
							str=str+generateDocDetailsTag_CIFUpdate(Arrays.asList("EMID",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,7),"4/22/2015",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,18)));
						 	str=str+generateDocDetailsTag_CIFUpdate(Arrays.asList("VISA",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,22),"4/22/2015",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,23)));
						}
						 else  if(callName.equalsIgnoreCase("CARD_NOTIFICATION")){
								str=str+generateDocDetailsTag_CardNotif(Arrays.asList("EMID",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,7),"4/22/2015",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,18)));
							 	str=str+generateDocDetailsTag_CardNotif(Arrays.asList("VISA",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,22),"4/22/2015",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,23)));
								str=str+generateDocDetailsTag_CardNotif(Arrays.asList("PPT",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,3),"4/22/2015",formObject.getNGValue("SupplementCardDetails_cmplx_supplementGrid",i,15)));
...
public String getFATCA_details(FormReference formObject)	{
	...
	for(int i=0;i<formObject.getLVWRowCount("cmplx_FATCA_cmplx_GR_FatcaDetails");i++){
		String applicantName=formObject.getNGValue("cmplx_FATCA_cmplx_GR_FatcaDetails",i, 0);
		String USRelation=formObject.getNGValue("cmplx_FATCA_cmplx_GR_FatcaDetails",i, 1);
		String TIN=formObject.getNGValue("cmplx_FATCA_cmplx_GR_FatcaDetails",i, 3);
		if(("S-"+formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),4)).equals(applicantName) || ("P_"+formObject.getNGValue("cmplx_CCCreation_cmplx_CCCreationGrid",formObject.getSelectedIndex("cmplx_CCCreation_cmplx_CCCreationGrid"),4)).equals(applicantName)){
	...
	try{
		...
		if("CUSTOMER_UPDATE_REQ".equalsIgnoreCase(call_name)){
			for (int i = 0; i<add_row_count;i++){
				...
				xml_str = xml_str + "<CRSUndocFlgReason>"+UndocumentedFlag_Reason+"</CRSUndocFlgReason></OECDDet>";
				}
			}
