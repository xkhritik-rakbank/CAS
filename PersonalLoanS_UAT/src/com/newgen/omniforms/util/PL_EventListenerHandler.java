    ...
    public void btnOk_Clicked(ActionEvent ae) throws ValidatorException {
        ...
        if (m_objPickList.getAssociatedTxtCtrl().equalsIgnoreCase("EMploymentDetails_Button2")) {
			...
			// changes done to check duplicate selection compare emp code and main emp code if/else condition added - 06-09-2017 Disha
                	 PL_SKLogger.writeLog("EventListenerHandler", "value of Emp Code" +  m_objPickList.getSelectedValue().get(1));
                	 PL_SKLogger.writeLog("EventListenerHandler", "value of main Emp Code" +  m_objPickList.getSelectedValue().get(9));
				...
				{     
					PL_SKLogger.writeLog("EventListenerHandler", "Employer code does not match main employer code");
