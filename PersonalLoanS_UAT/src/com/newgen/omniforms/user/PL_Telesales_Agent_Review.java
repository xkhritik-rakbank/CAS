...
public class PL_Telesales_Agent_Review extends PLCommon implements FormListener
{
	...
	{
		System.out.println("Inside initiation PL_Telesales_Agent_Review");
		PL_SKLogger.writeLog("PL_Telesales_Agent_Review Initiation", "Inside formLoaded()" + pEvent.getSource().getName());
