...
public class PL_Rejected_Application extends PLCommon implements FormListener
{
	...
	{
		System.out.println("Inside initiation PL_Rejected_Application");
		PL_SKLogger.writeLog("PL_Rejected_Application Initiation", "Inside formLoaded()" + pEvent.getSource().getName());
