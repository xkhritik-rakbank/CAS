...
public class PL_Interest_Rate_Approval extends PLCommon implements FormListener
{
	...
	{
		System.out.println("Inside initiation PL_Interest_Rate_Approval");
		PL_SKLogger.writeLog("PL_Interest_Rate_Approval Initiation", "Inside formLoaded()" + pEvent.getSource().getName());
