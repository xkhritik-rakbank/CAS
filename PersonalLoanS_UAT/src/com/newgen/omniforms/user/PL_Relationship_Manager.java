...
public class PL_Relationship_Manager extends PLCommon implements FormListener
{
	...
	{
		System.out.println("Inside initiation PL_Relationship_Manager");
		PL_SKLogger.writeLog("PL_Relationship_Manager Initiation", "Inside formLoaded()" + pEvent.getSource().getName());
