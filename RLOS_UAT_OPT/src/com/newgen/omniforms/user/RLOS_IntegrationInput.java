...
public class RLOS_IntegrationInput extends RLOSCommon implements Serializable
{
	...
	public String InternalBureauData(){
		...
		try{
			...
			List<List<String>> OutputXMLDerived = formObject.getNGDataFromDataCache(sQueryDerived);
			...
			List<List<String>> OutputXMLcheque = formObject.getNGDataFromDataCache(sQuerycheque);
		...
		*/
		...
		if (Man_liab_row_count !=0){
			for (int i = 0; i<Man_liab_row_count;i++){
				...
				String worst_status_24 = formObject.getNGValue("cmplx_Liability_New_cmplx_LiabilityAdditionGrid", i, 17); //0
		...
		try{
			for (List<String> mylist : OutputXML) {
				...
				else if(("prev_loan_dbr".equalsIgnoreCase(tag_name)||"prev_loan_tai".equalsIgnoreCase(tag_name)||"prev_loan_multiple".equalsIgnoreCase(tag_name)||"prev_loan_employer".equalsIgnoreCase(tag_name)))
				{
					...
					String squeryBorrow="select distinct(borrowingCustomer) from ng_RLOS_CUSTEXPOSE_CardDetails WHERE  Wi_Name ='"+formObject.getWFWorkitemName()+"' union select distinct(borrowingCustomer) from ng_RLOS_CUSTEXPOSE_LoanDetails with (nolock)  WHERE Wi_Name ='"+formObject.getWFWorkitemName()+"'";
				...
				else if((("lob".equalsIgnoreCase(tag_name))||("target_segment_code".equalsIgnoreCase(tag_name))||("designation".equalsIgnoreCase(tag_name))||("emp_name".equalsIgnoreCase(tag_name))||("industry_sector".equalsIgnoreCase(tag_name))||("eff_lob".equalsIgnoreCase(tag_name))||("industry_marco".equalsIgnoreCase(tag_name))||("industry_micro".equalsIgnoreCase(tag_name))||("bvr".equalsIgnoreCase(tag_name))||("eff_date_estba".equalsIgnoreCase(tag_name))||("poa".equalsIgnoreCase(tag_name))||("tlc_issue_date".equalsIgnoreCase(tag_name))) && NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_SelfEmployed").equalsIgnoreCase(emp_type)){
