...
public class RLOS_Query extends RLOSCommon implements FormListener
{
	...
	public void call_Frame_Expanded(ComponentEvent pEvent)
	{
       ...
       {        
		...
		else if ("Supplementary_Container".equalsIgnoreCase(pEvent.getSource().getName())) 
		{
			...
			if (NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_Salariedpensioner").equalsIgnoreCase(formObject.getNGValue("EmploymentType"))){
	...
	public void call_Value_Changed(ComponentEvent pEvent)
	{
		...
		if ("AppType".equalsIgnoreCase(pEvent.getSource().getName()))
		{
			...
			if ((NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_Conventional").equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_EXP").equalsIgnoreCase(subprod))&&(NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_RESCE").equalsIgnoreCase(apptype))){
			...
			if ((NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_Conventional").equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_NAT").equalsIgnoreCase(subprod))&&(NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_RESCN").equalsIgnoreCase(apptype))){
			...
			if ((NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_Islamic").equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_EXP").equalsIgnoreCase(subprod))&&(NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_RESCE").equalsIgnoreCase(apptype))){
				RLOS.mLogger.info( "4Value of AppType is:"+formObject.getNGValue("AppType"));
			...
			if ((NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_Islamic").equalsIgnoreCase(TypeofProduct)&&NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_NAT").equalsIgnoreCase(subprod))&&(NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_RESCN").equalsIgnoreCase(apptype))){
				RLOS.mLogger.info( "8Value of AppType is:"+formObject.getNGValue("AppType"));
				formObject.clear("Scheme");
				formObject.setNGValue("Scheme","--Select--");
	...
	throws ValidatorException {
		...
		if(outputindex != null && !outputindex.isEmpty())
		{
			 arrval=new String[outputindex.size()];
			RLOS.mLogger.info("Staff List "+outputindex);
			for(int i = 0; outputindex!=null && i < outputindex.size(); i++)
			{
