...
public class RLOSCommonCode extends RLOSCommon{
	...
	public void call_Frame_Expanded(ComponentEvent pEvent)
	{
		...
		/*--commented on 10/1/18 by akshay as they are not used now
		...
		else if ("DecisionHistoryContainer".equalsIgnoreCase(pEvent.getSource().getName()))
		{
			...
			if((!formObject.isVisible("CompanyDetails_Frame1"))){//company tab
				formObject.fetchFragment("CompanyDetails", "CompanyDetails", "q_CompanyDetails");
		...
		/*else if(pEvent.getSource().getName().equalsIgnoreCase("ELigibiltyAndProductInfo_Button1"))
	{
		...
		else  if("DecisionHistory_Button3".equalsIgnoreCase(pEvent.getSource().getName()))
		{
			...
			else
			{
				...
				/*
			 List<List<String>> AccountCount= formObject.getNGDataFromDataCache("Select count from ng_RLOS_CUSTEXPOSE_AcctDetails where AcctType='CURRENT ACCOUNT' AND Wi_Name="+wi_name+";");
		...
		{		
			...
			//formObject.setNGValue("Cust_Name",formObject.getNGValue("Customer_Name"));//Tarang to be removed on friday(1/19/2018)//added by akshay on 25/9/17 as per point 14 of problem sheet
 ...
 */
			...
			else if ((NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_Conventional").equalsIgnoreCase(TypeofProduct)&& NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_EXP").equalsIgnoreCase(subprod))&&(NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_RESCE").equalsIgnoreCase(apptype))){
			...
			else if ((NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_Conventional").equalsIgnoreCase(TypeofProduct)&& NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_NAT").equalsIgnoreCase(subprod))&&(NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_RESCN").equalsIgnoreCase(apptype))){
			...
			else if ((NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_Islamic").equalsIgnoreCase(TypeofProduct)&& NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_EXP").equalsIgnoreCase(subprod))&&(NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_RESCE").equalsIgnoreCase(apptype))){
				RLOS.mLogger.info( "4Value of AppType is:"+formObject.getNGValue("AppType"));
			...
			else if ((NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_Islamic").equalsIgnoreCase(TypeofProduct)&& NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_NAT").equalsIgnoreCase(subprod))&&(NGFUserResourceMgr_RLOS.getGlobalVar("RLOS_RESCN").equalsIgnoreCase(apptype))){
				RLOS.mLogger.info( "8Value of AppType is:"+formObject.getNGValue("AppType"));
				formObject.clear("Scheme");
				formObject.setNGValue("Scheme","--Select--");
		...
		//added by akshay on 12/15/17
			...
			if(!"".equalsIgnoreCase(formObject.getNGValue("Scheme"))){
				String query="select top 1 mintenure,maxtenure from NG_master_Scheme where schemeid='"+formObject.getNGValue("Scheme")+"'";
