...
public String getCustomerDetails(String passport,boolean forCif){
	...
	public void loadPicklist_suppCard(){
		...
		LoadPickList("SupplementCardDetails_EMploymentType", "select '--Select--' as description,'' as code union select convert(varchar, description),code from ng_MASTER_EmploymentType with (nolock) where isactive='Y'");
		...
		LoadPickList("SupplementCardDetails_EmploymentStatus", "select '--Select--' as description,'' as code union select convert(varchar, description),code from ng_MASTER_EmploymentType with (nolock)  where isActive='Y' order by code");
