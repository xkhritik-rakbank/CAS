    ...
    public void btnOk_Clicked(ActionEvent ae) throws ValidatorException {
       ...
       if("CompanyDetails_Aloc_search".equalsIgnoreCase(m_objPickList.getAssociatedTxtCtrl()))
       {
        ...
        if ("CustDetailVerification1_Button2".equalsIgnoreCase(m_objPickList.getAssociatedTxtCtrl())) {
        	...
        	CreditCard.mLogger.info("Inside Button_ok catch val 0: "+m_objPickList.getSelectedValue().get(0));
        	CreditCard.mLogger.info("Inside Button_ok catch val 1: "+m_objPickList.getSelectedValue().get(1));
        	CreditCard.mLogger.info("Inside Button_ok control name: "+m_objPickList.getAssociatedTxtCtrl());
