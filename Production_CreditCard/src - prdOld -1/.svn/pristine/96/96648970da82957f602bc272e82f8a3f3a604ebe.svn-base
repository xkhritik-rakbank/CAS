...
public class CC_Smart_CPV extends CC_Common implements FormListener
{
	...
	public void submitFormStarted(FormEvent arg0) throws ValidatorException {
		...
		if(formObject.isVisible("SmartCheck")==false){ 
			...
			for(int i=0;i<n;i++){
				...
				CreditCard.mLogger.info( "Grid Data[1][6] is:"+formObject.getNGValue("cmplx_SmartCheck_SmartCheckGrid",i,1)+formObject.getNGValue("cmplx_SmartCheck_SmartCheckGrid",i,3));
			}
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
		/*if (pEvent.getSource().getName().equalsIgnoreCase("Product")) {
			...
			//setDisabled();
			//formObject.setEnabled("Customer_Frame1",true); // Added by Rajan for PCASP-1879
		}	
		...
		//	formObject.setLocked("OECD_Frame8",true);
			...
			LoadPickList("cmplx_IncomeDetails_AnnualRentFreq", "select '--Select--' union select convert(varchar, description) from NG_MASTER_Frequency with (nolock)");
               ...
               //formObject.setEnabled("CompanyDetails_Frame1", true);// Added by Rajan for PCASP-1879
	...
	//		LoadPickList("PartMatch_nationality", "select '--Select--','--Select--' union select convert(varchar, Description),code from ng_MASTER_Country with (nolock)");
		...
		// ++ above code already present - 06-10-2017
			...
			formObject.setEnabled("cmplx_CustDetailVerification_offtelno_ver",true);//to be changed.
			...
			//Added by shivang for PCASP-2091
			if("BTC".equalsIgnoreCase(formObject.getNGValue("cmplx_Product_cmplx_ProductGrid", 0, 2))
					|| "SE".equalsIgnoreCase(formObject.getNGValue("cmplx_Product_cmplx_ProductGrid", 0, 2)))
				{
					formObject.setVisible("cmplx_BussVerification_Office_Extension", false);
					formObject.setVisible("BussinessVerification_Label5", false); 
				}
		}
		...
		//added by yash on 30/7/2017
			...
			formObject.setNGValue("NotepadDetails_Actusername",formObject.getNGValue("cmplx_h_FirstNAme") +" "+ formObject.getNGValue("cmplx_Customer_MiddleNAme") +" "+ formObject.getNGValue("cmplx_Customer_LastNAme"));
		...
		//added by abhishek as per CC FSD
			...
			formObject.setLocked("SmartCheck_Add", true);
            ...
            formObject.setVisible("cmplx_DEC_NoofAttempts",true);*/
         	...
         	fragment_ALign("DecisionHistory_Decision_Label3,cmplx_DEC_Decision#DecisionHistory_Label26,DecisionHistory_ReferTo#DecisionHistory_Label11,DecisionHistory_dec_reason_code#\n#DecisionHistory_Decision_Label4,cmplx_DEC_Remarks#DecisionHistory_nonContactable#DecisionHistory_cntctEstablished#DecisionHistory_Label44,cmplx_DEC_NoOfAttempts_Smart#DecisionHistory_Label45,cmplx_DEC_SetReminder_Smart#\n#DecisionHistory_ADD#DecisionHistory_Modify#DecisionHistory_Delete#\n#DecisionHistory_Decision_ListView1#\n#DecisionHistory_save","DecisionHistory");//\n for new line
