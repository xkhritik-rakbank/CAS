	...
	*/}
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
		...
		if ("Customer".equalsIgnoreCase(pEvent.getSource().getName())) {
			...
			if(formObject.getNGValue("Sub_Product").equalsIgnoreCase("SE") && formObject.getNGValue("ApplicationCategory").equals("BAU")
			...
			if(formObject.getNGValue("Sub_Product").equalsIgnoreCase("SE")){
			...
			//hritik 
			String empType = formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0,6);
			//above line by jahnavvi to add condition for salaried
			...
			else if("Salaried".equalsIgnoreCase(empType))
			{
				...
				formObject.setVisible("Liability_New_Button1", false);
		...
		formObject.setEnabled("ExtLiability_Button1", false);
		formObject.setLocked("ExtLiability_AECBReport",false);
		formObject.setEnabled("ExtLiability_AECBReport", true);
			formObject.setVisible("Liability_New_Button1", true);
			formObject.setLocked("Liability_New_Button1",false);
			...
			else if(!"BPA".equalsIgnoreCase(formObject.getNGValue("Sub_Product")))
			...
			if("Hold_CA_CPV".equalsIgnoreCase(formObject.getWFActivityName())  ) 
			{
				CreditCard.mLogger.info("for hold ca cpv"+formObject.getWFActivityName());
				if("Self Employed".equalsIgnoreCase(empType))
				{
				formObject.setEnabled("Liability_New_Button1", true);
				formObject.setVisible("Liability_New_Button1", true);
			...
			// Below added by Rajan for PCASP-1879
		...
		/*	formObject.setVisible("DecisionHistory_chqbook",false);
			...
			formObject.setLocked("cmplx_DEC_Remarks", true);
			...
			formObject.setEnabled("BussinessVerification_Enable",false);
			formObject.setLocked("BussinessVerification_Button1",true);//
			...
			formObject.setVisible("OfficeandMobileVerification_Label7", true);//Added by Alok to set visible the fields at exit workstep on 06/09/2021
			formObject.setVisible("OfficeandMobileVerification_Label13", true);//Added by Alok to set visible the fields at exit workstep on 06/09/2021
			formObject.setVisible("OfficeandMobileVerification_Label3", true);//Added by Alok to set visible the fields at exit workstep on 06/09/2021
			formObject.setVisible("cmplx_OffVerification_hrdcntctno", true);//Added by Alok to set visible the fields at exit workstep on 06/09/2021
			formObject.setVisible("cmplx_OffVerification_hrdcntctdesig", true);//Added by Alok to set visible the fields at exit workstep on 06/09/2021
			formObject.setVisible("cmplx_OffVerification_hrdcntctname", true);//Added by Alok to set visible the fields at exit workstep on 06/09/2021
