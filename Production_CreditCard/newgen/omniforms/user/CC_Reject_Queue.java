			...
			if(formObject.getNGValue("Reject_DeC").equalsIgnoreCase("Reject"))
			{
				...
				for(int i=count-1;i>count-4;i--)
				{
					...
					CreditCard.mLogger.info("sagarika@"+formObject.getNGValue("DecisionHistory_Decision_ListView1",i,2));
						...
						else if("CAD_analyst2".equalsIgnoreCase(formObject.getNGValue("DecisionHistory_Decision_ListView1",i,2))|| "CAD_analyst2".equalsIgnoreCase(formObject.getNGValue("DecisionHistory_Decision_ListView1",i,2)))
						{
							flag_cad=true;
						}
					}
