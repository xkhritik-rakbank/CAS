...
public class CC_CA_Hold extends CC_Common implements FormListener
{
	/**
	 * 
	 */
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
		/*if (pEvent.getSource().getName().equalsIgnoreCase("Product")) {
			...
			LoadPickList("cmplx_IncomeDetails_Account_num_sal", "select  AcctId from (select distinct AcctId, case when accttype='CURRENT ACCOUNT' then '1'  when accttype='FAST SAVER' then '2' else accttype end as accounttype from  ng_RLOS_CUSTEXPOSE_AcctDetails where  child_wi ='"+formObject.getWFWorkitemName()+"') as temp_data order by accounttype");
			LoadPickList("cmplx_IncomeDetails_Account_self_num", "select  AcctId from (select distinct AcctId, case when accttype='CURRENT ACCOUNT' then '1'  when accttype='FAST SAVER' then '2' else accttype end as accounttype from  ng_RLOS_CUSTEXPOSE_AcctDetails where  child_wi ='"+formObject.getWFWorkitemName()+"') as temp_data order by accounttype");
		}
		...
		//	formObject.setLocked("EMploymentDetails_Frame1", true);
         ...
         if(	NGFUserResourceMgr_CreditCard.getGlobalVar("CC_BusinessTitaniumCard").equalsIgnoreCase(formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0,2)) || NGFUserResourceMgr_CreditCard.getGlobalVar("CC_SelfEmployedCreditCard").equalsIgnoreCase(formObject.getNGValue("cmplx_Product_cmplx_ProductGrid",0,2))){
			...
			formObject.setLocked("RejectEnq_Frame1",true);
			 ...
			 //Added by shivang for PCASP-2485
		...
		//added by yash on 24/8/2017
		  ...
		  //--Above code added by nikhil 13/11/2017 for Code merge
            ...
            formObject.setVisible("DecisionHistory_save", true);*/
	         ...
	         fragment_ALign("DecisionHistory_Decision_Label3,cmplx_DEC_Decision#DecisionHistory_Label26,DecisionHistory_ReferTo#DecisionHistory_Label11,DecisionHistory_dec_reason_code#DecisionHistory_Label12,cmplx_DEC_NoofAttempts_CA#\n#DecisionHistory_Decision_Label4,cmplx_DEC_Remarks#\n#DecisionHistory_ADD#DecisionHistory_Modify#DecisionHistory_Delete#\n#DecisionHistory_Decision_ListView1#\n#DecisionHistory_save","DecisionHistory");//\n for new line
	     	formObject.setHeight("DecisionHistory_Frame1", formObject.getTop("DecisionHistory_save")+ formObject.getHeight("DecisionHistory_save")+20);
			formObject.setHeight("DecisionHistory", formObject.getHeight("DecisionHistory_Frame1")+20);
				
	         CreditCard.mLogger.info("***********Inside after fragment alignment decision history");
	       //for decision fragment made changes 8th dec 2017		
			formObject.setNGValue("cmplx_DEC_Decision", "Sendback");
