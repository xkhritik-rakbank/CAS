...
public class CC_Dispatch extends CC_Common implements FormListener
{
	...
	{
	     try{
	    	 CreditCard.mLogger.info("Inside CC Dispatch CC");
	...
	private void fragment_loaded(FormEvent pEvent,FormReference formObject)
	{
		/*if (pEvent.getSource().getName().equalsIgnoreCase("Product")) {
			...
			//	formObject.setLocked("EMploymentDetails_Frame1",true);
				...
				CreditCard.mLogger.info("Inside alternate contact details fragment (Dispatch) :"+formObject.getNGValue("Card_Dispatch_Option"));
