	...
	***********************************************************************************  */
	...
	public void fragment_loaded(ComponentEvent pEvent)
	{
		...
		//++below code changed added by yash for toteam
				...
				{
					String sQuery = "Select distinct DocName FROM ng_rlos_incomingDoc WHERE  docname like 'liability_certificate%' and DocSta = 'Recieved' and wi_name='"+formObject.getWFWorkitemName()+"'";
