...
public class User 
{
	...
	public User(String section) 
	{
		try 
		{
			...
			String sectionUpper="",pwdInt="",pwdEnd="",unInt="",unEnd="";
			...
			{
				sectionUpper=section.toUpperCase()+"_";
			}
			
			pwdInt="<"+sectionUpper+"PASSWORD>";
			pwdEnd="</"+sectionUpper+"PASSWORD>";
			unInt="<"+sectionUpper+"USERNAME>";
			unEnd="</"+sectionUpper+"USERNAME>";
			cis.close();
			fis.close();
