...
function Income_Save_Check()
{
	...
	if(Principal_Approval=='Y' && (EmpType=='Salaried' || EmpType=='Salaried Pensioner'))
	{
...
function Check_Mandate_CustomerCheck()
{
	...
	else if(getNGValue('cmplx_Customer_Basic_Sal')=='')
	{
	...
	var age=calcAge(getNGValue('cmplx_Customer_DOb'),'');
			...
			{
		       showAlert('','Minor Customer not Applicable for Credit Card');
