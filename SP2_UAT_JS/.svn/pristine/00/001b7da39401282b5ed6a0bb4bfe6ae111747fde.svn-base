...
var CC_Loan_BT ='creditcardNo#Credit card Number/Account Number,transferMode#Transfer Mode,bankName#Bank Name,nameOnCard#Name On Card,amount#Amount,marketingCode#Marketing Code,date#Date,AppStatus#Application Status';
...
var CC_Loan_LOC = 'transferMode#Transfer Mode,benificiaryName#Beneficiary Name,nameOnCard#Name On Card,tenor#Tenor,amount#Amount,marketingCode#Marketing Code,date#Date,iban#IBAN,AppStatus#Application Status';

var CC_Loan_SmartCash = 'transferMode#Transfer Mode,benificiaryName#Beneficiary Name,nameOnCard#Name On Card,amount#Amount,marketingCode#Marketing Code,date#Date,AppStatus#Application Status,iban#IBAN';
