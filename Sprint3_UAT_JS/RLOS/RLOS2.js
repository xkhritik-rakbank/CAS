		...
		if(pId=='cmplx_EmploymentDetails_EmpStatusPL')
{
	...
	// Added By Pooja
	/*
	if(pId=='cmplx_customerConsents_ContactMeColingOf'){
			if(getNGValue('cmplx_customerConsents_ContactMeColingOf')=='Y'){
				setEnabledCustom('cmplx_customerConsents_TelephoneCalls',true);
				setNGValue('cmplx_customerConsents_TelephoneCalls',true);
				setEnabledCustom('cmplx_customerConsents_Sms',true);
				setNGValue('cmplx_customerConsents_Sms',true);
				setEnabledCustom('cmplx_customerConsents_Email',true);
				setNGValue('cmplx_customerConsents_Email',true);
				setEnabledCustom('cmplx_customerConsents_ContactMe',true);
				setNGValue('cmplx_customerConsents_ContactMe',true);
			}
			else{
				setEnabledCustom('cmplx_customerConsents_TelephoneCalls',false);
				setNGValue('cmplx_customerConsents_TelephoneCalls',false);
				setEnabledCustom('cmplx_customerConsents_Sms',false);
				setNGValue('cmplx_customerConsents_Sms',false);
				setEnabledCustom('cmplx_customerConsents_Email',false);
				setNGValue('cmplx_customerConsents_Email',false);
				setEnabledCustom('cmplx_customerConsents_ContactMe',false);
				setNGValue('cmplx_customerConsents_ContactMe',false);
			}
...
//modified by akshay on 14/10/17	
	...
	//added By Akshay on 15/9/2017 for disabling below fields when transfermode is cheque
		...
		if(getNGValue('cmplx_CC_Loan_ModeOfSI')=='F'){
			...
			//PCASP-3177
				...
				setNGValue('cmplx_CC_Loan_SI_Percentage','4');
	...
	//Deepak code added for Consents_iban_number validation
	 if(pId=='cmplx_customerConsents_iban_number' && getNGValue('cmplx_customerConsents_iban_number').length <21){
		 showAlert('cmplx_customerConsents_iban_number', 'Length of IBAN should be 23');  
		 return false;
	 }
