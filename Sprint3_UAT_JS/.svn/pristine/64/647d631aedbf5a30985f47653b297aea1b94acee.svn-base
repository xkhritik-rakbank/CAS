...
if (window.parent.strprocessname=='CreditCard' || loanMultiple=='NaN' || loanMultiple==NaN || loanMultiple=='' || window.parent.strprocessname=='PersonalLoanS' )
{
	return '@10';
}
else{
...
function FPUTemplate(){
	...
	attrbList += "&<cust_verifiers>&" + get_ngformValue_template('cmplx_emp_ver_sp2_verifier');
	...
	attrbList += "&<BC_BankAccRemark>&" + "  @10" +get_ngformValue_template('cmplx_BankingCheck_BankAccDetailRemarks');
	attrbList += "&<BC_SalaryCreditRemark>&" + "  @10" +get_ngformValue_template('cmplx_BankingCheck_SalaryCreditRemarks');
	attrbList += "&<BC_AccConductRemark>&" + "  @10" +get_ngformValue_template('cmplx_BankingCheck_AccConductRemarks');
	attrbList += "&<BC_LiabCheckRemark>&" + "  @10" +get_ngformValue_template('cmplx_BankingCheck_LiabilityCheckRemarks');
	attrbList += "&<BC_RepayCondRemark>&" + "  @10" +get_ngformValue_template('cmplx_BankingCheck_RepaymentConductRemarks');
	attrbList += "&<BC_CCStatRemarks>&" + "  @10" +get_ngformValue_template('cmplx_BankingCheck_CCVerificationRemarks');
	attrbList += "&<BC_AccstatRemars>&" + "  @10" +get_ngformValue_template('cmplx_BankingCheck_AccStatementRemarks');
	attrbList += "&<BC_NLCRemarks>&" + "  @10" +get_ngformValue_template('cmplx_BankingCheck_NLCVericationRemarks');
	attrbList += "&<BC_CompListRemarks>&" + "  @10" +get_ngformValue_template('cmplx_BankingCheck_CompanyListingRemarks');
	attrbList += "&<BC_AecbMMRemarks>&" + "  @10" +get_ngformValue_template('cmplx_BankingCheck_AECBMismatchRemarks');
	attrbList += "&<CL_EIDVal>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_eid');
	attrbList += "&<CL_VisaVal>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_visa');
	attrbList += "&<CL_AECBCheck>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_aecb');
	attrbList += "&<CL_DirectExcp>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_direct_exp');
	attrbList += "&<CL_MOLCheck>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_mol');
	attrbList += "&<CL_AlocCheck>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_aloc');
	attrbList += "&<CL_CompDirectExp>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_company_direct');
	attrbList += "&<CL_CardandLoanP>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_card');
	attrbList += "&<CL_DedupeCheck>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_dedupe');
	attrbList += "&<CL_TLCheck>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_tl');
	attrbList += "&<CL_AddCheck1>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_add_1');
	attrbList += "&<CL_AddCheck2>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_add_2');
	attrbList += "&<CL_AddCheck3>&" + "  @10" +get_ngformValue_template('cmplx_checklist_sp2_add_3');
	return attrbList;
}
//function added by Saurabh for FPU Report CR.
	...
	if (getLVWRowCount(GridName) >0)
					  {
						...
						{ 
							if (getLVWAT(GridName,i,1)=='Business')
							{
								...
								attrbList += "&<SE_ELOB>&" + get_ngformGridColumn_template(GridName,i,37);
					...
					if (getLVWRowCount('cmplx_CompanyDetails_cmplx_CompanyGrid') >0)
					  {
						...
						{ 
							if (getLVWAT('cmplx_CompanyDetails_cmplx_CompanyGrid',i,1)=='Business')
							{
								...
								{
									attrbList+="&<header>&SELF EMPLOYED â€“ DOCTOR SURROGATE@10";
									attrbList+="&<loan>&Finance@10";
								}
...
var fields = desig_Query.split('#');
	...
	//change by saurabh for PCSP-315
	attrbList += "&<ALOC_PL>&" + ((get_ngformGridColumn_template("cmplx_Product_cmplx_ProductGrid",0,5).split('@')[0].indexOf('Salaried')>-1)?get_ngformValue_template('cmplx_EmploymentDetails_Aloc_RemarksPL'):" "+"@10");
	var aloc_remark=''
	aloc_remark= ((get_ngformGridColumn_template("cmplx_Product_cmplx_ProductGrid",0,5).split('@')[0].indexOf('Salaried')>-1)?get_ngformValue_template('cmplx_EmploymentDetails_Aloc_RemarksPL'):" "+"@10");
	if(aloc_remark=="@10" || aloc_remark == "" || aloc_remark==null){
		attrbList += "&<ALOC_PL>&" + "No@10";
	}else{
		attrbList += "&<ALOC_PL>&" + "Yes@10";
