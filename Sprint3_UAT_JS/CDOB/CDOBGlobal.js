...
function checkMandatory(constantName){
	var mField = constantName.split(",");
		...
		var j = mField[i].toString().split("#");
			...
			if((j[0].indexOf('_GRID')!=-1)||(j[0].indexOf('_GR')!=-1) ||(j[0].indexOf('inwardtt')!=-1) ||(j[0].indexOf('_CompanyGrid')!=-1) ||(j[0].indexOf('_partnerGrid')!=-1)||(j[0].indexOf('_Telloggrid')!=-1)||(j[0].indexOf('RejectEnqGrid')!=-1)||(j[0].indexOf('_Grid')!=-1)||(j[0].indexOf('_supplementGrid')!=-1))	//Changes Done by Sajan for PCASF-74	
			{
				...
				if(getLVWRowCount(j[0])==0 && j[1].indexOf('World Check')==-1){			//Changes made by Sajan for PCASF-464
					//alert('coming here '+j[1]);
			...
			// disha 06-10-2017 below change according to onsite
				...
				else if(j[0].indexOf('_notegrid')==-1){				//Changed by Sajan for PCASF-74
