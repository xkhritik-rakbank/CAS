...
//AppType
	...
	public void fetch_Liability_frag(FormReference formObject){
		...
		if(formObject.getWFActivityName().equalsIgnoreCase("Branch_Init")){
			
			String refNo = "";
			String aecbScore = "";
			String range = "";
			try{
				String query = "select ReferenceNo,AECB_Score,Range from NG_rlos_custexpose_Derived where Wi_Name = '"+formObject.getWFWorkitemName()+"' and and Request_Type='ExternalExposure'";
