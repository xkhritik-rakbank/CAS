...
//Module					: CAS
//File Name					: RLOS_Paper_based_Initiation.java
//Author					: Deepak Kumar
...
public class RLOS_Paper_based_Initiation extends RLOSCommon implements FormListener
{
	...
	public void formPopulated(FormEvent pEvent) {
		...
		try{
			...
			formObject.setNGValue("lbl_init_channel_val","Paperbased_Init");
		...
		/*	formObject.setNGValue("RM_Name",getDataFromSourceCodeMaster("supervisor_name"));
			...
			if(init_Channel!=null && "".equalsIgnoreCase(init_Channel))
				formObject.setNGValue("initiationChannel","M");
	...
	public void submitFormStarted(FormEvent arg0) throws ValidatorException {
		...
		if("RESC".equalsIgnoreCase(formObject.getNGValue("Application_Type")) || "RESN".equalsIgnoreCase(formObject.getNGValue("Application_Type")) || "RESR".equalsIgnoreCase(formObject.getNGValue("Application_Type")))
			...
			if(formObject.getNGValue("initiationChannel")==""){
				formObject.setNGValue("initiationChannel","M");//added by akshay on 17/4/18	
			}
			else{
	...
	public void call_Fragement_Loaded(ComponentEvent pEvent)
	{
		...
		//RLOS.mLogger.info("Value Of init type is:"+formObject.getNGValue("initiationChannel")); 
			...
			/*	formObject.setLocked("cmplx_Customer_Title",false);
				...
				paper_init_customer_fields(formObject);
			}
				...
				LoadPickList("ReqProd", "select '--Select--' union select convert(varchar, description) from NG_MASTER_RequestedProduct with (nolock) where activityName='Branch_Init'");
				//formObject.setNGValue("ReqProd","--Select--");				
				if("Branch_Init".equalsIgnoreCase(formObject.getWFActivityName()) || "Paperbased_Init".equalsIgnoreCase(formObject.getWFActivityName()))
				{
