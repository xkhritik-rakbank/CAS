...
<fieldset>
  ...
  <table cellspacing="10" cellpadding="5">
	...
	<tr>
		...
		<td style="padding:0 15px 0 15px;"><input type="text" name="full_name" value="<%=AecbHistory%>" disabled></td>
		<td style="padding:0 15px 0 15px;"><input type="text" name="full_name" value="<%=DPD5_Last3Months%>" disabled></td>
		<td style="padding:0 15px 0 15px;"><input type="text" name="full_name" value="<%=Dpd5_last12month%>" disabled></td>
		<td style="padding:0 15px 0 15px;"><input type="text" name="full_name" value="<%=Dpd60plus_last12month%>" disabled></td>
...
<fieldset>
  ...
  <table cellspacing="10" cellpadding="5">
	...
	<tr>
		...
		<td style="padding:0 15px 0 15px;"><input type="text" name="full_name" value="-"  disabled></td>
