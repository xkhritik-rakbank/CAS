...
function saveDate() {
		...
		for(var row_arr_count= 1;row_arr_count<=totalrowid;row_arr_count++){
				...
				if(document.getElementById(variable_id).value!="" )
				{
					total_blank=false;
				}		
				}
				if(total_blank==false)
				{
...
function setFinalLimit(id){
	limitDecimal(id);
		var CalculatedLimit_1=document.getElementById('CAS_Calculated_Limit_1').value;
			...
			if((col_id_arr[1]=="text")){
				if(activityName=='CA'){ 
					...
					if((row_num!=1)&&(i==5)){
						...
						if (ws_name=='CAD_Analyst1' || ws_name=='DDVT_Maker' || ws_name=='CSM'){
						table_row = table_row +"<td>"+"<input id = '"+col_id_arr[3]+"_"+row_num+"' type = '"+ col_id_arr[1] +"' name = '"+col_id_arr[3]+"_"+row_num+"' value='"+FinalLimit+"'    onchange ='setFinalLimit(this.id);' maxlength ='21' "+col_id_arr[5]+">"+"</td>";
						}
						else{
							table_row = table_row +"<td>"+"<input id = '"+col_id_arr[3]+"_"+row_num+"' type = '"+ col_id_arr[1] +"' name = '"+col_id_arr[3]+"_"+row_num+"' value='"+FinalLimit+"'   onchange ='setFinalLimit(this.id);' maxlength ='"+col_id_arr[2]+"' "+col_id_arr[5]+" readonly>"+"</td>";
						}
					}
