				...
				if(!total_records.equals("")){
					...
					if (status.equalsIgnoreCase("Success"))
					{
						for(int i=0;i<Wi_Name_array.length;i++)	
						{
							...
							sInputXML=ExecuteQuery_APUpdate(tableName,"File_Generated_Name,File_Generated_Date,Login_User_id,status","'"+File_Generated_Name+"','"+timestamp+"','"+userName+"','File Generated'",sWhere,cabinetName,sessionId);
	...
	try{		
		...
		{		
			...
			for(int i=0;i<result.size();i++){
				...
				fw.append("B|"+userName+"|"+result.get(i)+"\n");
			}
		}
