...
<%  String sCabname="";
	...
	console.log("Exec_datacopy_procedure jsp: request params old_app_no: "+old_app_no);
	console.log("Exec_datacopy_procedure jsp: request params ProcName: "+ProcName);
	console.log("Exec_datacopy_procedure jsp: request params winame: "+winame);
	...
	try {
			...
			console.log("Exception Occured while reading from properties file: "+e.getMessage());
		}
  ...
  String strInputXML = "<?xml version=\"1.0\"?>"
	...
	console.log("Exec_datacopy_procedure jsp: 1 strInputXML: "+strInputXML);
	try 
	{
		strOutputXML = NGEjbClient.getSharedInstance().makeCall(sJtsIp, iJtsPort, appServerType, strInputXML);
		console.log("Exec_datacopy_procedure jsp: 1 strOutputXML: "+strOutputXML);
	} 
	catch (NGException e) 
	{
	   e.printStackTrace();
	...
	console.log("Exec_datacopy_procedure jsp: 2 strInputXML: "+strInputXML);
	try 
	{
		strOutputXML = NGEjbClient.getSharedInstance().makeCall(sJtsIp, iJtsPort, appServerType, strInputXML);
		console.log("Exec_datacopy_procedure jsp: 2 strOutputXML: "+strOutputXML);
	} 
	catch (NGException e) 
	{
	   e.printStackTrace();
	...
	console.log("Exec_datacopy_procedure jsp: itemIndex: "+itemIndex);
	String sOutputXML="";
	String sFinalString="";
	...
	console.log("Exec_datacopy_procedure jsp: sInputXML: "+sInputXML.toString());
	...
	try 
	{
		...
		console.log("Exec_datacopy_procedure jsp: sOutputXML: "+sOutputXML);
	} 
	catch (NGException e) 
	{
	   e.printStackTrace();
