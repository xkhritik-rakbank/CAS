...
try{
	...
	document.write("<script src='/formviewer/resources/scripts/CC/CC_Constants.js'></script>");
	document.write("<script src='/formviewer/resources/scripts/CC/CreditCard.js'></script>");
	...
	document.write("<script src='/formviewer/resources/scripts/CC/CC_Validations.js'></script>");
