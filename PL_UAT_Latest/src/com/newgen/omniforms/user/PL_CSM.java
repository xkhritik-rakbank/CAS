...
*/
			...
			formObject.setLeft("EMploymentDetails_Label31", 24);
			formObject.setLeft("cmplx_EmploymentDetails_DateOfLeaving", 24);
			formObject.setTop("EMploymentDetails_Label31", 290);
			formObject.setTop("cmplx_EmploymentDetails_DateOfLeaving", 305);
			loadPicklist4();
			Fields_ApplicationType_Employment();
			//change by saurabh on 2 sept PROC - 12853
			if(!"".equals(formObject.getNGValue("cmplx_Customer_NEP"))){
			 ...
			 if(NGFUserResourceMgr_PL.getGlobalVar("PL_TEN").equalsIgnoreCase(formObject.getNGValue("cmplx_EmploymentDetails_targetSegCode")))
			{
			...
			formObject.setVisible("cmplx_EmploymentDetails_DateOfLeaving", true);
			formObject.setVisible("EMploymentDetails_Label71", false);
			formObject.setVisible("cmplx_EmploymentDetails_EmpContractType", false);
			//below code added by nikhil for loadpicklist textbox disabled in all cases
